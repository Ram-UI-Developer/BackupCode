...
const ProjectStatusList = () => {
        ...
        getById({
            ...
            .then(
                (res) => {
                    ...
                    setProjectData(res.data ? res.data : {})
                },
                (error) => {
                    console.log(error)
                }
    ...
    //api handling  for save project status object  with validation
    const onSaveHandler = () => {
        const obj = {
            organizationId: userDetails.organizationId == null ? 0 : userDetails.organizationId,
            name: formData.name
    ...
    //api handling  for updating project status object  with validation
    ...
    const onUpdateHandler = () => {
        ...
        } else if (updateValidation(projectData, formData)) {
        ...
        <div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="  ">
                                <PageHeader pageTitle="Project Statuses" />
                                <div className="">
                                    <Button
                                        className="addButton"
                                        variant="addbtn"
            ...
            <Modal show={view && !loading} size="lg" onHide={handleClose}>
                <Modal.Header closeButton={handleClose}>
                    <Modal.Title>
                        {mode == 'create' ? 'Add Project Status' : 'Update Project Status'}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
