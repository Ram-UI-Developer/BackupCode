...
const MeritalStatusList = () => {
        ...
        getById({
            ...
            .then(
                (res) => {
                    ...
                    setMaritalData(res.data ? res.data : {})
                },
                (error) => {
                    console.log(error)
                }
    ...
    //api handling  for saving the  marital status  object with validation
    const onSaveHandler = () => {
        const obj = {
            organizationId: userDetails.organizationId == null ? 0 : userDetails.organizationId,
            name: formData.name
    ...
    //api handling for updating marital status object  with validation
    const onUpdateHandler = () => {
        ...
        } else if (updateValidation(maritalData, formData)) {
        ...
        <div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="  ">
                                <PageHeader pageTitle="Marital Statuses" />
                                <div className="">
                                    <Button
                                        className="addButton"
                                        variant="addbtn"
            ...
            <Modal show={view && !loading} size="lg" onHide={handleClose}>
                <Modal.Header closeButton={handleClose}>
                    <Modal.Title>
                        {mode == 'create' ? 'Add Marital Status' : 'Update Marital Status'}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default MeritalStatusList
