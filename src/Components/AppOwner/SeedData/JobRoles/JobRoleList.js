...
const JobRoleList = () => {
    ...
    //api handling for get all job roles
    const getAllHandler = () => {
        setLoading(true)
        getAllByOrgId({
            entity: entity,
        ...
        getById({
            ...
            .then(
                (res) => {
                    ...
                    setJobRoleData(res.data ? res.data : {})
                },
                (error) => {
                    console.log(error)
                }
    ...
    //api handling for save job role  object along with validation
    const onSaveHandler = () => {
        const obj = {
            organizationId: userDetails.organizationId == null ? 0 : userDetails.organizationId,
            name: formData.name
    ...
    //api handling for update job role  object along with validation
    const onUpdateHandler = () => {
        ...
        } else if (updateValidation(jobRoleData, formData)) {
        ...
        <div>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-12">
                            <div className="  ">
                                <PageHeader pageTitle="Job Roles" />
                                <div className="table">
                                    <Button
                                        className="addButton"
                                        variant="addbtn"
            ...
            <Modal show={view} size="lg" onHide={handleClose}>
                <Modal.Header closeButton={handleClose}>
                    <Modal.Title>
                        {mode == 'create' ? 'Add Job Role' : 'Update Job Role'}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {loading ? <DetailLoader /> : ''}
