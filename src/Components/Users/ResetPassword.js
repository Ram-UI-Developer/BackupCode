...
const ResetPassword = () => {
    ...
    const userDetails = useLocation().state || { username: '', password: '' }
    ...
    const logoutProcess = () => {
        localStorage.setItem(ACCESS_TOKEN, '') // Clear access token
    ...
    const onChangePassword = (e) => {
        ...
        } else if (formData.password != userDetails.password) {
            setFormErrors(validate(formData))
        }
    ...
    const validate = (values) => {
        ...
        if (values.password && values.password != userDetails.password) {
        ...
        if (values.password && values.password == values.newpassword) {
                            ...
                            <div className="col-md-12">
                                <div>
                                    ...
                                    {userDetails.username ?
                                        <center>
                                            <p className='error'>Your password has expired. Kindly reset it to continue.</p>
