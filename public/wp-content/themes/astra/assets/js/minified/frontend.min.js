        ...
        for (
            var t,
                ...
                f =
                    ...
                    (a =
                        S.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) ||
                        []),
                    /trident/i.test(a[1])
                        ? (t = /\brv[ :]+(\d+)/g.exec(S) || [])
                        : ('Chrome' === a[1] && null != (t = S.match(/\bOPR|Edge\/(\d+)/))) ||
                          ((a = a[2]
                              ? [a[1], a[2]]
        ...
        if (
            (document.querySelectorAll('.search-field').forEach((e) => {
                ;(e.addEventListener('focus', function (e) {
                    var t =
                        this.parentNode.parentNode.parentNode.querySelector('.ast-search-menu-icon')
