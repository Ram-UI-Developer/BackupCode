...
;(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var isWhiteSpace = function (codePoint) {
        return (
            codePoint === LINE_FEED || codePoint === CHARACTER_TABULATION || codePoint === SPACE$1
        )
    }
    ...
    ;(function (PropertyDescriptorParsingType) {
        ...
        PropertyDescriptorParsingType[(PropertyDescriptorParsingType['IDENT_VALUE'] = 2)] =
            'IDENT_VALUE'
        PropertyDescriptorParsingType[(PropertyDescriptorParsingType['TYPE_VALUE'] = 3)] =
            'TYPE_VALUE'
    ...
    var breakWords = function (str, styles) {
        var breaker = LineBreaker(str, {
            ...
            wordBreak:
                styles.overflowWrap === OVERFLOW_WRAP.BREAK_WORD ? 'break-word' : styles.wordBreak
        })
        var words = []
        var bk
