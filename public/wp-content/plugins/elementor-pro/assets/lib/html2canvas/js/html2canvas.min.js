...
!(function (A, e) {
        ...
        Rr = {
            ...
            parse: function (A) {
                return 1 === A.length && JA(A[0], 'none')
                    ...
                    : WA(A).map(function (A) {
                          for (
                              var e = { color: He.TRANSPARENT, offsetX: se, offsetY: se, blur: se },
                                  t = 0,
                                  r = 0;
                              r < A.length;
                              r++
            ...
            if (
                ...
                var t = A.contentWindow.document.documentElement
                    ...
                    r = A.contentWindow.document.body
                        ? AB(getComputedStyle(A.contentWindow.document.body).backgroundColor)
                        : He.TRANSPARENT
                                        ...
                                        return (
                                            ...
                                            s &&
                                                ...
                                                !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                                                    ...
                                                    (o.documentElement.style.position =
                                                        'absolute'))),
    ...
    var is,
        ...
        cs = function (A) {
            ...
            1 < C &&
                ((n /= C), (B /= C), (o /= C), (i /= C), (c /= C), (Q /= C), (u /= C), (U /= C))
            var g = t.width - o,
                E = t.height - Q,
                F = t.width - c,
                h = t.height - U,
            ...
            ;((this.topLeftBorderBox =
                0 < n || 0 < B ? us(t.left, t.top, n, B, is.TOP_LEFT) : new ts(t.left, t.top)),
    ...
    var ps = function (c, Q, w, u) {
        ...
        Ns = function (A, e) {
            for (
                var t = A instanceof Mn ? A.start : 1, r = A instanceof Mn && A.reversed, n = 0;
                n < e.length;
                n++
            ) {
                var B = e[n]
