        ...
        a.extend(a.SmartMenus, {
            ...
            prototype: {
                init: function (c) {
                    ...
                    if (!c) {
                        ...
                        ;(this.$root
                            ...
                            a(window).on(
                                d({ 'resize orientationchange': a.proxy(this.winResize, this) }, g)
                            ),
                    ...
                    if (
                        ((this.isCollapsible() && !c) ||
                            this.menuHideSubMenus(
                                this.activatedItems[e - 1] && this.activatedItems[e - 1][0] == b[0]
                                    ? e
                                    : e - 1
                            ),
                ...
                menuHideAll: function () {
                    ...
                    for (
                        var a = this.opts.isPopup ? 1 : 0, b = this.visibleSubMenus.length - 1;
                        b >= a;
                        b--
                    )
