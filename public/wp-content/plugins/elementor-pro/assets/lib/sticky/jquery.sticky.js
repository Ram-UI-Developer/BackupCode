...
;(function ($) {
    var Sticky = function (element, userSettings) {
        ...
        const updateElementSizesData = () => {
            ...
            if (settings.isRTL) {
                ...
                const documentWidth = settings.handleScrollbarWidth
                    ? window.innerWidth
        ...
        var followParent = function () {
            ...
            if (settings.isRTL) {
                ...
                elementOffsetValue = Math.max(
                    parentWidth - elementWidth - elementOffsetValueLeft,
                    0
                )
            }
    ...
    $.fn.sticky = function (settings) {
        ...
        this.each(function () {
            ...
            if (!instance) {
                throw Error(
                    'Trying to perform the `' + settings + '` method prior to initialization'
                )
            }
