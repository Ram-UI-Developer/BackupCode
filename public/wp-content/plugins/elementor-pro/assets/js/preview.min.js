...
;(() => {
    ...
    var e = {
            5030: (e, t, r) => {
                ...
                ;(Object.defineProperty(t, '__esModule', { value: !0 }),
                    ...
                    (t.default = function addDocumentHandle(
                        { element: e, id: t, title: r = n('Template', 'elementor-pro') },
                        u = a,
                        s = null,
                        l = null
                    ) {
                        if (a === u) {
                            ...
                            if (
                                ...
                                (function hasHandle(e) {
                                    return !!e.querySelector(`:scope > .${o}`)
                                })(e)
                            )
                                return
                        }
                        const p = (function createHandleElement(
                            { title: e, onClick: t },
                            r,
                            i = null
                        ) {
                            const u = ['header', 'footer'].includes(i?.dataset.elementorType)
                                    ? '%s'
                                    : n('Edit %s', 'elementor-pro'),
                                s = createElement({
                                    tag: 'div',
                                    classNames: [`${o}__inner`],
                                    children: [
                                        createElement({ tag: 'i', classNames: [getHandleIcon(r)] }),
                                        createElement({
                                            tag: 'div',
                                            classNames: [`${a === r ? o : c}__title`],
                                            children: [
                                                document.createTextNode(
                                                    a === r
                                                        ? u.replace('%s', e)
                                                        : n('Save %s', 'elementor-pro').replace(
                                                              '%s',
                                                              e
                                                          )
                                                )
                                ...
                                l = [o]
                            a !== r && l.push(c)
                            const p = createElement({ tag: 'div', classNames: l, children: [s] })
                            return (p.addEventListener('click', t), p)
                        })(
                            {
                                title: r,
                                onClick: () =>
                                    (async function onDocumentClick(e, t, r = null, n = null) {
                                        a === t
                        ...
                        ;(e.prepend(p), a === u && (e.dataset.editableElementorDocument = t))
                    }),
                    r(3517))
                const o = 'elementor-document-handle',
                    i = 'elementor-edit-mode',
                    a = (t.EDIT_CONTEXT = 'edit'),
                    c = 'elementor-document-save-back-handle',
                    u = (t.SAVE_CONTEXT = 'save')
                ...
                function createElement({ tag: e, classNames: t = [], children: r = [] }) {
                    const n = document.createElement(e)
                    return (n.classList.add(...t), r.forEach((e) => n.appendChild(e)), n)
                }
            },
            8003: (e) => {
                e.exports = wp.i18n
            ...
            2390: (e, t, r) => {
                ...
                e.exports = function (e, t) {
                    var r,
                        ...
                        m = e.global,
                        y = e.stat
                    if ((r = m ? n : y ? n[v] || c(v, {}) : (n[v] || {}).prototype))
                        for (l in t) {
                            if (
                                ((f = t[l]),
                                (p = e.dontCallGetSet ? (d = o(r, l)) && d.value : r[l]),
                                !s(m ? l : v + (y ? '.' : '#') + l, e.forced) && void 0 !== p)
                            ) {
                ...
                var n = r(6406),
                    ...
                    w = (e.exports = function (e, t, r) {
                        ;('Symbol(' === m(d(t), 0, 7) &&
                            ...
                            r && r.setter && (t = 'set ' + t),
                            (!a(e, 'name') || (u && e.name !== t)) &&
                                (c ? v(e, 'name', { value: t, configurable: !0 }) : (e.name = t)),
                            g &&
                                r &&
                                a(r, 'arity') &&
                                e.length !== r.arity &&
                        ...
                        var n = p(e)
                        return (
                            a(n, 'source') || (n.source = h(b, 'string' == typeof t ? t : '')),
                            e
                        )
                    })
            ...
            5079: (e, t, r) => {
                ...
                e.exports = function (e, t) {
                    ...
                    for (; t.length > s; ) o(n, (r = t[s++])) && (~a(l, r) || u(l, r))
                    return l
                }
            },
            1940: (e, t) => {
            ...
            4053: (e, t, r) => {
                ...
                e.exports =
                    ...
                    !o(function () {
                        ...
                        return (
                            !i(e) || !(Object(e) instanceof Symbol) || (!Symbol.sham && n && n < 41)
                        )
                    })
            },
            9961: (e, t, r) => {
            ...
            7936: (e, t, r) => {
                ...
                e.exports = function (e) {
                    return (i(l, e) || (l[e] = c && i(s, e) ? s[e] : p('Symbol.' + e)), l[e])
                }
            },
            3517: (e, t, r) => {
                var n = r(2390),
    ...
    ;(() => {
        var e = (function _interopRequireWildcard(e, t) {
        ...
        class Preview extends elementorModules.ViewModule {
            ...
            addDocumentClass() {
                ...
                e &&
                    e.$element &&
                    e.$element.parents('[data-elementor-id]').addClass('e-embedded-document-active')
            }
            removeDocumentClass() {
                Object.values(elementorFrontend.documentsManager.documents).forEach((e) => {
                    e.$element.get(0).classList.remove('e-embedded-document-active')
                })
            }
            createDocumentsHandles() {
                Object.values(elementorFrontend.documentsManager.documents).forEach((t) => {
                    const r = t.$element.get(0),
                        { elementorTitle: n, customEditHandle: o } = r.dataset
                    if (o) return
                    const i = t.getSettings('id')
                    ;(0, e.default)(
                        { element: r, title: n, id: i },
                        e.EDIT_CONTEXT,
                        null,
                        '.elementor-' + i
                    )
            ...
            onFrontendComponentsInit() {
                ;(this.addDocumentClass(),
                    ...
                    elementor.on('document:loaded', () => {
                        ;(this.addDocumentClass(), this.createDocumentsHandles())
                    }),
