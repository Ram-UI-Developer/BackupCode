...
/******/ ;(() => {
  ...
  \**********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _conditions = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./conditions */ '../modules/custom-code/assets/js/admin/publish-metabox/conditions.js'
                    )
                )
                var _conditionsConfig = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-pro-app-modules/site-editor/assets/js/context/services/conditions-config */ '../core/app/modules/site-editor/assets/js/context/services/conditions-config.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    ...
                    const [showModal, setShowModal] = (0, _react.useState)(false),
                        ...
                        onPostSubmit = () => {
                            ...
                            if (!title.$input.attr('value').length) {
                                ...
                                title.$input.attr(
                                    'value',
                                    __('Elementor Custom-Code #', 'elementor-pro') +
                                        elementorProAdmin.customCode.post.ID
                                )
                            }
                        },
                        onPublishClick = (e) => {
                        ...
                        onConditionsSaved = (args) => {
                            const conditions = args.conditions,
                                ...
                                { $form, $formConditions, $publishButton } = elements
                            ...
                            if ('auto-draft' === post.post_status || 'draft' === post.post_status) {
                                $formConditions
                                    .attr('type', 'hidden')
                                    .attr('name', '_conditions')
                                    .attr('value', JSON.stringify(conditions))
                                    .appendTo($form)
                            }
                        ...
                        initData = async () => {
                            ...
                            $e.data
                                .get(
                                    'site-editor/templates-conditions',
                                    {
                                        id: post.ID
                                    },
                                    {
                                ...
                                .then((result) => {
                                    ...
                                    const conditions = Object.values(result.data).map(
                                            (condition) => ({
                                                type: condition.type,
                                                name: condition.name,
                                        ...
                                        instances = Object.values(
                                            conditionsConfig.calculateInstances(conditions)
                                        ).join(',')
                                    setData((prevState) => ({
                                        ...prevState,
                                        conditions,
  ...
  \****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _conditions = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-pro-app-modules/site-editor/assets/js/context/conditions */ '../core/app/modules/site-editor/assets/js/context/conditions.js'
                    )
                )
                var _conditionsRows = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-pro-app-modules/site-editor/assets/js/pages/conditions/conditions-rows */ '../core/app/modules/site-editor/assets/js/pages/conditions/conditions-rows.js'
                    )
                )
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                __('Where Do You Want to Display Your Code?', 'elementor-pro')
                            ),
                            /*#__PURE__*/ _react.default.createElement(
                                _appUi.Text,
                                {
...
*/
  ...
  \*******************************************************/
        ...
        var _component = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-pro-app-modules/site-editor/assets/js/data/component */ '../core/app/modules/site-editor/assets/js/data/component.js'
            )
        )
        var _conditionsModal = _interopRequireDefault(
            __webpack_require__(
                /*! ./publish-metabox/conditions-modal */ '../modules/custom-code/assets/js/admin/publish-metabox/conditions-modal.js'
            )
        )
        var _elementorAiAdmin = _interopRequireDefault(
            __webpack_require__(/*! elementor-ai-admin */ 'elementor-ai-admin')
        )
        class CustomCode extends elementorModules.Module {
            ...
            initialize() {
                ...
                ReactDOM.render(
                    /*#__PURE__*/ _react.default.createElement(_conditionsModal.default, null),
                    document.querySelector('.post-conditions')
                )
                ...
                this.setOptionsPlacementVisibility(
                    'elementor_body_end' === jQuery('#location').val()
                )
            }
            addTipsyToFields() {
            ...
            addDescription() {
                const description =
                    '<p>' +
                    __(
                        'Manage and create all of your custom code here.<br />Organize all of your custom code and incorporate code snippets in your site. Add tracking codes, meta titles, and other scripts. Set display conditions, locations, and priority all from one place.',
                        'elementor-pro'
                    ) +
                    '&nbsp;<a target="_blank" href="https://go.elementor.com/wp-dash-custom-code">' +
            ...
            addOpenAIButton() {
                const $buttonOpenAI = jQuery(
                    `<button class="e-ai-button"><i class="eicon-ai"></i> ${__('Write me code', 'elementor-pro')}</button>`
                )
                $buttonOpenAI.on('click', (event) => {
                    ...
                    // eslint-disable-next-line react/no-deprecated
                    ReactDOM.render(
                        /*#__PURE__*/ _react.default.createElement(_elementorAiAdmin.default, {
                            type: 'code',
                            getControlValue: () =>
