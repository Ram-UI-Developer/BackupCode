...
;(self['webpackChunkelementor_pro'] = self['webpackChunkelementor_pro'] || []).push([
                ...
                class Animate extends $e.modules.CommandBase {
                    ...
                    apply() {
                        const pageTransition =
                            elementor.$previewContents[0].querySelector('e-page-transition')
                        if (!pageTransition) {
                            return
                        }
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _animate = __webpack_require__(
                    /*! ./animate */ '../modules/page-transitions/assets/js/editor/commands/animate.js'
                )
  ...
  \*****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var commands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands/ */ '../modules/page-transitions/assets/js/editor/commands/index.js'
                    )
                )
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/page-transitions/assets/js/editor/hooks/index.js'
                    )
                )
                var _pageTransitionPreview = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./hooks/routes/page-transition-preview */ '../modules/page-transitions/assets/js/editor/hooks/routes/page-transition-preview.js'
                    )
                )
                ...
                class Component extends $e.modules.ComponentBase {
                    ...
                    initRouteHooks() {
                        ...
                        this.routesHooks.pageTransitionPreview =
                            new _pageTransitionPreview.default()
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _animatePageTransition = __webpack_require__(
                    /*! ./animate-page-transition */ '../modules/page-transitions/assets/js/editor/hooks/data/animate-page-transition.js'
                )
                var _reRenderPageTransition = __webpack_require__(
                    /*! ./re-render-page-transition */ '../modules/page-transitions/assets/js/editor/hooks/data/re-render-page-transition.js'
                )
  ...
  \********************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _utils = __webpack_require__(
                    /*! ../utils */ '../modules/page-transitions/assets/js/editor/hooks/utils.js'
                )
                /**
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data */ '../modules/page-transitions/assets/js/editor/hooks/data/index.js'
                )
                ...
                class PageTransitionPreview {
                    ...
                    run(component, route) {
                        if ('panel/global/settings-page-transitions' === route) {
                            ;(0, _utils.renderPageTransition)(
                                elementor.documents.getCurrent().container
                            )
                    ...
                    togglePageTransitionPreview(on = true) {
                        const className = 'e-page-transition--preview',
                            pageTransition =
                                elementor.$previewContents[0].body.querySelector(
                                    'e-page-transition'
                                )
                        if (!pageTransition) {
                            return
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                function getPageTransitionSettings(container) {
                    ...
                    const controls = Object.entries(container.settings.getActiveControls()).filter(
                        ([key, control]) => {
                ...
                function renderPageTransition(container) {
                    let pageTransition =
                        elementor.$previewContents[0].querySelector('e-page-transition')
                    const hasEntranceAnimation = !!container.settings.get(
                            `${prefix}entrance_animation`
                        ),
  ...
  \**************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/page-transitions/assets/js/editor/component.js'
                    )
                )
