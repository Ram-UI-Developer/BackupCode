  ...
  \**************************************************************/
    ...
    class Screenshot extends elementorModules.ViewModule {
        ...
        getDefaultElements() {
            ...
            const $sections = $elementor.find(
                '.elementor-section-wrap > .elementor-section, .elementor > .elementor-section'
            )
            return {
                $elementor,
                $sections,
                $firstSection: $sections.first(),
                $notElementorElements: elementorCommon.elements.$body
                    .find('> *:not(style, link)')
                    .not($elementor),
                $head: jQuery('head')
            }
        ...
        onInit() {
            ...
            this.timeoutTimer = setTimeout(
                this.screenshotFailed.bind(this),
