...
/******/ ;(() => {
            ...
            /***/ (module) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    ...
                    addControlSpinner(controlName) {
                        ...
                        $el.find('.elementor-control-title').after(
                    ...
                    addControlError(controlName, error, location = '.elementor-control-content') {
                        ...
                        $el.find(location)
                            .first()
                            .after(
                                `<span class="elementor-control-field-description e-control-error">${error}</span>`
                            )
                    },
                    /**
                    ...
                    addSectionListener(section, callback) {
                        ...
                        elementor.channels.editor.on(
                            ...
                            function (sectionName, editor) {
                                ...
                                if (
                                    self.elementType === currentElementType &&
                                    section === sectionName
                                ) {
                                    setTimeout(function () {
  ...
  \****************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                // TODO: Read from Core.
                const TIERS_PRIORITY = (exports.TIERS_PRIORITY = Object.freeze([
                    'free',
                    'essential',
                    'essential-oct2023',
                    'advanced',
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function addDocumentHandle(
                    { element, id, title = __('Template', 'elementor-pro') },
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _templates = __webpack_require__(
                    /*! ./templates */ '../core/app/modules/site-editor/assets/js/data/commands/templates.js'
                )
                var _conditionsConfig = __webpack_require__(
                    /*! ./conditions-config */ '../core/app/modules/site-editor/assets/js/data/commands/conditions-config.js'
                )
                var _templatesConditions = __webpack_require__(
                    /*! ./templates-conditions */ '../core/app/modules/site-editor/assets/js/data/commands/templates-conditions.js'
                )
                var _templatesConditionsConflicts = __webpack_require__(
                    /*! ./templates-conditions-conflicts */ '../core/app/modules/site-editor/assets/js/data/commands/templates-conditions-conflicts.js'
                )
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var dataCommands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands */ '../core/app/modules/site-editor/assets/js/data/commands/index.js'
                    )
                )
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./data/component */ '../core/app/modules/site-editor/assets/js/data/component.js'
                    )
                )
                var _commands = __webpack_require__(
                    /*! ./data/commands */ '../core/app/modules/site-editor/assets/js/data/commands/index.js'
                )
                class Module extends elementorModules.editor.utils.Module {
                    onElementorInit() {
                        ...
                        if (config.support_site_editor) {
                            ...
                            $e.data.deleteCache(
                                $e.components.get(_component.default.namespace),
                                _commands.Templates.signature
                            )
                        }
                    }
                }
  ...
  \************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    onElementorInit() {
                        var FontsManager = __webpack_require__(
                            /*! ./font-manager */ '../modules/assets-manager/assets/js/editor/font-manager.js'
                        )
                        this.assets = {
                            ...
                            success(data) {
                                if (data.font_face) {
                                    elementor.$previewContents
                                        ...
                                        .last()
                                        .after(
                                            '<style type="text/css">' + data.font_face + '</style>'
                                        )
                                }
                                if (data.font_url) {
                                    elementor.$previewContents
            ...
            /***/ (module) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    ...
                    onSectionActivated(sectionName, editor) {
                        ...
                        var isSideBSection =
                            -1 !==
                            ['section_side_b_content', 'section_style_b'].indexOf(sectionName)
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/forms/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    ...
                    updateMap(fields) {
                        ...
                        _.each(fields, function (field) {
                            var model = {
                                ...
                                remote_required: field.remote_required
                                    ? field.remote_required
                                    : false,
  ...
  \********************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _fieldsRepeaterRow = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./fields-repeater-row */ '../modules/forms/assets/js/editor/fields-repeater-row.js'
                    )
                )
                module.exports = class extends elementor.modules.controls.Repeater {
                    ...
                    initialize(...args) {
                        ...
                        this.listenTo(formFields, 'change', (model) =>
                            this.onFormFieldChange(model)
                    ...
                    onFormFieldChange(model) {
                        ...
                        if (
                            !fieldType ||
                            ('step' !== fieldType &&
                                'step' !== model._previousAttributes.field_type)
                        ) {
                            return
                        }
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    ...
                    onInit() {
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/acceptance',
                            this.renderField,
                            10,
                            4
                        )
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    renderField(inputField, item, i, settings) {
                        ...
                        return (
                            ...
                            max +
                            placeholder +
                            ' pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" type="date" class="elementor-field-textual elementor-date-field elementor-field elementor-size-' +
                            settings.input_size +
                            ' ' +
                            itemClasses +
                            '" name="form_field_' +
                    ...
                    onInit() {
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/date',
                            this.renderField,
                            10,
                            4
                        )
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    renderField(inputField, item, i, settings) {
                        ...
                        return (
                            '<input size="1" type="' +
                            item.field_type +
                            '" class="elementor-field-textual elementor-field elementor-size-' +
                            settings.input_size +
                            ' ' +
                            itemClasses +
                            '" name="form_field_' +
                    ...
                    onInit() {
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/tel',
                            this.renderField,
                            10,
                            4
                        )
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    renderField(inputField, item, i, settings) {
                        ...
                        return (
                            ...
                            placeholder +
                            ' class="elementor-field-textual elementor-time-field elementor-field elementor-size-' +
                            settings.input_size +
                            ' ' +
                            itemClasses +
                            '" name="form_field_' +
                    ...
                    onInit() {
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/time',
                            this.renderField,
                            10,
                            4
                        )
  ...
  \**********************************************************/
            /***/ (module) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    ...
                    onInit() {
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/upload',
                            this.renderField,
                            10,
                            4
                        )
                        ...
                        if (customId.match(this.ID_SANITIZE_FILTER)) {
                            ...
                            containers.forEach((container) => {
                                const panelView = container.panel.getControlView('form_fields'),
                                    currentItemView = panelView.children.findByModel(
                                        container.settings
                                    ),
                                    idView = currentItemView.children.find(
                                        (view) => 'custom_id' === view.model.get('name')
                                    )
                                idView.render()
                ...
                class FormFieldsSetCustomId extends $e.modules.hookData.After {
                    ...
                    apply(args, model) {
                        const { containers = [args.container] } = args,
                            isDuplicate = $e.commands.isCurrentFirstTrace(
                                'document/repeater/duplicate'
                            )
                        containers.forEach((/** Container */ container) => {
                            const itemContainer = container.repeaters.form_fields.children.find(
                                (childrenContainer) => {
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class FormFieldsAddFirstStep extends $e.modules.hookData.After {
                    ...
                    getConditions(args) {
                        const { containers = [args.container] } = args
                        return (
                            'form' === containers[0].parent.parent.model.get('widgetType') &&
                            'step' === args.settings.field_type
                        )
                    }
                    apply(args) {
                        const { containers = [args.container] } = args
  ...
  \*************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _formFieldsSanitizeCustomId = __webpack_require__(
                    /*! ./form-fields-sanitize-custom-id */ '../modules/forms/assets/js/editor/hooks/data/form-fields-sanitize-custom-id.js'
                )
                var _formFieldsSetCustomId = __webpack_require__(
                    /*! ./form-fields-set-custom-id */ '../modules/forms/assets/js/editor/hooks/data/form-fields-set-custom-id.js'
                )
                var _formFieldsStep = __webpack_require__(
                    /*! ./form-fields-step */ '../modules/forms/assets/js/editor/hooks/data/form-fields-step.js'
                )
                var _formSanitizeId = __webpack_require__(
                    /*! ./form-sanitize-id */ '../modules/forms/assets/js/editor/hooks/data/form-sanitize-id.js'
                )
  ...
  \********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data/ */ '../modules/forms/assets/js/editor/hooks/data/index.js'
                )
                ...
                var _ui = __webpack_require__(
                    /*! ./ui/ */ '../modules/forms/assets/js/editor/hooks/ui/index.js'
                )
  ...
  \**********************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class FormFieldsUpdateShortCode extends $e.modules.hookUI.After {
                    ...
                    getConditions(args) {
                        if (
                            !$e.routes.isPartOf('panel/editor') ||
                            undefined === args.settings.custom_id
                        ) {
                            return false
                        }
                        return true
                    ...
                    apply(args) {
                        ...
                        containers.forEach((/** Container */ container) => {
                            const panelView = container.panel.getControlView('form_fields'),
                                currentItemView = panelView.children.find(
                                    (view) => container.id === view.model.get('_id')
                                ),
                                shortcodeView = currentItemView.children.find(
                                    (view) => 'shortcode' === view.model.get('name')
                                )
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _formFieldsUpdateShortcode = __webpack_require__(
                    /*! ./form-fields-update-shortcode */ '../modules/forms/assets/js/editor/hooks/ui/form-fields-update-shortcode.js'
                )
  ...
  \************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var BaseIntegrationModule = __webpack_require__(
                    /*! ./base */ '../modules/forms/assets/js/editor/integrations/base.js'
                )
                module.exports = BaseIntegrationModule.extend({
                    ...
                    onApiUpdate() {
                        const self = this,
                            ...
                            apiCredControlView = self.getEditorControlView(
                                'activecampaign_api_credentials_source'
                            )
                        if (
                            'default' !== apiCredControlView.getControlValue() &&
                        ...
                        self.getActiveCampaignCache('lists', 'activecampaign_list', cacheKey).done(
                            function (data) {
                    ...
                    updateFieldsMapping() {
                        ...
                        this.getEditorControlView('activecampaign_fields_map').updateMap(
                            remoteFields
                        )
                    },
                    getActiveCampaignCache(type, action, cacheKey, requestArgs) {
                        ...
                        requestArgs = _.extend({}, requestArgs, {
                            ...
                            api_cred: this.getEditorControlView(
                                'activecampaign_api_credentials_source'
                            ).getControlValue()
                        })
  ...
  \**************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var ElementEditorModule = __webpack_require__(
                    /*! elementor-pro/editor/element-editor-module */ '../assets/dev/js/editor/element-editor-module.js'
                )
                module.exports = ElementEditorModule.extend({
                    ...
                    fetchCache(type, cacheKey, requestArgs, immediately = false) {
                        return elementorPro.ajax.addRequest(
                            'forms_panel_action_data',
                            {
  ...
  \********************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = BaseIntegrationModule.extend({
                    ...
                    onApiUpdate() {
                        var self = this,
                            apiKeyControlView = self.getEditorControlView(
                                'convertkit_api_key_source'
                            ),
                            customApikeyControlView = self.getEditorControlView(
                                'convertkit_custom_api_key'
                            )
                        if (
                            'default' !== apiKeyControlView.getControlValue() &&
                        ...
                        self.getConvertKitCache('data', 'convertkit_get_forms', cacheKey).done(
                            function (data) {
                    ...
                    getConvertKitCache(type, action, cacheKey, requestArgs) {
                        ...
                        requestArgs = _.extend({}, requestArgs, {
                            ...
                            api_key: this.getEditorControlView(
                                'convertkit_api_key_source'
                            ).getControlValue(),
                            custom_api_key: this.getEditorControlView(
                                'convertkit_custom_api_key'
                            ).getControlValue()
                        })
                        return this.fetchCache(type, cacheKey, requestArgs)
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = BaseIntegrationModule.extend({
                    ...
                    onApiUpdate() {
                        ...
                        if (
                            'default' !== controlView.getControlValue() &&
                    ...
                    getDripCache(type, action, cacheKey, requestArgs) {
                        ...
                        requestArgs = _.extend({}, requestArgs, {
                            ...
                            custom_api_token:
                                this.getEditorControlView('drip_custom_api_token').getControlValue()
                        })
                        return this.fetchCache(type, cacheKey, requestArgs)
                    }
                })
                ...
                module.exports = BaseIntegrationModule.extend({
                    ...
                    onApiUpdate() {
                        var self = this,
                            ...
                            customControlView = self.getEditorControlView(
                    ...
                    updatGetResonseList() {
                        ...
                        self.getCache('fields', 'get_fields', cacheKey, {
                            ...
                            self.getEditorControlView('getresponse_fields_map').updateMap(
                                data.fields
                            )
                        })
                    },
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = BaseIntegrationModule.extend({
                    ...
                    onApiUpdate() {
                        ...
                        // Fetch data
                        self.getMailchimpCache('lists', 'lists', cacheKey)
                            .done(function (data) {
                    ...
                    updatMailchimpList() {
                        ...
                        self.getMailchimpCache(
                            ...
                            .done(function (data) {
                                ...
                                self.getEditorControlView('mailchimp_fields_map').updateMap(
                                    data.list_details.fields
                                )
                            })
                            .fail(function (error) {
                    ...
                    getMailchimpCache(type, action, cacheKey, requestArgs, immediately = false) {
                        ...
                        requestArgs = _.extend({}, requestArgs, {
                            ...
                            api_key:
                                this.getEditorControlView('mailchimp_api_key').getControlValue(),
  ...
  \********************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                const BaseIntegrationModule = __webpack_require__(
                    /*! ./base */ '../modules/forms/assets/js/editor/integrations/base.js'
                )
                module.exports = BaseIntegrationModule.extend({
                    fields: {},
  ...
  \***************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/forms/assets/js/editor/component.js'
                    )
                )
                class FormsModule extends elementorModules.editor.utils.Module {
                    onElementorInit() {
                        const ReplyToField = __webpack_require__(
                                /*! ./reply-to-field */ '../modules/forms/assets/js/editor/reply-to-field.js'
                            ),
                            Recaptcha = __webpack_require__(
                                /*! ./recaptcha */ '../modules/forms/assets/js/editor/recaptcha.js'
                            ),
                            MailerLite = __webpack_require__(
                                /*! ./integrations/mailerlite */ '../modules/forms/assets/js/editor/integrations/mailerlite.js'
                            ),
                            Mailchimp = __webpack_require__(
                                /*! ./integrations/mailchimp */ '../modules/forms/assets/js/editor/integrations/mailchimp.js'
                            ),
                            Drip = __webpack_require__(
                                /*! ./integrations/drip */ '../modules/forms/assets/js/editor/integrations/drip.js'
                            ),
                            ActiveCampaign = __webpack_require__(
                                /*! ./integrations/activecampaign */ '../modules/forms/assets/js/editor/integrations/activecampaign.js'
                            ),
                            GetResponse = __webpack_require__(
                                /*! ./integrations/getresponse */ '../modules/forms/assets/js/editor/integrations/getresponse.js'
                            ),
                            ConvertKit = __webpack_require__(
                                /*! ./integrations/convertkit */ '../modules/forms/assets/js/editor/integrations/convertkit.js'
                            )
                        ...
                        // Form fields
                        const TimeField = __webpack_require__(
                                /*! ./fields/time */ '../modules/forms/assets/js/editor/fields/time.js'
                            ),
                            DateField = __webpack_require__(
                                /*! ./fields/date */ '../modules/forms/assets/js/editor/fields/date.js'
                            ),
                            AcceptanceField = __webpack_require__(
                                /*! ./fields/acceptance */ '../modules/forms/assets/js/editor/fields/acceptance.js'
                            ),
                            UploadField = __webpack_require__(
                                /*! ./fields/upload */ '../modules/forms/assets/js/editor/fields/upload.js'
                            ),
                            TelField = __webpack_require__(
                                /*! ./fields/tel */ '../modules/forms/assets/js/editor/fields/tel.js'
                            )
                        this.Fields = {
                        ...
                        elementor.addControlView(
                            'Fields_map',
                            __webpack_require__(
                                /*! ./fields-map-control */ '../modules/forms/assets/js/editor/fields-map-control.js'
                            )
                        )
                        elementor.addControlView(
                            'form-fields-repeater',
                            __webpack_require__(
                                /*! ./fields-repeater-control */ '../modules/forms/assets/js/editor/fields-repeater-control.js'
                            )
                        )
                    }
            ...
            /***/ (module) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    ...
                    onInit() {
                        ...
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/recaptcha',
                            this.renderField,
                            10,
                            2
                        )
                        elementor.hooks.addFilter(
                            'elementor_pro/forms/content_template/field/recaptcha_v3',
                            this.renderField,
                            10,
                            2
                        )
  ...
  \***********************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                'use strict'
                /* provided dependency */ var sprintf = __webpack_require__(
                    /*! @wordpress/i18n */ '@wordpress/i18n'
                )['sprintf']
                /* provided dependency */ var __ = __webpack_require__(
                    /*! @wordpress/i18n */ '@wordpress/i18n'
                    ...
                    var updateReplyToOptions = function () {
                        ...
                        emailFields = _.map(emailModels, function (model) {
                            return {
                                ...
                                label: sprintf(
                                    __('%s Field', 'elementor-pro'),
                                    model.get('field_label')
                                )
                            }
                        })
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _templates = __webpack_require__(
                    /*! ./templates */ '../modules/global-widget/assets/js/editor/commands-data/templates.js'
                )
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class Templates extends $e.modules.CommandData {
                    ...
                    onAfterApply(args = {}, result) {
                        ...
                        $e.data.deleteCache(
                            this.component,
                            'document/global/global-widget/templates',
                            args.query
                        )
                        Object.entries(result.data).forEach(([templateID, data]) => {
                            $e.data.setCache(
                                this.component,
                                `document/global/global-widget/templates/${templateID}`,
                                {},
                                data
                            )
                        })
  ...
  \****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _saveTemplates = __webpack_require__(
                    /*! ./save-templates */ '../modules/global-widget/assets/js/editor/commands-internal/save-templates.js'
                )
  ...
  \*************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class SaveTemplates extends $e.modules.CommandInternalBase {
                    apply() {
                        const templateModels = this.getCurrentTemplatesModels(
                            ...
                            elementorCommon.ajax.addRequest('update_templates', {
                                ...
                                success: () => {
                                    ...
                                    templateModels.forEach((template) => {
                                        ...
                                        $e.data.setCache(
                                            this.component,
                                            `document/global/global-widget/templates/${template.id}`,
                                            {},
                                            {
                                                settings
                                            }
                    ...
                    getCurrentTemplatesModels(changedContainersId) {
                        ...
                        Object.entries(changedContainersId).forEach(([templateID, containerId]) => {
                            const templateData = $e.data.getCache(
                                this.component,
                                `document/global/global-widget/templates/${templateID}`
                            )
                            if (!templateData) {
                                if ($e.devTools) {
                                    $e.devTools.log.warn(
                                        `$e.data.getCache( component, \`document/global/global-widget/templates/${templateID}\` ) - not found.`
                                    )
                                }
                            }
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _link = __webpack_require__(
                    /*! ./link */ '../modules/global-widget/assets/js/editor/commands/link.js'
                )
                var _unlink = __webpack_require__(
                    /*! ./unlink */ '../modules/global-widget/assets/js/editor/commands/unlink.js'
                )
                ...
                class Link extends $e.modules.editor.document.CommandHistoryBase {
                    validateArgs(args) {
                        ...
                        containers.forEach((/* Container */ container) => {
                            if ('global' === container.model.get('widgetType')) {
                                throw Error(
                                    `Invalid container, id: '${container.id}' is already global.`
                                )
                            }
                        })
                    }
                    ...
                    apply(args) {
                        ...
                        containers.forEach((/** Container */ container) => {
                            ...
                            const elementModel = elementorPro.modules.globalWidget.addGlobalWidget(
                                    data.template_id,
                                    data
                                ),
                            ...
                            $e.data.setCache(
                                this.component,
                                `document/global/global-widget/templates/${data.template_id}`,
                                {},
                                data
                            )
  ...
  \********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class Unlink extends $e.modules.editor.document.CommandHistoryBase {
                    ...
                    async apply(args) {
                        const { containers = [args.container] } = args
                        const ids = containers.map((/** Container */ container) =>
                            container.model.get('templateID')
                        )
                        const { data } = await $e.data.get('document/global/templates', {
                            ids
                        })
                        containers.forEach((/** Container */ container) => {
                            const id = container.model.get('templateID'),
                                elementModel = elementorPro.modules.globalWidget.createGlobalModel(
                                    id,
                                    data[id]
                                )
                            $e.run('document/elements/create', {
                                ...
                                model: {
                                    ...
                                    settings: elementorCommon.helpers.cloneObject(
                                        elementModel.get('settings').attributes
                                    ),
                                    defaultEditSettings: elementorCommon.helpers.cloneObject(
                                        elementModel.get('editSettings').attributes
                                    )
                                },
                                options: {
  ...
  \**************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var commands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands/ */ '../modules/global-widget/assets/js/editor/commands/index.js'
                    )
                )
                var commandsInternal = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands-internal/ */ '../modules/global-widget/assets/js/editor/commands-internal/index.js'
                    )
                )
                var commandsData = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands-data/ */ '../modules/global-widget/assets/js/editor/commands-data/index.js'
                    )
                )
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/global-widget/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    ...
                    updateGlobalsRecursive(targetContainer) {
                        ...
                        elementor.getPreviewContainer().forEachChildrenRecursive((container) => {
                            ...
                            if (
                                ...
                                parseInt(container.model.get('templateID')) ===
                                    parseInt(targetContainer.model.get('templateID'))
                            ) {
                                modelsToUpdate.forEach((modelName) => {
                                    ...
                                    if (model instanceof Backbone.Model) {
                                        const accordingTo =
                                            'settings' === modelName
                                                ? targetContainer.settings.attributes
                                                : model.changed
                ...
                class BaseGlobalWidgetPrepareUpdate extends $e.modules.hookData.After {
                    getConditions(args) {
                        ...
                        return containers.some((container) =>
                            container.renderer?.model?.get('templateID')
                        )
                    }
                    apply(args) {
                        const { containers = [args.container] } = args,
                        ...
                        component.lastChangedContainers = globalWidgetContainers.map(
                            (container) => container.renderer
                        )
                        globalWidgetContainers.forEach((container) => {
                            component.changedContainersId[
                                container.renderer.model.get('templateID')
                            ] = container.renderer.id
                        })
                    }
                }
  ...
  \************************************************************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _baseGlobalWidgetPrepareUpdate = __webpack_require__(
                    /*! ../../../base-global-widget-prepare-update */ '../modules/global-widget/assets/js/editor/hooks/data/base-global-widget-prepare-update.js'
                )
                /**
                 * Hook is responsible for saving last changed global widget and update
                 * which containers are needed for updating the template.
                ...
                exports.GlobalWidgetPrepareUpdateElementSetSettings =
                    GlobalWidgetPrepareUpdateElementSetSettings
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class GlobalWidgetDoUpdate extends $e.modules.hookData.After {
                    ...
                    apply() {
                        ...
                        containers.forEach((container) =>
                            component.updateGlobalsRecursive(container)
                        )
  ...
  \*************************************************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _baseGlobalWidgetPrepareUpdate = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../../../base-global-widget-prepare-update */ '../modules/global-widget/assets/js/editor/hooks/data/base-global-widget-prepare-update.js'
                    )
                )
                ...
                exports.GlobalWidgetPrepareUpdateRepeaterInsert =
  ...
  \*************************************************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports.GlobalWidgetPrepareUpdateRepeaterRemove =
                    GlobalWidgetPrepareUpdateRepeaterRemove
  ...
  \***************************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class GlobalWidgetSaveTemplates extends $e.modules.hookData.After {
                    ...
                    getConditions(args) {
                        if (
                            !Object.keys($e.components.get('document/global').changedContainersId)
                                .length
                        ) {
                            return false
                        }
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class GlobalWidgetLoadTemplates extends $e.modules.hookData.After {
                    ...
                    apply() {
                        ...
                        Object.entries(elementorPro.config.widget_templates).forEach(
                            ([id, data]) => {
                    ...
                    addTemplateToCache(id) {
                        const container = elementor
                            .getPreviewContainer()
                            .findChildrenRecursive(
                                (i) => parseInt(i.model.get('templateID')) === parseInt(id)
                            )
                        if (!container) {
                        ...
                        $e.data.setCache(
                            this.component,
                            `document/global/global-widget/templates/${id}`,
                            {},
                            args
                        )
                    }
  ...
  \*********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _globalWidgetPrepareUpdateElementSetSettings = __webpack_require__(
                    /*! ./document/elements/set-settings/global-widget-prepare-update-element-set-settings */ '../modules/global-widget/assets/js/editor/hooks/data/document/elements/set-settings/global-widget-prepare-update-element-set-settings.js'
                )
                var _globalWidgetPrepareUpdateRepeaterInsert = __webpack_require__(
                    /*! ./document/repeater/insert/global-widget-prepare-update-repeater-insert */ '../modules/global-widget/assets/js/editor/hooks/data/document/repeater/insert/global-widget-prepare-update-repeater-insert.js'
                )
                var _globalWidgetPrepareUpdateRepeaterRemove = __webpack_require__(
                    /*! ./document/repeater/remove/global-widget-prepare-update-repeater-remove */ '../modules/global-widget/assets/js/editor/hooks/data/document/repeater/remove/global-widget-prepare-update-repeater-remove.js'
                )
                var _globalWidgetDoUpdate = __webpack_require__(
                    /*! ./document/history/end-log/global-widget-do-update */ '../modules/global-widget/assets/js/editor/hooks/data/document/history/end-log/global-widget-do-update.js'
                )
                var _globalWidgetSaveTemplates = __webpack_require__(
                    /*! ./document/save/save/global-widget-save-templates */ '../modules/global-widget/assets/js/editor/hooks/data/document/save/save/global-widget-save-templates.js'
                )
                var _globalWidgetLoadTemplates = __webpack_require__(
                    /*! ./editor/documents/attach-preview/global-widget-load-templates */ '../modules/global-widget/assets/js/editor/hooks/data/editor/documents/attach-preview/global-widget-load-templates.js'
                )
  ...
  \****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data/ */ '../modules/global-widget/assets/js/editor/hooks/data/index.js'
                )
                Object.keys(_data).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _data[key]) return
                ...
                var _ui = __webpack_require__(
                    /*! ./ui/ */ '../modules/global-widget/assets/js/editor/hooks/ui/index.js'
                )
                Object.keys(_ui).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _ui[key]) return
                ...
                class GlobalWidgetHistoryUpdate extends $e.modules.hookUI.After {
                    ...
                    getConditions(args) {
                        ...
                        return (
                            ...
                            containers.some((container) => container.model.get('templateID'))
                        )
                    }
                    apply(args) {
                        const { containers = [args.container] } = args
                        containers.forEach((container) =>
                            $e.components.get('document/global').updateGlobalsRecursive(container)
                        )
                    }
                }
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _globalWidgetHistoryUpdate = __webpack_require__(
                    /*! ./document/elements/set-settings/global-widget-history-update */ '../modules/global-widget/assets/js/editor/hooks/ui/document/elements/set-settings/global-widget-history-update.js'
                )
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/global-widget/assets/js/editor/component.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    panelWidgets = new Backbone.Collection()
                    addGlobalWidget(templateId, templateData) {
                        return this.panelWidgets.add(
                            this.createGlobalModel(templateId, templateData)
                        )
                    }
                    createGlobalModel(templateId, templateData) {
                        ...
                        const elementModel = new elementor.modules.elements.models.Element(
                            templateData
                        )
                    ...
                    setWidgetType() {
                        elementor.hooks.addFilter('element/view', function (DefaultView, model) {
                            if (model.get('templateID')) {
                                return __webpack_require__(
                                    /*! ./widget/view */ '../modules/global-widget/assets/js/editor/widget/view.js'
                                )['default']
                            }
                            return DefaultView
                        })
                        elementor.hooks.addFilter('element/model', function (DefaultModel, attrs) {
                            if (attrs.templateID) {
                                return __webpack_require__(
                                    /*! ./widget/model */ '../modules/global-widget/assets/js/editor/widget/model.js'
                                )['default']
                            }
                            return DefaultModel
                        })
                    ...
                    registerTemplateType() {
                        elementor.templates.registerTemplateType('widget', {
                            ...
                            saveDialog: {
                                ...
                                description: __(
                                    "You'll be able to add this global widget to multiple areas on your site, and edit it from one single place.",
                                    'elementor-pro'
                                )
                            },
                    ...
                    addPanelPage() {
                        elementor.getPanelView().addPage('globalWidget', {
                            view: __webpack_require__(
                                /*! ./views/panel-page */ '../modules/global-widget/assets/js/editor/views/panel-page.js'
                            )
                        })
                    }
                        ...
                        elementor.hooks.addFilter(
                            ...
                            (groups, widget) => {
                                ...
                                if (elementorPro.config.should_show_promotion) {
                                    const iconLink =
                                        '<i class="eicon-advanced"></i>' +
                                        '<a class="elementor-context-menu-list__item__shortcut--link-fullwidth" href="https://go.elementor.com/go-pro-advanced-global-widget-context-menu/" target="_blank" rel="noopener noreferrer"></a>'
                    ...
                    filterRegionViews(regionViews) {
                        if (elementorPro.config.should_show_promotion) {
                            _.extend(regionViews.global, {
                                view: __webpack_require__(
                                    /*! ./views/promotion */ '../modules/global-widget/assets/js/editor/views/promotion.js'
                                ),
                                options: {}
                            })
                            return regionViews
                        ...
                        _.extend(regionViews.global, {
                            view: __webpack_require__(
                                /*! ./views/global-templates-view */ '../modules/global-widget/assets/js/editor/views/global-templates-view.js'
                            ),
                            options: {
                    ...
                    onElementorInit() {
                        elementor.on('panel:init', () => {
                            elementor.hooks.addFilter(
                                ...
                                this.filterRegionViews.bind(this)
                            )
                        })
                    ...
                    onWidgetTemplateSaved(data) {
                        ...
                        const container = elementor.getContainer(
  ...
  \********************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports =
                    elementor.modules.layouts.panel.pages.elements.views.Elements.extend({
                        ...
                        getEmptyView() {
                            ...
                            return __webpack_require__(
                                /*! ./no-templates */ '../modules/global-widget/assets/js/editor/views/no-templates.js'
                            )
                        },
                        onFilterEmpty() {}
                    })
  ...
  \***********************************************************************/
            /***/ (module) => {
                ...
                module.exports = GlobalWidgetsView.extend({
                    ...
                    className:
                        'elementor-nerd-box elementor-panel-nerd-box e-responsive-panel-stretch'
                })
                ...
                module.exports = Marionette.ItemView.extend({
                    ...
                    buildUnlinkDialog() {
                        ...
                        return elementorCommon.dialogsManager.createWidget('confirm', {
                            ...
                            message: __(
                                "This will make the widget stop being global. It'll be reverted into being just a regular widget.",
                                'elementor-pro'
                            ),
                            position: {
                                my: 'center center',
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class View extends WidgetView {
                    ...
                    getContainer() {
                        ...
                        container.label =
                            container.label + ' (' + __('global', 'elementor-pro') + ')'
                        return container
                    }
                    render() {
                        super.render()
                    ...
                    removeInlineAddingAttributes() {
                        const globalWidgetElementDom = this.el.querySelector(
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    onElementorPreviewLoaded() {
                        var EditButton = __webpack_require__(
                            /*! ./editor/edit-button */ '../modules/library/assets/js/editor/edit-button.js'
                        )
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    ...
                    self.onPanelShow = function (panel) {
                        ...
                        self.templateIdView = panel.content.currentView.children.findByModelCid(
                            model.cid
                        )

                        // Change Edit link on render & on change template.
                        self.templateIdView.elementSettingsModel.on(
                            'change',
                    ...
                    self.onTemplateIdChange = function () {
                        var templateID =
                                self.templateIdView.elementSettingsModel.get('template_id'),
                        ...
                        if ($editButton.length) {
                            ...
                            $editButton = jQuery('<a />', {
                                ...
                                href: editUrl,
                                html:
                                    '<i class="eicon-pencil" /> ' +
                                    __('Edit Template', 'elementor-pro')
                            })
                            self.templateIdView.$el
                    ...
                    self.init = function () {
                        elementor.hooks.addAction(
                            'panel/open_editor/widget/template',
                            self.onPanelShow
                        )
                    }
                    self.init()
  ...
  \*************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/loop-builder/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \***************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _addLoopBuildersTab = __webpack_require__(
                    /*! ./ui/editor/documents/open/add-loop-builders-tab */ '../modules/loop-builder/assets/js/editor/hooks/ui/editor/documents/open/add-loop-builders-tab.js'
                )
                var _removeLoopBuildersTab = __webpack_require__(
                    /*! ./ui/editor/documents/close/remove-loop-builders-tab */ '../modules/loop-builder/assets/js/editor/hooks/ui/editor/documents/close/remove-loop-builders-tab.js'
                )
  ...
  \**********************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/loop-builder/assets/js/editor/component.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                ...
                class loopBuilderModule extends elementorModules.editor.utils.Module {
                    ...
                    createTemplate() {
                        setTimeout(() => {
                            elementor
                                .getPanelView()
                                .getCurrentPageView()
                                .activateSection('section_layout')
                                ._renderChildren()
                            this.getEditorControlView('template_id').createTemplate()
                        })
                    }
                    createDocumentSaveHandles() {
                        Object.entries(elementorFrontend.config?.elements?.data).forEach(
                            ([cid, element]) => {
                                ...
                                const widgetSelector = `.elementor-element[data-model-cid="${cid}"]`,
                                    ...
                                    editHandleElement = elementorFrontend.elements.$body
                                        .find(`${widgetSelector} ${editHandleSelector}`)
                                        .first()[0]
                                if (editHandleElement) {
                                    ;(0, _documentHandle.default)(
                                        ...
                                        _documentHandle.SAVE_CONTEXT,
                                        null,
                                        '.elementor-' + elementor.config.initial_document.id
                                    )
                                }
                            }
                        )
                    ...
                    onDocumentLoaded(document) {
                        ...
                        elementor.channels.editor.on(
                            'elementorLoopBuilder:ApplySourceChange',
                            this.onApplySourceChange
                        )
                    }
                    ...
                    getCtaStyles() {
                        ...
                        ctaStyle.setAttribute(
                            'href',
                            `${elementorAppProConfig.baseUrl}/assets/css/loop-grid-cta.css`
                        )
                        return ctaStyle
                    }
                    getCtaContent(widgetName) {
                        const ctaContent = document.createElement('div')
                        ctaContent.classList.add(
                            'e-loop-empty-view__container',
                            'elementor-grid',
                            widgetName
                        )
                        ctaContent.innerHTML = Marionette.Renderer.render(
                            '#tmpl-' + widgetName + '-cta'
                        )
                        return ctaContent
                    }
                ...
                class notesContextMenu {
                    constructor() {
                        ...
                        elTypes.forEach((type) => {
                            elementor.hooks.addFilter(
                                `elements/${type}/contextMenuGroups`,
                                this.notesContextMenuAddGroup
                            )
                        })
                    }
                    ...
                    notesContextMenuAddGroup(groups) {
                        ...
                        if (elementorPro.config.should_show_promotion) {
                            const iconLink =
                                '<i class="eicon-advanced"></i>' +
                                '<a class="elementor-context-menu-list__item__shortcut--link-fullwidth" href="https://go.elementor.com/go-pro-advanced-notes-context-menu/" target="_blank" rel="noopener noreferrer"></a>'
                        ...
                        if (-1 === notesGroupIndex) {
                            const deleteGroup = _.findWhere(groups, {
                                ...
                                newGroupPosition =
                                    -1 !== deleteGroupIndex ? deleteGroupIndex : groups.length
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _stripe = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./stripe */ '../modules/payments/assets/js/editor/stripe.js'
                    )
                )
  ...
  \******************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                const ElementEditorModule = __webpack_require__(
                    /*! elementor-pro/editor/element-editor-module */ '../assets/dev/js/editor/element-editor-module.js'
                )
                module.exports = ElementEditorModule.extend({
                    __construct() {
                    ...
                    onInit() {
                        elementor.channels.editor.on(
                            'editor:widget:stripe-button:section_stripe_account:activated',
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/popup/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    ...
                    onRender() {
                        ...
                        this.children.each((child) => {
                            ...
                            const $imageWrapper = jQuery('<div>', {
                                ...
                                $image = jQuery('<img>', {
                                    src:
                                        elementorPro.config.urls.modules +
                                        `popup/assets/images/${name}/${groupName}.svg`
                                })
  ...
  \*************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _save = __webpack_require__(
                    /*! ./save */ '../modules/popup/assets/js/editor/hooks/data/save.js'
                )
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class PopupSave extends $e.modules.hookData.After {
                    ...
                    apply() {
                        const settings = {}
                        jQuery.each(
                            elementorPro.modules.popup.displaySettingsTypes,
                            (type, data) => {
  ...
  \********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data/ */ '../modules/popup/assets/js/editor/hooks/data/index.js'
                )
                Object.keys(_data).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _data[key]) return
                ...
                var _ui = __webpack_require__(
                    /*! ./ui/ */ '../modules/popup/assets/js/editor/hooks/ui/index.js'
                )
                Object.keys(_ui).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _ui[key]) return
  ...
  \****************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _displaySettings = _interopRequireDefault(
                    __webpack_require__(
                        /*! modules/popup/assets/js/editor/controls/display-settings */ '../modules/popup/assets/js/editor/controls/display-settings.js'
                    )
                )
                    ...
                    addPublishTabs() {
                        ...
                        jQuery.each(module.displaySettingsTypes, (type, data) => {
                            ...
                            component.addTab(type, {
                                ...
                                image:
                                    elementorPro.config.urls.modules +
                                    `popup/assets/images/${type}-tab.svg`
                            })
                        })
                    }
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _addLibraryTab = __webpack_require__(
                    /*! ./editor/documents/open/add-library-tab */ '../modules/popup/assets/js/editor/hooks/ui/editor/documents/open/add-library-tab.js'
                )
                var _addTriggers = __webpack_require__(
                    /*! ./editor/documents/open/add-triggers */ '../modules/popup/assets/js/editor/hooks/ui/editor/documents/open/add-triggers.js'
                )
                var _removeLibraryTab = __webpack_require__(
                    /*! ./editor/documents/close/remove-library-tab */ '../modules/popup/assets/js/editor/hooks/ui/editor/documents/close/remove-library-tab.js'
                )
                var _removeTriggers = __webpack_require__(
                    /*! ./editor/documents/close/remove-triggers */ '../modules/popup/assets/js/editor/hooks/ui/editor/documents/close/remove-triggers.js'
                )
  ...
  \***************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/popup/assets/js/editor/component.js'
                    )
                )
                    ...
                    constructor(...args) {
                        ...
                        this.displaySettingsTypes = {
                            triggers: {
                                ...
                                publishScreenDescription: __(
                                    'What action the user needs to do for the popup to open.',
                                    'elementor-pro'
                                )
                            },
                            timing: {
                                ...
                                publishScreenDescription: __(
                                    'Requirements that have to be met for the popup to open.',
                                    'elementor-pro'
                                )
                            }
                        }
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    onElementorPreviewLoaded() {
                        elementor.addControlView(
                            'Query',
                            __webpack_require__(
                                /*! ./editor/query-control */ '../modules/query-control/assets/js/editor/query-control.js'
                            )
                        )
                        __webpack_require__
                            .e(
                                /*! import() */ 'modules_query-control_assets_js_editor_template-query-control_js'
                            )
                            .then(
                                __webpack_require__.bind(
                                    __webpack_require__,
                                    /*! ./editor/template-query-control */ '../modules/query-control/assets/js/editor/template-query-control.js'
                                )
                            )
                            .then(({ default: TemplateQueryControl }) =>
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = elementor.modules.controls.Select2.extend({
                    ...
                    getQueryData() {
                        ...
                        const autocomplete = elementorCommon.helpers.cloneObject(
                                ...
                                ajax: {
                                    transport(params, success, failure) {
                                        ...
                                        if (bcFormat) {
                                            ...
                                            action =
                                                'panel_posts_control_filter_autocomplete_deprecated'
                                        } else {
  ...
  \************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var dataHooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/data */ '../modules/screenshots/assets/js/editor/hooks/data/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _deleteScreenshot = __webpack_require__(
                    /*! ./document/save/save/delete-screenshot */ '../modules/screenshots/assets/js/editor/hooks/data/document/save/save/delete-screenshot.js'
                )
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/screenshots/assets/js/editor/component.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    onElementorInit() {
  ...
  \************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ui */ '../modules/scroll-snap/assets/js/editor/hooks/ui/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \*****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _focusPreview = __webpack_require__(
                    /*! ./document/elements/settings/focus-preview */ '../modules/scroll-snap/assets/js/editor/hooks/ui/document/elements/settings/focus-preview.js'
                )
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/scroll-snap/assets/js/editor/component.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    /**
                ...
                module.exports = elementor.modules.controls.RepeaterRow.extend({
                    ...
                    onBeforeRender() {
                        var subNameModel = this.collection.findWhere({
                            ...
                            subConditionConfig =
                                this.config.conditions[this.model.attributes.sub_name]
                    ...
                    getOptions() {
                        ...
                        _(conditionConfig.sub_conditions).each(
                            function (conditionId, conditionIndex) {
                                ...
                                if (subConditionConfig.sub_conditions.length) {
                                    ...
                                    _(subConditionConfig.sub_conditions).each(
                                        function (subConditionId) {
  ...
  \************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _repeaterRow = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./repeater-row */ '../modules/theme-builder/assets/js/editor/conditions/repeater-row.js'
                    )
                )
                module.exports = elementor.modules.controls.Repeater.extend({
  ...
  \********************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var inlineControlsStack = __webpack_require__(
                    /*! elementor-pro/editor/inline-controls-stack.js */ '../assets/dev/js/editor/inline-controls-stack.js'
                )
  ...
  \************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _saveAndReload = __webpack_require__(
                    /*! ./save-and-reload */ '../modules/theme-builder/assets/js/editor/hooks/data/document/elements/settings/save-and-reload.js'
                )
                var _updatePreviewOptions = __webpack_require__(
                    /*! ./update-preview-options */ '../modules/theme-builder/assets/js/editor/hooks/data/document/elements/settings/update-preview-options.js'
                )
  ...
  \*****************************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class ThemeBuilderUpdatePreviewOptions extends $e.modules.hookData.After {
                    ...
                    apply(args) {
                        const { containers = [args.container] } = args,
                            { themeBuilder } = elementorPro.modules
                        $e.run('document/elements/settings', {
                            containers,
                            settings: {
                                preview_id: '',
                    ...
                    getConditions(args) {
                        ...
                        if (themeBuilder) {
                            const hasConditions = themeBuilder.settings.conditions.length,
                                ...
                                isDraft =
                                    'draft' === elementor.settings.page.model.get('post_status')
  ...
  \*********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _settings = __webpack_require__(
                    /*! ./document/elements/settings */ '../modules/theme-builder/assets/js/editor/hooks/data/document/elements/settings/index.js'
                )
                ...
                var _saveConditions = __webpack_require__(
                    /*! ./document/save/save-conditions */ '../modules/theme-builder/assets/js/editor/hooks/data/document/save/save-conditions.js'
                )
                var _showConditions = __webpack_require__(
                    /*! ./document/save/show-conditions */ '../modules/theme-builder/assets/js/editor/hooks/data/document/save/show-conditions.js'
                )
                var _previewBreak = __webpack_require__(
                    /*! ./editor/documents/preview/preview-break */ '../modules/theme-builder/assets/js/editor/hooks/data/editor/documents/preview/preview-break.js'
                )
  ...
  \****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data/ */ '../modules/theme-builder/assets/js/editor/hooks/data/index.js'
                )
                Object.keys(_data).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _data[key]) return
                ...
                var _ui = __webpack_require__(
                    /*! ./ui/ */ '../modules/theme-builder/assets/js/editor/hooks/ui/index.js'
                )
                Object.keys(_ui).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _ui[key]) return
  ...
  \**********************************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class ThemeBuilderToggleMenuConditions extends $e.modules.hookUI.After {
                    ...
                    apply() {
                        const { themeBuilder } = elementorPro.modules
  ...
  \*************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _view = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../../../../../conditions/view */ '../modules/theme-builder/assets/js/editor/conditions/view.js'
                    )
                )
                class ThemeBuilderAddEditorUI extends $e.modules.hookUI.After {
                    ...
                    addRepeaterControlView() {
                        elementor.addControlView(
                            'Conditions_repeater',
                            __webpack_require__(
                                /*! ../../../../../conditions/repeater */ '../modules/theme-builder/assets/js/editor/conditions/repeater.js'
                            )
                        )
                    }
                    addPublishTabs() {
                        ...
                        component.manager.conditionsModel =
                            new elementorModules.editor.elements.models.BaseSettings(settings, {
                        ...
                        component.addTab('conditions', {
                            ...
                            name: 'conditions',
                            description: __(
                                'Apply current template to these pages.',
                                'elementor-pro'
                            ),
                            image:
                                elementorPro.config.urls.modules +
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _addEditorUi = __webpack_require__(
                    /*! ./editor/documents/open/add-editor-ui */ '../modules/theme-builder/assets/js/editor/hooks/ui/editor/documents/open/add-editor-ui.js'
                )
                var _removeEditorUi = __webpack_require__(
                    /*! ./editor/documents/close/remove-editor-ui */ '../modules/theme-builder/assets/js/editor/hooks/ui/editor/documents/close/remove-editor-ui.js'
                )
                var _toggleMenuConditions = __webpack_require__(
                    /*! ./editor/document/elements/settings/toggle-menu-conditions */ '../modules/theme-builder/assets/js/editor/hooks/ui/editor/document/elements/settings/toggle-menu-conditions.js'
                )
                var _after = __webpack_require__(
                    /*! ./save/after */ '../modules/theme-builder/assets/js/editor/hooks/ui/save/after.js'
                )
                            ...
                            buttons: [
                                {
                                    ...
                                    text:
                                        '<i class="eicon-external-link-square"></i><span class="e-theme-builder-toaster-button-text">' +
                                ...
                                },
                                {
                                    name: 'view_live_site',
                                    text:
                                        '<i class="eicon-preview-medium"></i><span class="e-theme-builder-toaster-button-text">' +
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./publish/component */ '../modules/theme-builder/assets/js/editor/publish/component.js'
                    )
                )
                class ThemeBuilderModule extends elementorModules.editor.utils.Module {
                        ...
                        Object.defineProperty(elementorPro.config, 'theme_builder', {
                            get() {
                                elementorCommon.helpers.softDeprecated(
                                    'theme_builder',
                                    '2.9.0',
                                    'elementor.config.document.theme_builder'
                                )
                                return elementor.config.document.theme_builder
                            }
                        })
                    ...
                    onElementorLoaded() {
                        ...
                        this.onSectionPreviewSettingsActive =
                            this.onSectionPreviewSettingsActive.bind(this)
                        elementor.channels.editor.on(
                            'elementorProSiteLogo:change',
                            this.openSiteIdentity
                        )
                    }
                    onDocumentLoaded(document) {
                        if (!document.config.theme_builder) {
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _content = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./content */ '../modules/theme-builder/assets/js/editor/publish/content.js'
                    )
                )
                var _layout = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./layout */ '../modules/theme-builder/assets/js/editor/publish/layout.js'
                    )
                )
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ../hooks */ '../modules/theme-builder/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \*******************************************************************/
            /***/ (module) => {
                ...
                module.exports = function () {
                    ...
                    self.init = function () {
                        elementor.hooks.addAction(
                            'panel/open_editor/widget/post-comments',
                            self.onPanelShow
                        )
                    }
                    self.init()
  ...
  \************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = elementorModules.editor.utils.Module.extend({
                    onElementorPreviewLoaded() {
                        var CommentsSkin = __webpack_require__(
                            /*! ./comments-skin */ '../modules/theme-elements/assets/js/editor/comments-skin.js'
                        )
  ...
  \***************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ui */ '../modules/video-playlist/assets/js/editor/hooks/ui/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \****************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class ActiveTab extends $e.modules.hookData.After {
                    ...
                    getConditions(args) {
                        return (
                            args.settings.inner_tab_content_1 || args.settings.inner_tab_content_2
                        )
                    }
                    apply(args) {
  ...
  \********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _activeTab = __webpack_require__(
                    /*! ./document/elements/settings/active-tab */ '../modules/video-playlist/assets/js/editor/hooks/ui/document/elements/settings/active-tab.js'
                )
  ...
  \************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/video-playlist/assets/js/editor/component.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    /**
                        ...
                        elementor.channels.editor.on(
                            ...
                            (e) => {
                                $e.run('document/elements/settings', {
                                    ...
                                    settings: {
                                        thumbnail: {
                                            url: e.currentItem.thumbnail
                                                ? e.currentItem.thumbnail.url
                                                : ''
                                        },
                                        title: e.currentItem.video_title
                                            ? e.currentItem.video_title
                                            : '',
                                        duration: e.currentItem.duration
                                            ? e.currentItem.duration
                                            : ''
                                    },
                                    options: {
                                        external: true
  ...
  \************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks/ */ '../modules/woocommerce/assets/js/editor/hooks/index.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
  ...
  \***************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class WoocommerceCreateWidgetActivateSettingsModal extends $e.modules.hookData
                    .After {
                    getCommand() {
                    ...
                    getConditions(args, container) {
                        return Object.prototype.hasOwnProperty.call(
                            elementorPro.modules.woocommerce.pageSettingsWidgets,
                ...
                exports.WoocommerceCreateWidgetActivateSettingsModal =
  ...
  \*****************************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class WoocommerceDeleteWidgetDeactivateSettingsModal extends $e.modules.hookData
                    .After {
                    getCommand() {
                ...
                exports.WoocommerceDeleteWidgetDeactivateSettingsModal =
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _saveShowModal = __webpack_require__(
                    /*! ./save-show-modal */ '../modules/woocommerce/assets/js/editor/hooks/data/save-show-modal.js'
                )
                var _createWidgetActivateSettingsModal = __webpack_require__(
                    /*! ./create-widget-activate-settings-modal */ '../modules/woocommerce/assets/js/editor/hooks/data/create-widget-activate-settings-modal.js'
                )
                var _deleteWidgetDeactivateSettingsModal = __webpack_require__(
                    /*! ./delete-widget-deactivate-settings-modal */ '../modules/woocommerce/assets/js/editor/hooks/data/delete-widget-deactivate-settings-modal.js'
                )
                var _notices = __webpack_require__(
                    /*! ./notices */ '../modules/woocommerce/assets/js/editor/hooks/data/notices.js'
                )
                ...
                class WoocommerceNotices extends $e.modules.hookData.After {
                    ...
                    getConditions(args) {
                        return (
                            ...
                            Array.isArray(args.settings.woocommerce_notices_elements)
                        )
                    }
                    apply(args) {
  ...
  \**************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _data = __webpack_require__(
                    /*! ./data/ */ '../modules/woocommerce/assets/js/editor/hooks/data/index.js'
                )
                Object.keys(_data).forEach(function (key) {
                    if (key === 'default' || key === '__esModule') return
                    if (key in exports && exports[key] === _data[key]) return
  ...
  \*********************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/woocommerce/assets/js/editor/component.js'
                    )
                )
                class WoocommerceModule extends elementorModules.editor.utils.Module {
                    constructor(...args) {
                        ...
                        this.pageSettingsWidgets = {
                            ...
                            'woocommerce-my-account': {
                                ...
                                failedMessage: __(
                                    '<h3>Sorry, something went wrong.</h3><br>To define a my account page for your site, head over to Site Settings.',
                                    'elementor-pro'
                                ),
                    ...
                    onElementorInit() {
                        elementor.hooks.addAction(
                            ...
                            this.addWooCommerceClassToLoopWrapper
                        )
                    }
                    onElementorFrontendInit() {
                        ...
                        if (
                            'loop-item' === elementor.documents.currentDocument.config.type &&
                            'product' ===
                                elementor.documents.currentDocument.config.settings.settings.source
                        ) {
                            ...
                            elementor.on('document:loaded', () => {
                                elementor.$previewContents[0]
                                    .querySelector('.e-loop-item')
                                    .classList.add('woocommerce')
                            })
                        }
                    }
                    ...
                    onElementorLoaded() {
                        ...
                        for (const section of noticeSections) {
                            elementor.channels.editor.on(
                                'kit_settings:' + section + ':activated',
                                () => {
                                    this.renderMockNotices(
                                        elementor.documents
                                            .getCurrent()
                                            .container.settings.get('woocommerce_notices_elements')
                                    )
                                }
                            )
                        }
                        ...
                        elementor.channels.editor.on(
                            'editor:widget:woocommerce-cart:section_additional_options:activated',
                            () => {
                        ...
                        elementor.channels.editor.on(
                            'editor:widget:woocommerce-my-account:section_additional_options:activated',
                            () => {
                    ...
                    renderMockNotices(noticeElements) {
                        const noticesWrapper = elementor.$previewContents.find(
                    ...
                    onTemplateIdChange(sectionActive) {
                        ...
                        if (!templateID) {
                            ...
                            const editUrl =
                                ElementorConfig.home_url + '?p=' + templateID + '&elementor'
                            $editButton
                                .prop('href', editUrl)
                                .removeClass('e-control-tool-disabled')
                                .show()
                        }
                    }
                    ...
                    onUpdateDocument() {
                        ...
                        const saveWoocommercePageSettingKeys = Object.keys(
                                this.createdPageSettingsWidgets
                            ),
                            lastWidgetCreated =
                                saveWoocommercePageSettingKeys[
                                    saveWoocommercePageSettingKeys.length - 1
                                ],
                        ...
                        if (
                            postId ===
                            elementorPro.config.woocommerce.woocommercePages[
                                lastWidgetCreatedOptions.woocommercePageName
                            ]
                        ) {
                            return
                        }
                    ...
                    onConfirmModal(lastWidgetCreatedOptions) {
                        elementorPro.ajax.addRequest('woocommerce_update_page_option', {
                            ...
                            error: () =>
                                this.showPagesSettingsToast(lastWidgetCreatedOptions.failedMessage)
                        })
                    }
                    ...
                    openSiteSettingsTab(tabId = '', sectionId = '') {
                        const isWPPreviewMode = elementorCommon.elements.$body.hasClass(
                            'elementor-editor-preview'
                        )
                        if (isWPPreviewMode) {
                            elementor.exitPreviewMode()
                        }
                        const isInSettingsPanelActive =
                            'panel/global/menu' ===
                            elementor.documents.currentDocument.config.panel.default_route
...
*/
  ...
  \********************************************************/
    ...
    ;(() => {
        ...
        /******/ __webpack_require__.u = (chunkId) => {
            ...
            /******/ if (chunkId === 'page-transitions-editor')
                return '' + chunkId + '.e3439a669e359e50462f.bundle.js'
            /******/ if (chunkId === 'mega-menu-editor')
                return '' + chunkId + '.bbef3f7412481cbce555.bundle.js'
            /******/ if (chunkId === 'nested-carousel-editor')
                return '' + chunkId + '.2fdc278ce6bc9f6ec2e0.bundle.js'
            /******/ if (chunkId === 'loop-filter-editor')
                return '' + chunkId + '.2dedca4ebc18b2de2c3d.bundle.js'
            /******/ if (
                chunkId === 'modules_query-control_assets_js_editor_template-query-control_js'
            )
                return '4abfbfd970d6f7680bc7.bundle.js'
    ...
    ;(() => {
        ...
        /******/
        /******/ var chunkLoadingGlobal = (self['webpackChunkelementor_pro'] =
  ...
  \*****************************************/
        ...
        var _editor = _interopRequireDefault(
            __webpack_require__(
                /*! ../../../../modules/custom-css/assets/js/editor/editor */ '../modules/custom-css/assets/js/editor/editor.js'
            )
        )
        var _editor2 = _interopRequireDefault(
            __webpack_require__(
                /*! ../../../../modules/motion-fx/assets/js/editor/editor */ '../modules/motion-fx/assets/js/editor/editor.js'
            )
        )
        var _module = _interopRequireDefault(
            __webpack_require__(
                /*! modules/popup/assets/js/editor/module */ '../modules/popup/assets/js/editor/module.js'
            )
        )
        var _module2 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/global-widget/assets/js/editor/module */ '../modules/global-widget/assets/js/editor/module.js'
            )
        )
        var _module3 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/theme-builder/assets/js/editor/module */ '../modules/theme-builder/assets/js/editor/module.js'
            )
        )
        var _module4 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/forms/assets/js/editor/module */ '../modules/forms/assets/js/editor/module.js'
            )
        )
        var _module5 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/screenshots/assets/js/editor/module */ '../modules/screenshots/assets/js/editor/module.js'
            )
        )
        var _editor3 = _interopRequireDefault(
            __webpack_require__(
                /*! ../../../../core/app/modules/site-editor/assets/js/editor */ '../core/app/modules/site-editor/assets/js/editor.js'
            )
        )
        var _module6 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/video-playlist/assets/js/editor/module */ '../modules/video-playlist/assets/js/editor/module.js'
            )
        )
        var _module7 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/woocommerce/assets/js/editor/module */ '../modules/woocommerce/assets/js/editor/module.js'
            )
        )
        var _module8 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/scroll-snap/assets/js/editor/module */ '../modules/scroll-snap/assets/js/editor/module.js'
            )
        )
        var _module9 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/payments/assets/js/editor/module */ '../modules/payments/assets/js/editor/module.js'
            )
        )
        var _module10 = _interopRequireDefault(
            __webpack_require__(
                /*! modules/loop-builder/assets/js/editor/module */ '../modules/loop-builder/assets/js/editor/module.js'
            )
        )
        var _tiers = __webpack_require__(/*! ./tiers */ '../assets/dev/js/editor/tiers.js')
        var _notesContextMenu = _interopRequireDefault(
            __webpack_require__(
                /*! modules/notes/assets/js/notes-context-menu */ '../modules/notes/assets/js/notes-context-menu.js'
            )
        )
        var ElementorPro = Marionette.Application.extend({
            ...
            modules: {},
            initModules() {
                var QueryControl = __webpack_require__(
                        /*! modules/query-control/assets/js/editor */ '../modules/query-control/assets/js/editor.js'
                    ),
                    Library = __webpack_require__(
                        /*! modules/library/assets/js/editor */ '../modules/library/assets/js/editor.js'
                    ),
                    FlipBox = __webpack_require__(
                        /*! modules/flip-box/assets/js/editor/editor */ '../modules/flip-box/assets/js/editor/editor.js'
                    ),
                    ShareButtons = __webpack_require__(
                        /*! modules/share-buttons/assets/js/editor/editor */ '../modules/share-buttons/assets/js/editor/editor.js'
                    ),
                    AssetsManager = __webpack_require__(
                        /*! modules/assets-manager/assets/js/editor/editor */ '../modules/assets-manager/assets/js/editor/editor.js'
                    ),
                    ThemeElements = __webpack_require__(
                        /*! modules/theme-elements/assets/js/editor/editor */ '../modules/theme-elements/assets/js/editor/editor.js'
                    )
                this.modules = {
                ...
                if (elementorCommon.config.experimentalFeatures['page-transitions']) {
                    __webpack_require__
                        .e(/*! import() | page-transitions-editor */ 'page-transitions-editor')
                        .then(
                            __webpack_require__.bind(
                                __webpack_require__,
                                /*! modules/page-transitions/assets/js/editor/module */ '../modules/page-transitions/assets/js/editor/module.js'
                            )
                        )
                        .then(({ default: PageTransitions }) => {
                ...
                if (elementorCommon.config.experimentalFeatures['mega-menu']) {
                    elementorCommon.elements.$window.on(
                        ...
                        async () => {
                            ...
                            this.modules.megaMenu = new (
                                await __webpack_require__
                                    .e(/*! import() | mega-menu-editor */ 'mega-menu-editor')
                                    .then(
                                        __webpack_require__.bind(
                                            __webpack_require__,
                                            /*! modules/mega-menu/assets/js/editor/module */ '../modules/mega-menu/assets/js/editor/module.js'
                                        )
                                    )
                            ).default()
                        }
                ...
                if (elementorCommon.config.experimentalFeatures['nested-elements']) {
                    elementorCommon.elements.$window.on(
                        ...
                        async () => {
                            // The module should be loaded only when `nestedElements` is available.
                            this.modules.nestedCarousel = new (
                                await __webpack_require__
                                    .e(
                                        /*! import() | nested-carousel-editor */ 'nested-carousel-editor'
                                    )
                                    .then(
                                        __webpack_require__.bind(
                                            __webpack_require__,
                                            /*! modules/nested-carousel/assets/js/editor/module */ '../modules/nested-carousel/assets/js/editor/module.js'
                                        )
                                    )
                            ).default()
                        }
                ...
                if (elementorCommon.config.experimentalFeatures['taxonomy-filter']) {
                    __webpack_require__
                        .e(/*! import() | loop-filter-editor */ 'loop-filter-editor')
                        .then(
                            __webpack_require__.bind(
                                __webpack_require__,
                                /*! modules/loop-filter/assets/js/editor/module */ '../modules/loop-filter/assets/js/editor/module.js'
                            )
                        )
                        .then(({ default: LoopFilter }) => {
            ...
            onStart() {
                ...
                this.initModules()
                jQuery(window)
                    .on('elementor:init', () => this.onElementorInit())
            ...
            libraryRemoveGetProButtons() {
                elementor.hooks.addFilter(
                    ...
                    (viewID, templateData) => {
                        if (
                            !templateData.accessTier ||
                            !elementor.config?.library_connect?.current_access_tier
                        ) {
                            // BC support.
            ...
            getProButtonViewIdBC(viewID, templateData) {
                ...
                if (
                    templateData.accessLevel > elementor.config.library_connect.current_access_level
                ) {
                    return viewID
                }
