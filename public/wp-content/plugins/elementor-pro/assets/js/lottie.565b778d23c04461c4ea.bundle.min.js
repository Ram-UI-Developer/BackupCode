    ...
    [288],
    {
        1464: (t, e) => {
            ...
            class lottieHandler extends elementorModules.frontend.handlers.Base {
                ...
                getAnimationPath() {
                    const t = this.getLottieSettings()
                    return t.source_json?.url &&
                        'json' === t.source_json.url.toLowerCase().substr(-4)
                        ? t.source_json.url
                        : t.source_external_url?.url
                          ? t.source_external_url.url
                ...
                setCaption() {
                    const t = this.getLottieSettings()
                    if (
                        'external_url' === t.source ||
                        ('media_file' === t.source && 'custom' === t.caption_source)
                    ) {
                ...
                getCaptionElement() {
                    if (!this.elements.$caption.length) {
                        ...
                        return (
                            (this.elements.$caption = jQuery('<p>', { class: t.caption })),
                ...
                getAnimationFrames() {
                    ...
                    return (
                        ...
                        this.state.isNewLoopCycle ||
                            'bind_to_scroll' === t.trigger ||
                            (n = i && i > e ? i : e),
                        'backward' === this.state.animationDirection &&
                            this.isReverseMode() &&
                            ((n = e),
                            (o =
                                i && i > this.lottie.__initialFirstFrame
                                    ? i
                                    : this.lottie.__initialFirstFrame)),
                        { first: n, last: o, current: e, total: this.lottie.__initialTotalFrames }
                    )
                }
                getAnimationRange() {
                    const t = this.getLottieSettings()
                ...
                getLottieSettings() {
                    ...
                    return { ...t, lazyload: 'yes' === t.lazyload, loop: 'yes' === t.loop }
                }
                playLottie() {
                    const t = this.getAnimationFrames()
                    ;(this.lottie.stop(),
                ...
                addSessionEventListener(t, e, i) {
                    ;(t.on(e, i), this.listeners.collection.push({ $el: t, event: e, callback: i }))
                }
                ...
                setLoopWhenNotReverse() {
                    ...
                    t.number_of_times > 0
                        ? (this.state.playAnimationCount++,
                          this.state.playAnimationCount < t.number_of_times
                              ? this.playLottie()
                ...
                setReverseAnimationOnLoop() {
                    const t = this.getLottieSettings()
                    !t.number_of_times || this.state.playAnimationCount < t.number_of_times
                ...
                updateLottieValues() {
                    ...
                    ;[
                        ...
                        void 0 !== t.sourceVal &&
                            t.sourceVal !== this.state[t.stateProp] &&
                            ((this.state[t.stateProp] = t.sourceVal), t.callback())
                    })
                }
                onLoopStateChange() {
                    const t =
                    ...
                    this.state.loop &&
                        (t || 'none' === this.state.currentAnimationTrigger) &&
                        this.playLottie()
                }
                ...
                removeObservers() {
                    for (const t in this.intersectionObservers)
                        this.intersectionObservers[t].observer &&
                            this.intersectionObservers[t].element &&
                            this.intersectionObservers[t].observer.unobserve(
                                this.intersectionObservers[t].element
                            )
                }
