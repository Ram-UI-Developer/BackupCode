...
/******/ ;(() => {
  ...
  \*******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _connectButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../ui/connect-button */ '../core/app/assets/js/ui/connect-button.js'
                    )
                )
                ...
                function useFeatureLock(featureName) {
                    ...
                    const buttonText = (0, _utils.htmlDecodeTextContent)(
                        appConfig.lock?.button.text
                    )
                    const buttonLink = (0, _utils.replaceUtmPlaceholders)(
                        appConfig.lock?.button.url ?? '',
                        appConfig.utms ?? {}
                    )
                    const ConnectButton = () =>
                        /*#__PURE__*/ _react.default.createElement(_connectButton.default, {
                            text: buttonText,
                            url: buttonLink
                        })
                    return {
  ...
  \**************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _utils = __webpack_require__(
                    /*! ../utils.js */ '../core/app/assets/js/utils.js'
                )
                ...
                const ConnectButton = (props) => {
                    const className = (0, _utils.arrayToClassName)([
  ...
  \**************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                exports.replaceUtmPlaceholders =
                    exports.htmlDecodeTextContent =
                ...
                const arrayToClassName = (array, action) => {
                    return array
                        .filter((item) =>
                            'object' === typeof item ? Object.entries(item)[0][1] : item
                        )
                        .map((item) => {
                            const value =
                                'object' === typeof item ? Object.entries(item)[0][0] : item
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                __webpack_require__(
                    /*! ./indicator-bullet.scss */ '../core/app/modules/site-editor/assets/js/atoms/indicator-bullet.scss'
                )
  ...
  \*************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                __webpack_require__(
                    /*! ./preview-iframe.scss */ '../core/app/modules/site-editor/assets/js/atoms/preview-iframe.scss'
                )
  ...
  \***********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _condition = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./models/condition */ '../core/app/modules/site-editor/assets/js/context/models/condition.js'
                    )
                )
                var _conditionsConfig = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./services/conditions-config */ '../core/app/modules/site-editor/assets/js/context/services/conditions-config.js'
                    )
                )
                var _baseContext = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./base-context */ '../core/app/modules/site-editor/assets/js/context/base-context.js'
                    )
                )
                ...
                class ConditionsProvider extends _baseContext.default {
                     ...
                     */
                    componentDidMount() {
                        this.executeAction(ConditionsProvider.actions.FETCH_CONFIG, () =>
                            _conditionsConfig.default.create()
                        )
                     ...
                     */
                    saveConditions() {
                        const conditions = Object.values(this.state.conditions).map((condition) =>
                            condition.forDb()
                        )
                        return this.executeAction(ConditionsProvider.actions.SAVE, () =>
                            $e.data.update(
                                _commands.TemplatesConditions.signature,
                                {
                                    conditions
                                },
                                {
                            ...
                            const contextConditions = Object.values(this.state.conditions).map(
                                (condition) => condition.forContext()
                            )
                            this.props.onConditionsSaved(this.props.currentTemplate.id, {
                                conditions: contextConditions,
                                instances: this.conditionsConfig.calculateInstances(
                                    Object.values(this.state.conditions)
                                ),
                                isActive: !!(
                                    Object.keys(this.state.conditions).length &&
                                    'publish' === this.props.currentTemplate.status
                                )
                            })
                        })
                    }
                    ...
                    checkConflicts(condition) {
                        return this.executeAction(ConditionsProvider.actions.CHECK_CONFLICTS, () =>
                            $e.data.get(_commands.TemplatesConditionsConflicts.signature, {
                                post_id: this.props.currentTemplate.id,
                                condition: condition.clone().toString()
                            })
                        ).then((response) =>
                            this.updateConditionItemState(
                                condition.id,
                                {
                    ...
                    normalizeConditionsState() {
                        this.updateConditionsState(() => {
                            return this.props.currentTemplate.conditions.reduce(
                                (current, condition) => {
                                    const conditionObj = new _condition.default({
                                        ...
                                        subOptions: this.conditionsConfig.getSubOptions(
                                            condition.name
                                        ),
                                        subIdAutocomplete:
                            ...
                            Object.values(this.state.conditions).forEach((condition) =>
                                this.checkConflicts(condition)
                            )
                        })
                    }
                    ...
                    setSubIdTitles() {
                        return Object.values(this.state.conditions).forEach((condition) => {
                            ...
                            return this.fetchSubIdsTitles(condition).then((response) =>
                                this.updateConditionItemState(
                                    condition.id,
                                    {
                                        subIdOptions: [
                    ...
                    updateConditionItemState(id, args, shouldCheckConflicts = true) {
                        ...
                        if (args.sub || args.name) {
                            args.subIdAutocomplete = this.conditionsConfig.getSubIdAutocomplete(
                                args.sub
                            )
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class Condition {
                    ...
                    only(keys) {
                        ...
                        const keysToRemove = Object.keys(this).filter(
                            (conditionKey) => !keys.includes(conditionKey)
                        )
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class ConditionsConfig {
                    ...
                    static create() {
                        ...
                        return $e.data
                            .get(
                                _commands.ConditionsConfig.signature,
                                {},
                                {
                                    refresh: true
                                }
                        ...
                        return [
                            ...
                            ...config.sub_conditions.map((subName) => {
                                ...
                                return {
                                    ...
                                    value: subName,
                                    children: subConfig.sub_conditions.length
                                        ? this.getSubOptions(subName, true)
                                        : null
                                }
                            })
                        ]
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class TemplatesProvider extends _baseContext.default {
                    ...
                    importTemplates({ fileName, fileData }) {
                        return this.executeAction(TemplatesProvider.actions.IMPORT, () =>
                            $e.data.create(_commands.Templates.signature, {
                                fileName,
                                fileData
                            })
                        ).then((response) => {
                    ...
                    deleteTemplate(id) {
                        return this.executeAction(TemplatesProvider.actions.DELETE, () =>
                            $e.data.delete(_commands.Templates.signature, {
                                id
                            })
                        ).then(() => {
                            this.updateTemplatesState((prev) => {
                    ...
                    updateTemplate(id, args) {
                        return this.executeAction(TemplatesProvider.actions.UPDATE, () =>
                            $e.data.update(_commands.Templates.signature, args, {
                                id
                            })
                        ).then((response) => {
                    ...
                    fetchTemplates() {
                        return this.executeAction(TemplatesProvider.actions.FETCH, () =>
                            $e.data.get(
  ...
  \***********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _templates = __webpack_require__(
                    /*! ../context/templates */ '../core/app/modules/site-editor/assets/js/context/templates.js'
                )
                var _useScreenshot = _interopRequireWildcard(
                    __webpack_require__(
                        /*! modules/screenshots/app/assets/js/hooks/use-screenshot */ '../modules/screenshots/app/assets/js/hooks/use-screenshot.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                ...
                function useTemplatesScreenshot(templateType = null) {
                    const { updateTemplateItemState, templates } = React.useContext(
                        _templates.Context
                    )
                    const templatesForScreenshot = Object.values(templates).filter((template) =>
                        shouldScreenshotTemplate(template, templateType)
                    )
                    ...
                    React.useEffect(() => {
                        screenshot.posts
                            .filter(
                                (post) => post.status === _useScreenshot.SCREENSHOT_STATUS_SUCCEED
                            )
                            .forEach((post) =>
                                updateTemplateItemState(post.id, {
                    ...
                    React.useEffect(() => {
                        screenshot.posts
                            .filter(
                                (post) => post.status === _useScreenshot.SCREENSHOT_STATUS_FAILED
                            )
                            .forEach((post) =>
                                updateTemplateItemState(post.id, {
                                    screenshot_url: null
  ...
  \**************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                __webpack_require__(
                    /*! ./back-button.scss */ '../core/app/modules/site-editor/assets/js/molecules/back-button.scss'
                )
  ...
  \*********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _siteTemplateThumbnail = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./site-template-thumbnail */ '../core/app/modules/site-editor/assets/js/molecules/site-template-thumbnail.js'
                    )
                )
                var _previewIframe = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../atoms/preview-iframe */ '../core/app/modules/site-editor/assets/js/atoms/preview-iframe.js'
                    )
                )
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        props.extended
                            ...
                            : /*#__PURE__*/ _react.default.createElement(
                                  _siteTemplateThumbnail.default,
                                  {
                                      id: props.id,
                                      title: props.title,
                                      type: props.type,
  ...
  \***********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _dialogsAndButtons = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../part-actions/dialogs-and-buttons */ '../core/app/modules/site-editor/assets/js/part-actions/dialogs-and-buttons.js'
                    )
                )
                var _indicatorBullet = __webpack_require__(
                    /*! ../atoms/indicator-bullet */ '../core/app/modules/site-editor/assets/js/atoms/indicator-bullet.js'
                )
                const SiteTemplateHeader = (props) => {
                    const status =
                            props.status && 'publish' !== props.status ? ` (${props.status})` : '',
                        ...
                        IndicatorDot = props.showInstances
                            ? /*#__PURE__*/ _react.default.createElement(
                                  _indicatorBullet.Indicator,
                                  {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        props.extended &&
                            /*#__PURE__*/ _react.default.createElement(MetaData, null),
                        props.extended &&
                            /*#__PURE__*/ _react.default.createElement(ActionButtons, null)
                    )
                }
  ...
  \****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _siteTemplateHeader = __webpack_require__(
                    /*! ./site-template-header */ '../core/app/modules/site-editor/assets/js/molecules/site-template-header.js'
                )
                var _siteTemplateBody = __webpack_require__(
                    /*! ./site-template-body */ '../core/app/modules/site-editor/assets/js/molecules/site-template-body.js'
                )
                var _siteTemplateFooter = __webpack_require__(
                    /*! ./site-template-footer */ '../core/app/modules/site-editor/assets/js/molecules/site-template-footer.js'
                )
                __webpack_require__(
                    /*! ./site-template.scss */ '../core/app/modules/site-editor/assets/js/molecules/site-template.scss'
                )
                function SiteTemplate(props) {
                    ...
                    const CardFooter =
                        props.extended && props.showInstances
                            ? /*#__PURE__*/ _react.default.createElement(
                                  _siteTemplateFooter.SiteTemplateFooter,
                                  props
                              )
                            : ''
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            _siteTemplateHeader.SiteTemplateHeader,
                            props
                        ),
                        /*#__PURE__*/ _react.default.createElement(
                            _siteTemplateBody.SiteTemplateBody,
                            props
                        ),
                        CardFooter
                    )
  ...
  \*****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _siteTemplate = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../molecules/site-template */ '../core/app/modules/site-editor/assets/js/molecules/site-template.js'
                    )
                )
                var _dialogsAndButtons = __webpack_require__(
                    /*! ../part-actions/dialogs-and-buttons */ '../core/app/modules/site-editor/assets/js/part-actions/dialogs-and-buttons.js'
                )
                var _templates = __webpack_require__(
                    /*! ../context/templates */ '../core/app/modules/site-editor/assets/js/context/templates.js'
                )
                var _useTemplatesScreenshot = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../hooks/use-templates-screenshot */ '../core/app/modules/site-editor/assets/js/hooks/use-templates-screenshot.js'
                    )
                )
                function SiteTemplates(props) {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            _dialogsAndButtons.PartActionsDialogs,
                            null
                        ),
                        action.error &&
                            /*#__PURE__*/ _react.default.createElement(_appUi.Dialog, {
                                ...
                                approveButtonUrl:
                                    'https://go.elementor.com/app-theme-builder-template-load-issue',
  ...
  \******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _siteEditor = __webpack_require__(
                    /*! @elementor/site-editor */ '@elementor/site-editor'
                )
                __webpack_require__(
                    /*! ./add-new.scss */ '../core/app/modules/site-editor/assets/js/pages/add-new.scss'
                )
                var _templates = __webpack_require__(
                    /*! ../context/templates */ '../core/app/modules/site-editor/assets/js/context/templates.js'
                )
                var _backButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../molecules/back-button */ '../core/app/modules/site-editor/assets/js/molecules/back-button.js'
                    )
                )
                var _useFeatureLock = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-pro-app/hooks/use-feature-lock */ '../core/app/assets/js/hooks/use-feature-lock.js'
                    )
                )
                function AddNew() {
                    const { templates } = _react.default.useContext(_templates.Context),
                        hasTemplates = 1 <= Object.keys(templates).length
                    const { isLocked, ConnectButton } = (0, _useFeatureLock.default)('site-editor')
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                isLocked &&
                                    /*#__PURE__*/ _react.default.createElement(ConnectButton, null)
                            )
                        ),
                        /*#__PURE__*/ _react.default.createElement(_siteEditor.SiteParts, {
                        ...
                        ajax: {
                            transport(params, success, failure) {
                                return elementorCommon.ajax.addRequest(
                                    'pro_panel_posts_control_filter_autocomplete',
                                    {
                                        data: {
                                            q: params.data.q,
                                            autocomplete
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function ConditionType(props) {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        {
                            className:
                                'e-site-editor-conditions__input-wrapper e-site-editor-conditions__input-wrapper--condition-type',
                            ref: wrapperRef
                        },
                        /*#__PURE__*/ _react.default.createElement(_appUi.Select, {
                            options: options,
  ...
  \*************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _conditions = __webpack_require__(
                    /*! ../../context/conditions */ '../core/app/modules/site-editor/assets/js/context/conditions.js'
                )
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _conditionType = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./condition-type */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-type.js'
                    )
                )
                var _conditionName = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./condition-name */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-name.js'
                    )
                )
                var _conditionSub = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./condition-sub */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-sub.js'
                    )
                )
                var _conditionSubId = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./condition-sub-id */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-sub-id.js'
                    )
                )
                var _conditionConflicts = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./condition-conflicts */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-conflicts.js'
                    )
                )
                function ConditionsRows(props) {
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                /*#__PURE__*/ _react.default.createElement(
                                    ...
                                    /*#__PURE__*/ _react.default.createElement(
                                        _conditionType.default,
                                        (0, _extends2.default)({}, condition, {
                                    ...
                                    /*#__PURE__*/ _react.default.createElement(
                                        ...
                                        /*#__PURE__*/ _react.default.createElement(
                                            _conditionName.default,
                                            (0, _extends2.default)({}, condition, {
                                                updateConditions: update
                                            })
                                        ),
                                        /*#__PURE__*/ _react.default.createElement(
                                            _conditionSub.default,
                                            (0, _extends2.default)({}, condition, {
                                                updateConditions: update
                                            })
                                        ),
                                        /*#__PURE__*/ _react.default.createElement(
                                            _conditionSubId.default,
                                            (0, _extends2.default)({}, condition, {
                                                updateConditions: update
                                            })
                                        )
                    ...
                    const isSaving =
                        action.current === _conditions.ConditionsProvider.actions.SAVE &&
                        action.loading
                    return /*#__PURE__*/ _react.default.createElement(
                        _react.default.Fragment,
                        null,
                        action.error &&
                            /*#__PURE__*/ _react.default.createElement(_appUi.Dialog, {
                                ...
                                approveButtonColor: 'link',
                                approveButtonUrl:
                                    'https://go.elementor.com/app-theme-builder-conditions-load-issue',
                                approveButtonTarget: '_target'
                            }),
                        /*#__PURE__*/ _react.default.createElement(
                            'div',
  ...
  \********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _conditions = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../../context/conditions */ '../core/app/modules/site-editor/assets/js/context/conditions.js'
                    )
                )
                ...
                var _conditionsRows = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./conditions-rows */ '../core/app/modules/site-editor/assets/js/pages/conditions/conditions-rows.js'
                    )
                )
                __webpack_require__(
                    /*! ./conditions.scss */ '../core/app/modules/site-editor/assets/js/pages/conditions/conditions.scss'
                )
                var _backButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../../molecules/back-button */ '../core/app/modules/site-editor/assets/js/molecules/back-button.js'
                ...
                function Conditions(props) {
                    const { findTemplateItemInState, updateTemplateItemState } =
                            _react.default.useContext(_templates.Context),
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(_backButton.default, null),
                        /*#__PURE__*/ _react.default.createElement(
                            'div',
                            {
  ...
  \*****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function Import() {
                    const { importTemplates, action, resetActionState } = _react.default.useContext(
                            _templates.Context
                        ),
                        [importedTemplate, setImportedTemplate] = _react.default.useState(null),
                        isImport = _react.default.useMemo(
                            () => action.current === _templates.TemplatesProvider.actions.IMPORT,
                            [action]
                        ),
                        isUploading = _react.default.useMemo(
                            () => isImport && action.loading,
                            [action]
                        ),
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        hasError &&
                            /*#__PURE__*/ _react.default.createElement(_appUi.Dialog, {
                                ...
                                approveButtonText: __('Learn More', 'elementor-pro'),
                                approveButtonUrl:
                                    'https://go.elementor.com/app-theme-builder-import-issue',
                                approveButtonTarget: '_blank',
                                approveButtonColor: 'link',
                                dismissButtonText: __('Go Back', 'elementor-pro'),
                                dismissButtonOnClick: resetActionState,
                        ...
                        dialog.isOpen &&
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                {
                                    title: __(
                                        'Warning: JSON or ZIP files may be unsafe',
                                        'elementor-pro'
                                    ),
                                    text: __(
                                        'Uploading JSON or ZIP files from unknown sources can be harmful and put your site at risk. For maximum safety, upload only JSON or ZIP files from trusted sources.',
                                        'elementor-pro'
                                    ),
                                    approveButtonColor: 'link',
                        ...
                        /*#__PURE__*/ _react.default.createElement(_backButton.default, null),
                        /*#__PURE__*/ _react.default.createElement(_appUi.DropZone, {
                            heading: __('Import Template To Your Library', 'elementor-pro'),
                            text: __(
                                'Drag & Drop your .JSON or .zip template file',
                                'elementor-pro'
                            ),
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                var _siteTemplates = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../organisms/site-templates */ '../core/app/modules/site-editor/assets/js/organisms/site-templates.js'
                    )
                )
                var _useFeatureLock = _interopRequireDefault(
                    __webpack_require__(
                ...
                __webpack_require__(
                    /*! ./template-type.scss */ '../core/app/modules/site-editor/assets/js/pages/template-type.scss'
                )
                function TemplateType(props) {
                    const { templateTypes } = _react.default.useContext(
                            _siteEditor.TemplateTypesContext
                        ),
                        currentType = templateTypes.find((item) => item.type === props.type),
                        { isLocked, ConnectButton } = (0, _useFeatureLock.default)('site-editor')
                    if (!currentType) {
  ...
  \*******************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function DialogDelete(props) {
                    const { deleteTemplate, findTemplateItemInState } = _react.default.useContext(
                        _templates.Context
                    )
  ...
  \*******************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function DialogRename(props) {
                    const { findTemplateItemInState, updateTemplate } = _react.default.useContext(
                            _templates.Context
                        ),
  ...
  \*************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _dialogRename = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./dialog-rename */ '../core/app/modules/site-editor/assets/js/part-actions/dialog-rename.js'
                    )
                )
                var _dialogDelete = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./dialog-delete */ '../core/app/modules/site-editor/assets/js/part-actions/dialog-delete.js'
                    )
                )
                var _appUi = __webpack_require__(/*! @elementor/app-ui */ '@elementor/app-ui')
                ...
                function PartActionsDialogs() {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        _react.default.Fragment,
                        null,
                        /*#__PURE__*/ _react.default.createElement(_dialogRename.default, {
                            id: DialogRenameId,
                ...
                function PartActionsButtons(props) {
                    ...
                    if (showMenu) {
                        SiteTemplatePopover = /*#__PURE__*/ _react.default.createElement(
                            _appUi.Popover,
                            {
  ...
  \****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _templates = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./pages/templates */ '../core/app/modules/site-editor/assets/js/pages/templates.js'
                    )
                )
                var _templateType = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./pages/template-type */ '../core/app/modules/site-editor/assets/js/pages/template-type.js'
                    )
                )
                var _addNew = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./pages/add-new */ '../core/app/modules/site-editor/assets/js/pages/add-new.js'
                    )
                )
                var _conditions = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./pages/conditions/conditions */ '../core/app/modules/site-editor/assets/js/pages/conditions/conditions.js'
                    )
                )
                var _import = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./pages/import */ '../core/app/modules/site-editor/assets/js/pages/import.js'
                    )
                )
                var _templates2 = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./context/templates */ '../core/app/modules/site-editor/assets/js/context/templates.js'
                    )
                )
                ...
                __webpack_require__(
                    /*! ./site-editor.scss */ '../core/app/modules/site-editor/assets/js/site-editor.scss'
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    var r = new WeakMap(),
                ...
                function SiteEditor() {
                    const { isLocked } = (0, _useFeatureLock.default)('site-editor')
                    ...
                    const headerButtons = [
                        {
                            ...
                            onClick: () =>
                                _router2.default.appHistory.navigate(basePath + '/import')
                        }
                    ]
                    ...
                    const SiteEditorDefault = () => {
                        const { templates } = _react.default.useContext(_templates2.Context)
  ...
  \********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports.SCREENSHOT_STATUS_SUCCEED =
                    exports.SCREENSHOT_STATUS_QUEUE =
                    exports.SCREENSHOT_STATUS_IN_PROGRESS =
                    exports.SCREENSHOT_STATUS_FAILED =
                        void 0
                exports['default'] = useScreenshot
                const { useState, useEffect, useMemo, useCallback } = React
                const SCREENSHOT_STATUS_QUEUE = (exports.SCREENSHOT_STATUS_QUEUE = 'queue')
                const SCREENSHOT_STATUS_IN_PROGRESS = (exports.SCREENSHOT_STATUS_IN_PROGRESS =
                    'in-progress')
                ...
                function useIFrameMessageListener(inProgressPosts, setPosts) {
                    return useCallback(
                        (message) => {
                            ...
                            const post = inProgressPosts.find(
                            ...
                            post.iframe.remove()
                            setPosts((prevState) =>
                                updatePostsAttrs(prevState, post.id, {
                                    status: data.success
                                        ? SCREENSHOT_STATUS_SUCCEED
                ...
                function useScreenshot(
                    initialPosts,
                    { numberOfScreenshotInParallel } = defaultOptions
                ) {
                    ...
                    const queue = useMemo(
                        () => filterPostByStatus(posts, SCREENSHOT_STATUS_QUEUE),
                        [posts]
                    )
                    const inProgress = useMemo(
                        () => filterPostByStatus(posts, SCREENSHOT_STATUS_IN_PROGRESS),
                        [posts]
                    )
                    const succeed = useMemo(
                        () => filterPostByStatus(posts, SCREENSHOT_STATUS_SUCCEED),
                        [posts]
                    )
                    const failed = useMemo(
                        () => filterPostByStatus(posts, SCREENSHOT_STATUS_FAILED),
                        [posts]
                    )
                    ...
                    useEffect(() => {
                        const postsDiff = initialPosts.filter(
                            (initialPost) =>
                                !posts.find((statePost) => statePost.id === initialPost.id)
                        )
                        if (!postsDiff.length) {
                            return
                        }
                    ...
                    useEffect(() => {
                        if (
                            0 === queue.length ||
                            inProgress.length >= numberOfScreenshotInParallel
                        ) {
                            return
                        }
                        ...
                        setPosts((prevState) =>
                            updatePostsAttrs(prevState, nextPost.id, {
...
*/
  ...
  \**************************************/
        ...
        var _siteEditor = _interopRequireDefault(
            __webpack_require__(
                /*! ../../modules/site-editor/assets/js/site-editor */ '../core/app/modules/site-editor/assets/js/site-editor.js'
            )
        )
