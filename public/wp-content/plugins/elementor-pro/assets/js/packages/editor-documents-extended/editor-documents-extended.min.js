!(function () {
    ...
    var t = window.elementorV2.store,
        n = window.elementorV2.editorV1Adapters,
        i = window.elementorV2.editorAppBar,
        o = window.wp.i18n,
        C = window.elementorV2.editorDocuments,
        r = window.React,
        d = window.elementorV2.ui,
        c = window.elementorV2.icons,
        u = (0, t.__createSlice)({
    ...
    function l(e) {
        return { id: e.id, locationKey: e.config.theme_builder?.settings?.location || null }
    }
    ...
    function m() {
        const e = (0, C.__useActiveDocument)(),
            t = 'popup' === e?.type.value
        return {
            icon: a,
            title: (0, o.__)('Triggers', 'elementor-pro'),
            visible: t,
            onClick: () => {
                ;(0, n.__privateOpenRoute)('theme-builder-publish/triggers')
            }
        }
    }
    function V() {
        ...
        return {
            icon: c.SettingsIcon,
            title: (0, o.__)('Advanced Rules', 'elementor-pro'),
            visible: t,
            onClick: () => {
                ;(0, n.__privateOpenRoute)('theme-builder-publish/timing')
            }
        }
    }
    function _() {
        const e = (function () {
                const e = (0, C.__useActiveDocument)(),
                    n = (0, t.__useSelector)(
                        (t) => (e && t.documentsExtended.entities[e.id]) || null
                    )
                return n ? { ...e, ...n } : null
            })(),
            i = !!e?.locationKey
        return {
            icon: p,
            title: (0, o.__)('Display Conditions', 'elementor-pro'),
            visible: i,
            onClick: () => {
                ;(0, n.__privateOpenRoute)('theme-builder-publish/conditions')
            }
        }
    }
    ;(i.documentOptionsMenu.registerAction({ id: 'popup-triggers', priority: 20, useProps: m }),
        i.documentOptionsMenu.registerAction({
        ...
        (0, t.__registerSlice)(u),
        (function () {
            const { init: e } = u.actions
            ;(0, n.__privateListenTo)((0, n.v1ReadyEvent)(), () => {
                const n = s(),
                    i = Object.entries(n.documents).reduce((e, [t, n]) => ((e[t] = l(n)), e), {})
                ;(0, t.__dispatch)(e({ entities: i }))
            })
        })(),
        (function () {
            const { addDocument: e } = u.actions
            ;(0, n.__privateListenTo)((0, n.commandEndEvent)('editor/documents/open'), () => {
                const n = l(s().getCurrent())
                ;(0, t.__dispatch)(e(n))
            })
        })(),
        ((window.elementorV2 = window.elementorV2 || {}).editorDocumentsExtended = e))
})()
