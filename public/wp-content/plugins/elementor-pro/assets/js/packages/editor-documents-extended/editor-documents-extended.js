/******/ ;(function () {
  ...
  \**************************************************************************/
        ...
        /* harmony import */ var _elementor_store__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! @elementor/store */ '@elementor/store')
        /* harmony import */ var _elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
                /*! @elementor/editor-v1-adapters */ '@elementor/editor-v1-adapters'
            )
        /* harmony import */ var _elementor_editor_app_bar__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(/*! @elementor/editor-app-bar */ '@elementor/editor-app-bar')
        /* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
            /*! @wordpress/i18n */ '@wordpress/i18n'
        )
        /* harmony import */ var _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(/*! @elementor/editor-documents */ '@elementor/editor-documents')
        /* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
            /*! react */ 'react'
        )
        /* harmony import */ var _elementor_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
            /*! @elementor/ui */ '@elementor/ui'
        )
        /* harmony import */ var _elementor_icons__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(/*! @elementor/icons */ '@elementor/icons')
        // src/store/index.ts
        ...
        function syncInitialization() {
            ...
            ;(0, _elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_1__.__privateListenTo)(
                ...
                () => {
                    ...
                    ;(0, _elementor_store__WEBPACK_IMPORTED_MODULE_0__.__dispatch)(
                        init5({ entities })
                    )
                }
            )
        ...
        var HierarchyIcon = react__WEBPACK_IMPORTED_MODULE_5__.forwardRef((props, ref) => {
            return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_5__.createElement(
                _elementor_ui__WEBPACK_IMPORTED_MODULE_6__.SvgIcon,
                { viewBox: '0 0 24 24', ...props, ref },
        ...
        function usePopupTriggersProps() {
            const document = (0,
            _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_4__.__useActiveDocument)()
            ...
            return {
                ...
                onClick: () => {
                    ;(0,
                    _elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_1__.__privateOpenRoute)(
                        'theme-builder-publish/triggers'
                    )
                }
            }
        }
        ...
        function useActiveDocumentExtended() {
            const document = (0,
            _elementor_editor_documents__WEBPACK_IMPORTED_MODULE_4__.__useActiveDocument)()
            const documentExtensions = (0,
            _elementor_store__WEBPACK_IMPORTED_MODULE_0__.__useSelector)((state) => {
                if (!document) {
                    return null
                }
        ...
        function useDocumentDisplayConditionsProps() {
            ...
            return {
                ...
                onClick: () => {
                    ;(0,
                    _elementor_editor_v1_adapters__WEBPACK_IMPORTED_MODULE_1__.__privateOpenRoute)(
                        'theme-builder-publish/conditions'
                    )
                }
            }
        }
