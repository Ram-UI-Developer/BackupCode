        ...
        8208: (e, t, s) => {
            ...
            class TOCHandler extends elementorModules.frontend.handlers.Base {
                ...
                getContainer() {
                    ...
                    if (e.container) return jQuery(l.default.sanitize(e.container))
                ...
                getHeadings() {
                    ...
                    return this.elements.$pageContainer
                        .find(t)
                        .not(s.headerTitle)
                        .filter((e, t) => !jQuery(t).closest(i).length)
                }
                ...
                followAnchor(e, t) {
                    ...
                    ;(elementorFrontend.waypoint(
                        ...
                        (s) => {
                            ...
                            const n = i.attr('id')
                            'down' === s
                                ? ((this.viewportItems[n] = !0), this.activateItem(e))
                                : (delete this.viewportItems[n],
                ...
                getNestedLevel(e) {
                    ...
                    for (; this.listItemPointer < this.headingsData.length; ) {
                        ...
                        let r = t.classes.listItemText
                        if (
                            (0 === a.level && (r += ' ' + t.classes.firstLevelListItem),
                            e > a.level)
                        )
                            break
                        if (e === a.level) {
                            ...
                            let h = `<a href="#${a.anchorLink}" class="${r}">${a.text}</a>`
                            ;('bullets' === s.marker_view && i && (h = `${n}${h}`),
                                (h = l.default.sanitize(h)),
                                (o += h),
                                (o += '</div>'),
                                this.listItemPointer++)
                            const c = this.headingsData[this.listItemPointer]
                            ;(c && e < c.level && (o += this.getNestedLevel(c.level)),
                                (o += '</li>'))
                        }
                    }
