            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class CircularProgress {
                    constructor(element, settings) {
                        ...
                        this.circularProgressTracker = element.find(
                    ...
                    updateProgress(progress) {
                        ...
                        this.elements.circularCurrentProgress.style.strokeDashoffset =
                            'ltr' === this.settings.direction ? -offset : offset
  ...
  \**********************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class LinearProgress {
                    constructor(element, settings) {
                        this.settings = settings
                        this.linearProgressTracker = element.find(
                            '.elementor-scrolling-tracker-horizontal'
                        )[0]
                        this.linearCurrentProgress =
                            this.linearProgressTracker.getElementsByClassName('current-progress')[0]
  ...
  \***********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _circularProgress = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./circular-progress */ '../modules/progress-tracker/assets/js/frontend/handlers/circular-progress.js'
                    )
                )
                var _linearProgress = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./linear-progress */ '../modules/progress-tracker/assets/js/frontend/handlers/linear-progress.js'
                    )
                )
                class ProgressTracker extends elementorModules.frontend.handlers.Base {
                    ...
                    isScrollSnap() {
                        const scrollSnapStatus = this.isEdit
                    ...
                    scrollHandler() {
                        ...
                        const $trackingElementSelector = this.getTrackingElementSelector(),
                            scrollStartPercentage =
                                $trackingElementSelector.is(elementorFrontend.elements.$body) ||
                                $trackingElementSelector.is(jQuery('#e-scroll-snap-container'))
                                    ? -100
                                    : 0
