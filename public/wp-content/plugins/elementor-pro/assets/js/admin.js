...
/******/ ;(() => {
  ...
  \****************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _elementorFontManager = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./admin/elementor-font-manager */ '../modules/assets-manager/assets/js/admin/elementor-font-manager.js'
                    )
                )
                var _elementorCustomIcons = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./admin/elementor-custom-icons */ '../modules/assets-manager/assets/js/admin/elementor-custom-icons.js'
                    )
                )
                module.exports = function () {
                    const TypekitAdmin = __webpack_require__(
                            /*! ./admin/typekit */ '../modules/assets-manager/assets/js/admin/typekit.js'
                        ),
                        CustomIcon = _elementorCustomIcons.default,
                        FontAwesomeProAdmin = __webpack_require__(
                            /*! ./admin/font-awesome-pro */ '../modules/assets-manager/assets/js/admin/font-awesome-pro.js'
                        )['default']
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _customAssetsBase = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./custom-assets-base */ '../modules/assets-manager/assets/js/admin/custom-assets-base.js'
                    )
                )
                var _elementorProDropzone = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./fields/elementor-pro-dropzone */ '../modules/assets-manager/assets/js/admin/fields/elementor-pro-dropzone.js'
                    )
                )
                class CustomIcons extends _customAssetsBase.default {
                    getDefaultSettings() {
                        return {
                            ...
                            templates: {
                                ...
                                duplicatePrefix: jQuery(
                                    '#elementor-custom-icons-template-duplicate-prefix'
                                ).html()
                            },
                    ...
                    getCreatedOn() {
                        const { $dayInput, $mmInput, $yearInput, $hourInput, $minuteInput } =
                            this.elements
                        return {
                            day: $dayInput.val(),
                            mm: $mmInput.val(),
                    ...
                    enqueueCSS(url) {
                        if (
                            !elementorCommon.elements.$document.find('link[href="' + url + '"]')
                                .length
                        ) {
                            elementorCommon.elements.$document
                                .find('link')
                                .last()
                                .after('<link href="' + url + '" rel="stylesheet" type="text/css">')
                        }
                    }
                    setData(data) {
                    ...
                    renderIcons(config) {
                        ...
                        $metaboxContainer.append(
                            elementorCommon.compileTemplate(footer, this.getCreatedOn())
                        )
                    }
                    onTitleInput(event) {
                    ...
                    checkInputsForValues() {
                        ...
                        if (
                            ...
                            '' !== this.elements.$iconSetConfigInput.val()
                        ) {
                            return true
                        }
                        return false
                    ...
                    onSuccess(data) {
                        ...
                        if (data.data.config.duplicate_prefix) {
                            ...
                            return this.showAlertDialog(
                                'duplicate-prefix',
                                this.getSettings('templates.duplicatePrefix'),
                    ...
                    onInit() {
                        const { $body } = elementorCommon.elements,
                            { editPageClass, editPhp } = this.getSettings('classes')
                        ...
                        const dropzoneFieldClass = this.getSettings('fields.dropzone'),
                            ...
                            config = this.getData(),
                            { $dropzone, $metaboxContainer } = this.elements
                        if ('' === config) {
                            $dropzone.show('fast')
                            dropzoneField.setSettings('onSuccess', (...args) =>
                                this.onSuccess(...args)
                            )
                        } else {
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _elementorProUpload = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./fields/elementor-pro-upload */ '../modules/assets-manager/assets/js/admin/fields/elementor-pro-upload.js'
                    )
                )
                var _elementorProRepeater = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./fields/elementor-pro-repeater */ '../modules/assets-manager/assets/js/admin/fields/elementor-pro-repeater.js'
                    )
                )
                class CustomFontsManager extends _customAssetsBase.default {
                    ...
                    updateRowLabel(event, $table) {
                        ...
                        if ($deleteBtn.length > 0) {
                            $deleteBtn
                                .not(selectors.toolbar + ' ' + selectors.removeRowBtn)
                                .remove()
                        }
                        const toolbarHtml = jQuery('<li class="row-font-actions">').append(
                            $toolbar
                        )[0].outerHTML
                        return this.renderTemplate(fontLabelTemplate, {
                            ...
                            preview:
                                ...
                                '">Elementor is making the web beautiful</span>',
                            toolbar: toolbarHtml
                        })
                    }
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class DropZoneField extends elementorModules.ViewModule {
                    getDefaultSettings() {
                        ...
                        return {
                            ...
                            selectors: {
                                ...
                                browseButton:
                                    baseSelector + ' .elementor--dropzone--upload__browse',
                                postId: '#post_ID'
                            },
                            classes: {
                                drag: 'is-dragover',
                    ...
                    handleUpload() {
                        ...
                        const { $input, $dropZone, $postId, $errorMsg } = this.elements,
                            { error, success, upload } = this.getSettings('classes'),
                            { onSuccess, onError } = this.getSettings(),
                ...
                module.exports = {
                    ...
                    uploadFile(el) {
                        ...
                        self.fileFrame[name].on('select', function () {
                            ...
                            const attachment = self.fileFrame[name]
                                .state()
                                .get('selection')
                                .first()
                                .toJSON()
                    ...
                    init() {
                        const self = this,
                            { uploadBtn, inputURLField, clearBtn } = this.selectors,
  ...
  \*******************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    var ApiValidations = __webpack_require__(
                        /*! ./admin/api-validations */ '../modules/forms/assets/js/admin/api-validations.js'
                    )
                    ...
                    this.activeCcampaign = new ApiValidations(
            ...
            /***/ (module) => {
                ...
                module.exports = function (key, fieldID) {
                    ...
                    self.validateApi = function () {
                        ...
                        if (
                            this.cache.$apiUrlField.length &&
                            '' === this.cache.$apiUrlField.val()
                        ) {
                            this.setState('clear')
                            return
                        }
            ...
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    var EditButton = __webpack_require__(
                        /*! ./admin/edit-button */ '../modules/library/assets/js/admin/edit-button.js'
                    )
            ...
            /***/ (module) => {
                ...
                module.exports = function () {
                    ...
                    self.init = function () {
                        jQuery(document).on(
                            'change',
                            '.elementor-widget-template-select',
                            function () {
                                var $this = jQuery(this),
                                    templateID = $this.val(),
                                    $editButton = $this
                                        .parents('p')
                                        .find('.elementor-edit-template'),
                                ...
                                var editUrl =
                                    elementorAdmin.config.home_url +
                                    '?p=' +
                                    templateID +
                                    '&elementor'
  ...
  \**********************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    const ApiValidations = __webpack_require__(
                        /*! ./admin/api-validations */ '../modules/payments/assets/js/admin/api-validations.js'
                    )
  ...
  \**************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    var AdvancedRoleManager = __webpack_require__(
                        /*! ./admin/role-mananger */ '../modules/role-manager/assets/js/admin/role-mananger.js'
                    )
  ...
  \*********************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                module.exports = function () {
                    var CreateTemplateDialog = __webpack_require__(
                        /*! ./create-template-dialog */ '../modules/theme-builder/assets/js/admin/create-template-dialog.js'
                    )
  ...
  \***************************************/
        ...
        var _admin = _interopRequireDefault(
            __webpack_require__(
                /*! modules/popup/assets/js/admin/admin */ '../modules/popup/assets/js/admin/admin.js'
            )
        )
        var _admin2 = _interopRequireDefault(
            __webpack_require__(
                /*! ../../../../license/assets/js/admin */ '../license/assets/js/admin.js'
            )
        )
        const modules = {
            widget_template_edit_button: __webpack_require__(
                /*! modules/library/assets/js/admin */ '../modules/library/assets/js/admin.js'
            ),
            forms_integrations: __webpack_require__(
                /*! modules/forms/assets/js/admin */ '../modules/forms/assets/js/admin.js'
            ),
            AssetsManager: __webpack_require__(
                /*! modules/assets-manager/assets/js/admin */ '../modules/assets-manager/assets/js/admin.js'
            ),
            RoleManager: __webpack_require__(
                /*! modules/role-manager/assets/js/admin */ '../modules/role-manager/assets/js/admin.js'
            ),
            ThemeBuilder: __webpack_require__(
                /*! modules/theme-builder/assets/js/admin/admin */ '../modules/theme-builder/assets/js/admin/admin.js'
            ),
            StripeIntegration: __webpack_require__(
                /*! modules/payments/assets/js/admin */ '../modules/payments/assets/js/admin.js'
            ),
