...
/******/ ;(() => {
  ...
  \*************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _content = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./components/content */ '../modules/display-conditions/assets/js/editor/components/content.js'
                    )
                )
  ...
  \******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _app = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./app */ '../modules/display-conditions/assets/js/editor/app.js'
                    )
                )
                class DisplayConditionsBehavior extends Marionette.Behavior {
                    ...
                    events() {
                        return {
                            'click @ui.displayConditionsButton':
                                'onClickControlButtonDisplayConditions',
                            'mouseenter @ui.displayConditionsPromoButton':
                                'onHoverControlButtonDisplayConditions'
                        }
                    }
                    ...
                    getRootElement() {
                        let rootElement = window.parent.document.getElementById(
                            'elementor-conditions__modal'
                        )
                        if (!!rootElement) {
                            return rootElement
                        }
                    ...
                    mount() {
                        ...
                        ReactDOM.render(
                            /*#__PURE__*/ _react.default.createElement(
                                _app.default, // eslint-disable-line react/no-deprecated
                                {
  ...
  \*********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function CacheNotice({ setCacheNoticeStatus }) {
  ...
  \********************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireWildcard(__webpack_require__(/*! react */ 'react'))
                var _dayjs = _interopRequireDefault(
                ...
                var _constants = __webpack_require__(
                    /*! ../constants */ '../modules/display-conditions/assets/js/editor/constants.js'
                )
                var _i18n = __webpack_require__(/*! @wordpress/i18n */ '@wordpress/i18n')
                var _icons = __webpack_require__(/*! @elementor/icons */ '@elementor/icons')
                var _queryControl = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./controls/query-control */ '../modules/display-conditions/assets/js/editor/components/controls/query-control.js'
                    )
                )
                var _utils = __webpack_require__(
                    /*! ../utils/utils */ '../modules/display-conditions/assets/js/editor/utils/utils.js'
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    var r = new WeakMap(),
                ...
                const ConditionsRepeaterRow = ({
                    ...
                    const { conditions, groups } = conditionsConfig
                    ...
                    const groupedConditions = (0, _react.useMemo)(getGroupedConditions, [
                        conditionsConfig,
                        conditions
                    ])
                    ...
                    const getFormattedDate = (value, isInvalid) => {
                        ...
                        const { $M: month, $D: day, $y: year } = value
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            Object.keys(groupedConditions).map((itemName) =>
                                'group' === groupedConditions[itemName]
                                    ? /*#__PURE__*/ _react.default.createElement(
                                          _ui.ListSubheader,
                                          {
                                              key: itemName
                                          },
                                          groups[itemName].label
                                      )
                                    : /*#__PURE__*/ _react.default.createElement(
                                          _ui.MenuItem,
                                          {
                                          ...
                                          conditions[itemName].label
                                      )
                            )
                        ),
                        Object.keys(conditionControls)
                            .filter((controlKey) => controlKey !== '__settings')
                            .map((controlKey) => {
                                const control = conditionControls[controlKey],
                                    ...
                                    errorMessage =
                                        (controlErrors.shouldShow && controlErrors.message) || '',
                                    shouldShowError = Boolean(errorMessage)
                                let defaultValue =
                                    'undefined' !== typeof control.default
                                        ? control.default
                                        : Object.keys(options || {})?.[0] || ''
                                selectedConditions[dataIndex][controlKey] = getValue(
                                    selectedConditions[dataIndex][controlKey],
                                    control.type
                                )
                                        ...
                                        Object.entries(options).map(([optionKey, optionLabel]) =>
                                            /*#__PURE__*/ _react.default.createElement(
                                                _ui.MenuItem,
                                                {
                                                    ...
                                                    value: optionKey,
                                                    disabled:
                                                        control?.disabled_options?.includes(
                                                            optionKey
                                                        )
                                                },
                                                optionLabel
                                ...
                                if (_constants.CONTROL_TYPES.MULTIPLE_SELECT === control.type) {
                                    const { label } = selectedConditions[dataIndex][controlKey]
                                        ?.length
                                        ? ''
                                        : conditions[selectedConditions[dataIndex].condition]
                                    return /*#__PURE__*/ _react.default.createElement(
                                        _ui.Autocomplete,
                                        {
                                            ...
                                            onChange: (_event, newValues) =>
                                                handleChangeOption(newValues, controlKey, dataIndex)
                                        }
                                    )
                                }
                                if (
                                    _constants.CONTROL_TYPES.DATE_TIME === control.type &&
                                    'date' === control?.variant
                                ) {
                                    const props = {
                                        sx: {
                                            flex: 1
                                ...
                                return /*#__PURE__*/ _react.default.createElement(_ui.TextField, {
                                    ...
                                    helperText: errorMessage,
                                    value:
                                        selectedConditions[dataIndex][controlKey] || defaultValue,
                                    id: `text-${controlKey}`,
                                    variant: 'outlined',
                                    onChange: (event) =>
                                        handleChangeOption(
  ...
  \*****************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui')
                var _icons = __webpack_require__(/*! @elementor/icons */ '@elementor/icons')
                var _conditionsRepeaterRow = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./conditions-repeater-row */ '../modules/display-conditions/assets/js/editor/components/conditions-repeater-row.js'
                    )
                )
                var _utils = __webpack_require__(
                    /*! ../utils/utils */ '../modules/display-conditions/assets/js/editor/utils/utils.js'
                )
                var _conditionsContext = __webpack_require__(
                    /*! ../contexts/conditions-context */ '../modules/display-conditions/assets/js/editor/contexts/conditions-context.js'
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    var r = new WeakMap(),
                ...
                const ConditionsSelectors = ({
                    ...
                    const { selectedConditions, dispatch } = (0, _react.useContext)(
                        _conditionsContext.ConditionsContext
                    )
                    const { conditions } = conditionsConfig
                    const initializeDefaultValues = (0, _react.useCallback)(
                        (conditionKey) => {
                            const defaultValues = {
                                errors: {}
                            }
                            if (conditions[conditionKey]?.controls) {
                                Object.keys(conditions[conditionKey].controls)
                                    .filter((controlKey) => controlKey !== '__settings')
                                    .forEach((controlKey) => {
                                        const control =
                                                conditions[conditionKey].controls[controlKey],
                                            { type, variant = null, options } = control,
                                            defaultValue =
                                                control?.default ||
                                                (options ? Object.keys(options)[0] : '')
                                        defaultValues[controlKey] = (0, _utils.shouldCastToArray)(
                                            type
                                        )
                                            ? []
                                            : defaultValue
                    ...
                    const handleChangeOption = (value, controlKey, dataIndex) => {
                        const { type, variant } =
                                conditionsConfig.conditions[selectedConditions[dataIndex].condition]
                                    .controls[controlKey],
                            error = !value?.length
                                ? {
                                      message: (0, _utils.getErrorMessage)(type, variant),
                    ...
                    const getDefaultActiveCondition = (groups, allConditions) => {
                        for (const groupName in groups) {
                            const firstCondition = Object.keys(allConditions).find(
                                (conditionKey) => groupName === allConditions[conditionKey].group
                            )
                            if (firstCondition) {
                                return {
                    ...
                    const addRepeaterRow = () => {
                        const initialCondition = getDefaultActiveCondition(
                                conditionsConfig.groups,
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        showConditions &&
                            selectedConditions.map((selectedCondition, index) =>
                                /*#__PURE__*/ _react.default.createElement(
                                    _conditionsRepeaterRow.default,
                                    {
  ...
  \*******************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui')
                var _hierarchyIcon = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./icons/hierarchy-icon */ '../modules/display-conditions/assets/js/editor/components/icons/hierarchy-icon.js'
                    )
                )
                var _conditionsSelectors = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./conditions-selectors */ '../modules/display-conditions/assets/js/editor/components/conditions-selectors.js'
                    )
                )
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                __('Set one or more conditions for this element', 'elementor-pro')
                            ),
                            /*#__PURE__*/ _react.default.createElement(
                                _ui.Typography,
                                {
                                ...
                                __(
                                    'It will only appear on your website when all the conditions are met.',
                                    'elementor-pro'
                                ),
                                ' ',
                                /*#__PURE__*/ _react.default.createElement(
  ...
  \****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _header = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./header */ '../modules/display-conditions/assets/js/editor/components/header.js'
                    )
                )
                var _footer = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./footer */ '../modules/display-conditions/assets/js/editor/components/footer.js'
                    )
                )
                var _conditions = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./conditions */ '../modules/display-conditions/assets/js/editor/components/conditions.js'
                    )
                )
                var _constants = __webpack_require__(
                    /*! ../constants */ '../modules/display-conditions/assets/js/editor/constants.js'
                )
                var _conditionsReducer = __webpack_require__(
                    /*! ../reducers/conditions-reducer */ '../modules/display-conditions/assets/js/editor/reducers/conditions-reducer.js'
                )
                var _conditionsContext = __webpack_require__(
                    /*! ../contexts/conditions-context */ '../modules/display-conditions/assets/js/editor/contexts/conditions-context.js'
                )
                ...
                var _cacheNotice = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./cache-notice */ '../modules/display-conditions/assets/js/editor/components/cache-notice.js'
                    )
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                ...
                const Content = ({
                    ...
                    const inputValue = getControlValue(),
                        ...
                        context = !controlValue
                            ? _constants.CONTEXT.CREATE
                            : _constants.CONTEXT.UPDATE
                    const [showConditions, setShowConditions] = _react.default.useState(true)
                    const [rowsRef, setRowsRefs] = (0, _react.useState)([])
                    const [selectedConditions, dispatch] = (0, _react.useReducer)(
                        _conditionsReducer.conditionsReducer,
                        controlValue || []
                    )
                    ...
                    const doesHaveInvalidFields = () => {
                        return selectedConditions.some(({ errors }) => {
                    ...
                    const handleRequiredEmptyFields = () => {
                        ...
                        selectedConditions.forEach((conditionConfig, index) => {
                            ...
                            requiredKeys.forEach((controlKey) => {
                                ...
                                const { type, variant = null } =
                                    conditionsConfig.conditions[condition].controls[controlKey]
                                firstInvalidIndex =
                                    -1 === firstInvalidIndex ? index : firstInvalidIndex
                                dispatch({
                                    type: 'SET_ERRORS',
                                    dataIndex: index,
                                    errors: {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        conditionsConfig.show_cache_notice &&
                            /*#__PURE__*/ _react.default.createElement(_cacheNotice.default, {
                                setCacheNoticeStatus: setCacheNoticeStatus
                            }),
                        /*#__PURE__*/ _react.default.createElement(
                            _conditionsContext.ConditionsContext.Provider,
                            {
                                value: {
                                    selectedConditions,
                                    dispatch
  ...
  \*******************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _i18n = __webpack_require__(/*! @wordpress/i18n */ '@wordpress/i18n')
                var _utils = __webpack_require__(
                    /*! elementor-pro-app/utils */ '../core/app/assets/js/utils.js'
                )
                function _getRequireWildcardCache(e) {
                    if ('function' != typeof WeakMap) return null
                    var r = new WeakMap(),
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui')
                function Footer({ onClickSaveButton, isButtonDisabled }) {
                    return /*#__PURE__*/ _react.default.createElement(
                        _ui.Stack,
                        {
                            direction: 'row',
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _react = _interopRequireDefault(__webpack_require__(/*! react */ 'react'))
                var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui')
                var _elementorLogo = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./icons/elementor-logo */ '../modules/display-conditions/assets/js/editor/components/icons/elementor-logo.js'
                    )
                )
                var _i18n = __webpack_require__(/*! @wordpress/i18n */ '@wordpress/i18n')
                var _propTypes = _interopRequireDefault(
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                (0, _i18n.__)('Display Conditions', 'elementor-pro')
                            ),
                            /*#__PURE__*/ _react.default.createElement(
                                _ui.Stack,
                                {
  ...
  \*****************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                const HierarchyIcon = (0, _ui.styled)(UnstyledHierarchyIcon)(({ theme }) => ({
                    '& path': {
  ...
  \****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _behavior = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./behavior */ '../modules/display-conditions/assets/js/editor/behavior.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    onElementorInit() {
                        elementor.hooks.addFilter(
                            ...
                            this.registerControlBehavior
                        )
                        elementor.channels.editor.on(
                            'section:activated',
                            this.highlightIconIfFilled
                        )
                    }
                    registerControlBehavior = (behaviors, view) => {
                        ...
                        behaviors.displayConditions = {
                            ...
                            getControlValue: () => {
                                const controlView =
                                    this.getEditorControlView('e_display_conditions')
                                if (!controlView) {
                                    return ''
                                }
                            ...
                            setControlValue: (value) => {
                                const displayConditionsInput =
                                        this.getEditorControlView('e_display_conditions'),
                                    displayConditionsTemplate = this.getEditorControlView(
                                ...
                                if (displayConditionsTemplate.$el) {
                                    const icon = displayConditionsTemplate.$el.find(
                                        '.eicon-flow.e-control-display-conditions'
                                    )
                                    this.highlightIcon(icon, displayConditionsInput)
                                }
                            },
                            fetchData: async (value, control) => {
                                const response = await this.doAjaxRequest(
                            ...
                            setCacheNoticeStatus: async () => {
                                const response = await this.doAjaxRequest(
                                    'display_conditions_set_cache_notice_status'
                                )
                                if (response) {
                    ...
                    highlightIconIfFilled = (sectionName, editor) => {
                        ...
                        const icon = editor.$childViewContainer.find(
                            '.eicon-flow.e-control-display-conditions'
                        )
  ...
  \*********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                const shouldCastToArray = (controlType) => {
                    return (
                        _constants.CONTROL_TYPES.MULTIPLE_SELECT === controlType ||
                        _constants.CONTROL_TYPES.QUERY === controlType
                    )
                }
                ...
                const getErrorMessage = (controlType, variant = null) => {
                    ...
                    if (_constants.CONTROL_TYPES.DATE_TIME === controlType) {
                        return 'time' === variant
                            ? __('Select a time', 'elementor-pro')
                            : __('Select a date', 'elementor-pro')
                    }
...
*/
  ...
  \***************************************************************/
        ...
        var _module = _interopRequireDefault(
            __webpack_require__(
                /*! ./module.js */ '../modules/display-conditions/assets/js/editor/module.js'
            )
        )
        new _module.default()
    })()
