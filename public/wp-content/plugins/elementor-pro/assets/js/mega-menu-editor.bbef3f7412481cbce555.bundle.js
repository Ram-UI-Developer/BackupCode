  ...
  \**********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _view = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./views/view */ '../modules/mega-menu/assets/js/editor/views/view.js'
                    )
                )
  ...
  \*******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _megaMenu = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./mega-menu */ '../modules/mega-menu/assets/js/editor/mega-menu.js'
                    )
                )
                var _urlHelper = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./utils/url-helper */ '../modules/mega-menu/assets/js/editor/utils/url-helper.js'
                    )
                )
                class Module extends elementorModules.editor.utils.Module {
                    ...
                    closeAllMegaMenus() {
                        const megaMenus = elementor.$previewContents[0].querySelectorAll(
                        ...
                        if (megaMenus.length) {
                            Array.from(megaMenus).forEach((node) => {
                                ...
                                window
                                    .jQuery(window)
                                    .trigger('elementor/mega-menu/dropdown-toggle-by-keyboard', {
                                        widgetId: id,
                                        show: false
                                    })
                            })
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                class View extends $e.components.get('nested-elements').exports.NestedView {
                    ...
                    onAddChild(childView) {
                        const widgetNumber =
                                childView._parent.$el.find('.e-n-menu')[0]?.dataset.widgetNumber ||
                                childView.model.attributes.widgetId,
                            index = childView.model.attributes.dataIndex,
                            tabId =
                                childView._parent.$el
                                    .find(`.e-n-menu-item-title[data-tab-index="${index}"]`)
                                    ?.attr('id') ||
                                childView.model.attributes.widgetId + ' ' + index
                        childView.$el.attr({
