...
;(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [124],
    {
            ...
            class Base extends elementorModules.frontend.handlers.Base {
                ...
                activateStickyRightColumn() {
                    ...
                    ;(t.length && 'fixed' === t.css('position') && (n += t.height()),
                        'yes' === this.getElementSettings('sticky_right_column') &&
                            (this.elements.$stickyRightColumn.addClass(o.stickyRightColumnActive),
                ...
                updateWpReferers() {
                    const e = this.getSettings('selectors'),
                        ...
                        o = new URL(document.location)
                    ;(o.searchParams.set('elementorPageId', elementorFrontend.config.post.id),
                        o.searchParams.set('elementorWidgetId', this.getID()),
                        t.attr('value', o))
                }
            }
            t.default = Base
        ...
        9035: (e, t, o) => {
            ...
            ;(Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = void 0))
            var s = n(o(915))
            class Checkout extends s.default {
                getDefaultSettings() {
