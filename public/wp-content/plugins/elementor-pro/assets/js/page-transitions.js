...
/******/ ;(() => {
  ...
  \**************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _pageTransition = __webpack_require__(
                    /*! ./page-transition/page-transition */ '../modules/page-transitions/assets/js/frontend/components/page-transition/page-transition.js'
                )
                var _preloader = __webpack_require__(
                    /*! ./preloader/preloader */ '../modules/page-transitions/assets/js/frontend/components/preloader/preloader.js'
                )
  ...
  \********************************************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                var _default = (exports['default'] = {
                    ...
                    isDisabled: (a) =>
                        Object.prototype.hasOwnProperty.call(a.dataset, 'eDisablePageTransition'),
                    ...
                    isPopup: (a) =>
                        'true' === a.getAttribute('aria-haspopup') &&
                    ...
                    isWoocommerce: (a) => {
                        const isAddToCart = a.href.match(/\?add-to-cart=/),
                            ...
                            isWoocommerceTab = a.parentElement?.classList.contains(
  ...
  \****************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _pageTransitionComponent = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./page-transition.component.scss */ '../modules/page-transitions/assets/js/frontend/components/page-transition/page-transition.component.scss'
                    )
                )
                var _filters = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./filters */ '../modules/page-transitions/assets/js/frontend/components/page-transition/filters.js'
                    )
                )
                class PageTransition extends HTMLElement {
                    ...
                    shouldPageTriggerTransition(a) {
                        return Object.values(_filters.default).every(
                            (shouldDisable) => !shouldDisable(a, this.getAttribute('exclude'))
                        )
                    }
		...
		`
                    ...
                    getCssVar(variable, prefix = 'e-page-transition-') {
                        return window
                            ...
                            .getPropertyValue(`--${prefix}${variable}`)
                    }
  ...
  \****************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _preloaderComponent = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./preloader.component.scss */ '../modules/page-transitions/assets/js/frontend/components/preloader/preloader.component.scss'
                    )
                )
...
*/
  ...
  \******************************************************************/
        ...
        var _components = __webpack_require__(
            /*! ./components */ '../modules/page-transitions/assets/js/frontend/components/index.js'
        )
