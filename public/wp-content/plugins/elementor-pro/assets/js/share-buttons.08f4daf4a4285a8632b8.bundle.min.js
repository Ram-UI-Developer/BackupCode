                ...
                (t.default = function handleParameterPollution(e) {
                    ...
                    return (
                        ['u'].forEach((e) => {
                            ...
                            if (t)
                                try {
                                    new URL(t).hostname !== n && r.delete(e)
                                } catch (t) {
                                    r.delete(e)
                                }
                        }),
            ...
            t.default = elementorModules.frontend.handlers.Base.extend({
                async onInit() {
                    ...
                    const e = this.getElementSettings(),
                        ...
                        r = { classPrefix: t.shareLinkPrefix }
                    ;(n
                        ? (r.url = e.share_url.url)
                        : ((r.url = (0, s.default)(location.href)),
                          (r.title = elementorFrontend.config.post.title),
                          (r.text = elementorFrontend.config.post.excerpt),
                          (r.image = elementorFrontend.config.post.featuredImage)),
                        !window.ShareLink &&
                        ...
                        this.elements.$shareButton.shareLink &&
                            this.elements.$shareButton.shareLink(r))
                },
                getDefaultSettings: () => ({
