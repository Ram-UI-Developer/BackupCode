        ...
        2627: (e, o) => {
            ...
            class _default extends elementorModules.frontend.handlers.Base {
                ...
                moveNotices() {
                    ...
                    const o = this.getSettings('selectors')
                    let t = elementorFrontend.elements.$body.find(o.woocommerceNotices)
                    if (
                        ((elementorFrontend.isEditMode() || elementorFrontend.isWPPreviewMode()) &&
                            (t = t.filter(':not(.e-notices-demo-notice)')),
                        e && this.elements.$documentScrollToElements.stop(),
                        this.elements.$noticesWrapper.prepend(t),
                        this.is_ready ||
