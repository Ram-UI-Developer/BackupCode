...
;(self['webpackChunkelementor_pro'] = self['webpackChunkelementor_pro'] || []).push([
                ...
                class baseTabs extends elementorModules.frontend.handlers.Base {
                    ...
                    activateDefaultTab(videoId) {
                        ...
                        const defaultActiveTab =
                                this.getEditSettings('activeItemIndex') || videoId || 1,
  ...
  \*********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _playlistEvent = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./playlist-event */ '../modules/video-playlist/assets/js/frontend/playlist-event.js'
                    )
                )
                // Functions to get objects for the playlist event object.
                function getEventTabsObject(widgetObject) {
                    const currentInnerTabsTitleElements = widgetObject.elements.$innerTabs
                        .filter('.e-active')
                        .find('.e-inner-tabs-wrapper .e-inner-tab-title')
                    if (currentInnerTabsTitleElements.length) {
                        const activeInnerTabTitleElement =
                            currentInnerTabsTitleElements.filter('.e-inner-tab-active')
                        return {
                ...
                function getEventPlaylistObject(widgetObject, positionInVideoList) {
                    const currentVideoIndex =
                        positionInVideoList || widgetObject.currentPlaylistItemIndex
                    return {
                        name: widgetObject.getElementSettings('playlist_title'),
                        currentItem: currentVideoIndex,
                        amount: widgetObject.playlistItemsArray.filter(
                            (video) => video.videoType !== 'section'
                        ).length
                    }
                }
                ...
                async function getEventEventObject(
                    widgetObject,
                    eventType,
                    eventTrigger,
                    positionInVideoList
                ...
                async function triggerEvent(
                    ...
                    const currentEvent = new _playlistEvent.default({
                        event: await getEventEventObject(
                            widgetObject,
                            eventType,
                            eventTrigger,
                            positionInVideoList
  ...
  \***************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _baseTabs = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./base-tabs */ '../modules/video-playlist/assets/js/frontend/base-tabs.js'
                    )
                )
                var _playerYoutube = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./player-youtube */ '../modules/video-playlist/assets/js/frontend/player-youtube.js'
                    )
                )
                var _playerVimeo = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./player-vimeo */ '../modules/video-playlist/assets/js/frontend/player-vimeo.js'
                    )
                )
                var _playerHosted = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./player-hosted */ '../modules/video-playlist/assets/js/frontend/player-hosted.js'
                    )
                )
                var _scrollUtils = __webpack_require__(
                    /*! ./scroll-utils */ '../modules/video-playlist/assets/js/frontend/scroll-utils.js'
                )
                var _innerTabs = __webpack_require__(
                    /*! ./inner-tabs */ '../modules/video-playlist/assets/js/frontend/inner-tabs.js'
                )
                var _urlParams = __webpack_require__(
                    /*! ./url-params */ '../modules/video-playlist/assets/js/frontend/url-params.js'
                )
                var _eventTrigger = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./event-trigger */ '../modules/video-playlist/assets/js/frontend/event-trigger.js'
                    )
                )
                class VideoPlaylistHandler extends _baseTabs.default {
                    ...
                    getDefaultElements() {
                        ...
                        return {
                            ...
                            $toggleVideosDisplayButton: this.findElement(
                                selectors.toggleVideosDisplayButton
                            ),
                    ...
                    activateInitialVideo() {
                        ...
                        const isLazyLoad = !!this.getElementSettings('lazy_load'),
                            initialTabIndex = (0, _urlParams.handleURLParams)(
                                this.playlistId,
     ...
     */
                    ...
                    handleVideo(playListItem) {
                        ...
                        if (playListItem.playerInstance) {
                            ...
                            playListItem.playerInstance = new players[playListItem.videoType](
                                playListItem,
                                this.currentPlaylistItemIndex
                            )
                            playListItem.playerInstance.create().then(() => {
                                ...
                                playListItem.playerInstance.handleFullScreenChange(
                                    (isEnterFullScreenMode) => {
                                        // Trigger event when enter/exit full screen mode.
                                        ;(0, _eventTrigger.default)(
                                            this,
                                            isEnterFullScreenMode
                                                ? 'videoFullScreen'
                                                : 'videoExitFullScreen',
                                ...
                                playListItem.playerInstance.handlePlayed(() => {
                                    ...
                                    ;(0, _eventTrigger.default)(
                                        this,
                                        currentPlaylistItem.playerInstance.isVideoPausedLocal
                                            ? 'videoResume'
                                            : 'videoStart',
                                        videoTrigger
                                    )
                                ...
                                playListItem.playerInstance.handleEnded(() => {
                                    ...
                                    if (
                                        !this.watchedVideosArray.includes(endedVideoId) &&
                                    ...
                                    if (this.isAutoplayNextUp) {
                                        ...
                                        if (
                                            ...
                                            while (
                                                'section' ===
                                                this.getCurrentItemSelected().videoType
                                            ) {
                                                this.currentPlaylistItemIndex++
                    ...
                    createPlaylistItems() {
                        ...
                        if (this.watchedVideosArray.length > 0 && this.watchedIndication) {
                            this.watchedVideosArray.forEach((watchedVideoId) => {
                                const watchedPlaylistItem = this.playlistItemsArray.find(
                                    (playlistItem) => playlistItem.dataItemId === watchedVideoId
                                )
                                this.elements.$tabTitles
                                    .filter('[data-tab="' + watchedPlaylistItem.dataTab + '"]')
                                    .addClass('watched-video')
                            })
                        }
                    }
                    changeActiveTab(tabIndex, isVideoSelectedAutomatically) {
                        ...
                        if (
                            this.playlistItemsArray[tabIndex - 1] &&
                            this.playlistItemsArray[tabIndex - 1].videoType !== 'section'
                        ) {
                            ...
                            this.handleVideo(
                                this.getCurrentItemSelected(),
                                isVideoSelectedAutomatically
                            )
                            ...
                            if (
                                jQuery(this.elements.$innerTabs.eq(tabIndex - 1)).find(
                                    '.e-inner-tab-content'
                                ).length > 0
                            ) {
                                const innerTabsContent = this.elements.$innerTabs
                                    .filter('.e-active')
                                    .find('.e-inner-tab-content')
                                ;(0, _innerTabs.handleInnerTabsButtonsDisplay)(
                                    innerTabsContent.toArray(),
                                    this.isCollapsible,
  ...
  \******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function toggleInnerTabs(event, clickedTab, widgetObject) {
                    ...
                    handleInnerTabsButtonsDisplay(
                        Array.from(tabsContents),
                        widgetObject.isCollapsible,
                        widgetObject.innerTabsHeightLimit
                    )
                ...
                function handleInnerTabsButtonsDisplay(
                    tabsContents,
                    isCollapsible,
                    innerTabsHeightLimit
                ) {
                    if (!isCollapsible) {
                        return
                    }
                    const activeInnerTab = tabsContents.filter((tabsContent) =>
                            tabsContent.classList.contains('e-inner-tab-active')
                        ),
                        innerTabScrollableHeight =
                            activeInnerTab[0].querySelector('.e-inner-tab-text > div').offsetHeight,
                ...
                function onTabContentButtonsClick(event, widgetObject) {
                    ...
                    const eventType = $activeTabContent.hasClass('show-full-height')
                        ? 'tabExpanded'
                        : 'tabCollapsed'
  ...
  \*********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _playerBase = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./player-base */ '../modules/video-playlist/assets/js/frontend/player-base.js'
                    )
                )
                    ...
                    create() {
                        ...
                        return new Promise((resolve) => {
                            this.apiProvider.onApiReady((apiObject) => {
                                ...
                                this.playerObject = new apiObject.Player(
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class playerYoutube extends _playerBase.default {
                                ...
                                this.playerObject.addEventListener('onStateChange', (event) => {
                                    ...
                                    if (3 === event.data) {
                                        ...
                                        if (
                                            2 ===
                                            this.seekSequenceArray[
                                                this.seekSequenceArray.length - 1
                                            ]
                                        ) {
                    ...
                    getCurrentTime() {
                        const currentTime = this.pauseCurrentTime
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class PlaylistEvent {
                    constructor(_ref) {
                        let { event, tab, playlist, video } = _ref
                        this.event = {
                            type: event.type || '',
                            time: event.time || 0,
  ...
  \********************************************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                function handleVideosPanelScroll(elements, event) {
                    if (!event) {
                        if (
                            elements.$tabsItems[0].offsetHeight <
                            elements.$tabsItems[0].scrollHeight
                        ) {
            ...
            /***/ (__unused_webpack_module, exports) => {
                ...
                function handleURLParams(playlistId, playlistItemsArray) {
                    ...
                    if (playlistName === playlistId) {
                        ...
                        const videoItem = playlistItemsArray.find(
                                (playlistItem) => videoId === playlistItem.dataItemId
                            ),
