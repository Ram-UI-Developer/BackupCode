...
var EGallery = /******/ (function (modules) {
  ...
  \*****************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* harmony import */ var _types_grid__WEBPACK_IMPORTED_MODULE_2__ =
                    __webpack_require__(/*! ./types/grid */ './src/js/types/grid.js')
                /* harmony import */ var _types_justified__WEBPACK_IMPORTED_MODULE_3__ =
                    __webpack_require__(/*! ./types/justified */ './src/js/types/justified.js')
                /* harmony import */ var _types_masonry__WEBPACK_IMPORTED_MODULE_4__ =
                    __webpack_require__(/*! ./types/masonry */ './src/js/types/masonry.js')
                /* harmony import */ var _scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5__ =
                    __webpack_require__(/*! ../scss/e-gallery.scss */ './src/scss/e-gallery.scss')
                /* harmony import */ var _scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5___default =
                    /*#__PURE__*/ __webpack_require__.n(
                        _scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5__
                    )
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function initGalleriesTypes() {
                                        this.galleriesTypes = {
                                            grid: _types_grid__WEBPACK_IMPORTED_MODULE_2__[
                                                'default'
                                            ],
                                            justified:
                                                _types_justified__WEBPACK_IMPORTED_MODULE_3__[
                                                    'default'
                                                ],
                                            masonry:
                                                _types_masonry__WEBPACK_IMPORTED_MODULE_4__[
                                                    'default'
                                                ]
                                        }
                                    }
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function initElements() {
                                        ...
                                        var containerClasses =
                                            ...
                                            ' ' +
                                            this.getItemClass(directionClass)
                                ...
                                },
                                {
                                    ...
                                    value: function getCurrentBreakpoint() {
                                        var breakpoints = Object.keys(this.settings.breakpoints)
                                            .map(Number)
                                            .sort(function (a, b) {
                                                return a - b
                                            })
                                ...
                                },
                                {
                                    ...
                                    value: function getCurrentDeviceSetting(settingKey) {
                                        ...
                                        if (currentBreakpoint) {
                                            return this.settings.breakpoints[currentBreakpoint][
                                                settingKey
                                            ]
                                        }
                                ...
                                },
                                {
                                    ...
                                    value: function createOverlay(overlayData) {
                                        var _this$settings = this.settings,
                                            ...
                                            overlayContent = this.compileTemplate(
                                                overlayTemplate,
                                                jQuery.extend(true, this.settings, overlayData)
                                            )
                                ...
                                },
                                {
                                    ...
                                    value: function lazyLoadImages() {
                                        ...
                                        $items.each(function (index, item) {
                                            var itemData =
                                                _this6.settings.items[itemsIndexes[index]]
                                            ...
                                            promise.then(function () {
                                                $item
                                                    .find(_this6.settings.selectors.image)
                                                    .css(
                                                        'background-image',
                                                        'url("' + itemData.thumbnail + '")'
                                                    )
                                                    .addClass(
                                                        _this6.getItemClass(
                                                            _this6.settings.classes.imageLoaded
                                                        )
                                                    )
                                    ...
                                    value: function makeGalleryFromContent() {
                                        ...
                                        this.$items.each(function (index, item) {
                                            ...
                                            if (isLazyLoad) {
                                                ...
                                                $image.css(
                                                    'background-image',
                                                    'url("'.concat($image.data('thumbnail'), '")')
                                                )
                                            }
                                        })
                                ...
                                },
                                {
                                    key: 'setSettings',
                                    value: function setSettings(key, value) {
                                        var nestedObjectData = this.getNestedObjectData(
                                            this.settings,
                                            key
                                        )
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function setContainerSize() {
                                        var columns = this.getCurrentDeviceSetting('columns'),
                                            rows = Math.ceil(
                                                this.getActiveItems().length / columns
                                            ),
                                        ...
                                        var itemWidth = this.getActiveItems().width(),
                                            ...
                                            calculatedAspectRatio =
                                                (totalHeight / this.$container.width()) * 100
                                        containerStyle.setProperty(
                                            '--aspect-ratio',
                                            aspectRatioPercents * 100 + '%'
                                        )
                                        containerStyle.setProperty(
                                ...
                                },
                                {
                                    ...
                                    value: function run() {
                                        ...
                                        var animatedClass = this.getItemClass(
                                            this.settings.classes.animated
                                        )
                        ...
                        _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(
                            ...
                            [
                                ...
                                },
                                {
                                    ...
                                    value: function makeJustifiedRow(startIndex) {
                                        ...
                                        for (var index = startIndex; ; index++) {
                                            ...
                                            var itemComputedWidth = Math.round(
                                                this.getCurrentDeviceSetting('idealRowHeight') *
                                                    imageData.ratio
                                            )
                                            ...
                                            var isLastItem =
                                                index === this.getActiveItems().length - 1
                                            imageData.computedWidth = itemComputedWidth

                                            if (isLastItem) {
                                                var lastRowMode =
                                                    this.getCurrentDeviceSetting('lastRow')

                                                if ('hide' !== lastRowMode) {
                                                    var totalRowWidth =
                                                        'fit' === lastRowMode ||
                                                        0.7 <= newRowWidth / this.containerWidth
                                                            ? newRowWidth
                                                            : this.containerWidth
                                                    this.fitImagesInContainer(
                                                        startIndex,
                                ...
                                },
                                {
                                    ...
                                    value: function fitImagesInContainer(
                                        startIndex,
                                        endIndex,
                                        rowWidth
                                    ) {
                                        ...
                                        for (var index = startIndex; index < endIndex; index++) {
                                            var imageData = this.getImageData(index),
                                                ...
                                                firstRowItemClass = this.getItemClass(
                                                    this.settings.classes.firstRowItem
                                                )
                                            ...
                                            if (index === startIndex) {
                                                ...
                                                var imagePxWidth =
                                                    ...
                                                    (this.containerWidth -
                                                        gapCount *
                                                            this.getCurrentDeviceSetting(
                                                                'horizontalGap'
                                                            ))
                                                this.rowsHeights.push(
                                                    imagePxWidth / imageData.ratio
                                                )
                                            } else {
                                ...
                                },
                                {
                                    ...
                                    value: function inflateGalleryHeight() {
                                        var totalRowsHeight = this.rowsHeights.reduce(
                                                function (total, item) {
                                                    return total + item
                                                }
                                            ),
                                            ...
                                            containerAspectRatio =
                                                finalContainerHeight / this.containerWidth,
                                            percentRowsHeights = this.rowsHeights.map(
                                                function (rowHeight) {
                                        ...
                                        this.getActiveItems().each(function (index, item) {
                                            var itemRowIndex =
                                                    item.style.getPropertyValue('--item-row-index'),
                                            ...
                                            if (isFirstItem) {
                                                ...
                                                if (currentRow) {
                                                    accumulatedTop +=
                                                        percentRowsHeights[currentRow - 1]
                                                }
                                            }
                            ...
                            [
                                {
                                    ...
                                    value: function run(refresh) {
                                        ...
                                        $items.each(function (index, item) {
                                            ...
                                            jQuery.each(
                                                heights,
                                                function (colNumber, currentColHeight) {
                                                    if (
                                                        currentColHeight &&
                                                        naturalColumnHeight > currentColHeight + 5
                                                    ) {
                                        ...
                                        $items.each(function (index, item) {
                                            var percentHeight = aggregatedHeights[index]
                                                ? (aggregatedHeights[index] / highestColumn) * 100
                                                : 0
                                            item.style.setProperty(
                                                '--percent-height',
                                                percentHeight + '%'
  ...
  \*******************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                'use strict'
                __webpack_require__.r(__webpack_exports__)
                /* harmony import */ var _element_in_view__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./element-in-view */ './src/js/utils/element-in-view.js'
                    )
