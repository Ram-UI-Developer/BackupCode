...
!(function (p, t) {
        ...
        (y.Widget = function (n) {
            ...
            ;((this.addElement = function (t, e, n) {
                ...
                (this.off = function (t, e) {
                    return (
                        u[t] &&
                            (e ? -1 !== (e = u[t].indexOf(e)) && u[t].splice(e, 1) : delete u[t]),
                        c
                    )
                }),
                (this.refreshPosition = function () {
                    ...
                    a.position.enable &&
                        ...
                        a.iframe &&
                            ...
                            (r = []),
                            1 === s.length &&
                                (/left|right/.test(s[0]) ? s.push('center') : s.unshift('center')),
                ...
                (this.show = function () {
                    ...
                    return (
                        ...
                        (a.hide.onClick || a.hide.onBackgroundClick) && d.widget.on('click', i),
                        a.preventScroll && c.getElements('body').addClass(a.classes.preventScroll),
                        c.trigger('show'),
                        c
                    )
                }),
    ...
    'undefined' != typeof module && void 0 !== module.exports ? module.exports : window
)
