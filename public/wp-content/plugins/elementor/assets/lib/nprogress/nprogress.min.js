!(function (root, factory) {
    ...
    ;((NProgress.configure = function (options) {
        ...
        for (key in options)
            ((value = options[key]),
                void 0 !== value && options.hasOwnProperty(key) && (Settings[key] = value))
        return this
    }),
