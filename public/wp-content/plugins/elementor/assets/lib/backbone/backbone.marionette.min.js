    ...
    return (
                ...
                show: function (a, b) {
                    if (this._ensureElement()) {
                        ...
                        var d = b || {},
                            ...
                            k = e || h
                        if (
                            (i && this.triggerMethod('before:swapOut', this.currentView, this, b),
        ...
        (f.View = b.View.extend({
            ...
            _buildViewTrigger: function (a) {
                ...
                return function (a) {
                    ...
                    var c = { view: this, model: this.model, collection: this.collection }
            ...
            _triggerEventOnBehaviors: function (a) {
                for (
                    var b = f._triggerMethod, c = this._behaviors, d = 0, e = c && c.length;
                    e > d;
                    d++
                )
                    b(c[d], a)
        ...
        (f.CollectionView = f.View.extend({
            ...
            endBuffering: function () {
                ...
                ;((this.isBuffering = !1),
                    ...
                    b &&
                        this._triggerAttach &&
                        ((a = this._getNestedViews()), this._triggerMethodMany(a, this, 'attach')),
        ...
        (f.CompositeView = f.CollectionView.extend({
            ...
            serializeData: function () {
                ...
                return (
                    this.model &&
                        (a = c.partial(this.serializeModel, this.model).apply(this, arguments)),
                    a
                )
            },
            render: function () {
            ...
            return (
                ...
                b.extend(d.prototype, {
                    buildBehaviorTriggers: function () {
                        return (
                            b.each(this._behaviors, this._buildTriggerHandlersForBehavior, this),
                            this._triggers
                        )
                    },
        ...
        (f.Application = f.Object.extend({
            ...
            _initChannel: function () {
                ;((this.channelName = c.result(this, 'channelName') || 'global'),
                    (this.channel =
                        c.result(this, 'channel') || b.Wreqr.radio.channel(this.channelName)),
        ...
        c.extend(f.Module, {
            ...
            _getStartWithParent: function (a, b) {
                ...
                return c.isFunction(a) && a.prototype instanceof f.Module
                    ? ((d = b.constructor.prototype.startWithParent), c.isUndefined(d) ? !0 : d)
                    : c.isObject(a)
