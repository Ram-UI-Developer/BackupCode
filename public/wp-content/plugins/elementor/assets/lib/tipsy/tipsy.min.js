!(function ($) {
    ...
    function isElementInDOM(ele) {
        for (; (ele = ele.parentNode); ) if (ele == document) return !0
        return !1
    }
    ...
    ;((Tipsy.prototype = {
        ...
        fixTitle: function () {
            var $e = this.$element
            ;($e.attr('title') || 'string' != typeof $e.attr('original-title')) &&
        ...
        getTitle: function () {
            ...
            return (
                'string' == typeof o.title
                    ? (title = $e.attr('title' == o.title ? 'original-title' : o.title))
        ...
        ($.fn.tipsy.autoBounds = function (margin, prefer) {
            return function () {
                var dir = { ns: prefer[0], ew: prefer.length > 1 && prefer[1] },
                    ...
                    $this = $(this)
                return (
                    $this.offset().top < boundTop && (dir.ns = 'n'),
                    $this.offset().left < boundLeft && (dir.ew = 'w'),
                    $(window).width() + $(document).scrollLeft() - $this.offset().left < margin &&
                        (dir.ew = 'e'),
                    $(window).height() + $(document).scrollTop() - $this.offset().top < margin &&
                        (dir.ns = 's'),
                    dir.ns + (dir.ew ? dir.ew : '')
                )
            }
        }))
})(jQuery)
