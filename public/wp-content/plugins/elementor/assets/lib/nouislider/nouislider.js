...
;(function (factory) {
    ...
    function testAnimationDuration(parsed, entry) {
        ...
        if (typeof entry !== 'number') {
            throw new Error(
                'noUiSlider (' + VERSION + "): 'animationDuration' option must be a number."
            )
        }
    }
    ...
    function testConnect(parsed, entry) {
        ...
        // Reject invalid input
            ...
            throw new Error(
                'noUiSlider (' + VERSION + "): 'connect' option doesn't match handle count."
            )
        } else {
            connect = entry
        }
    ...
    function testMargin(parsed, entry) {
        ...
        if (!parsed.margin) {
            throw new Error(
                'noUiSlider (' + VERSION + "): 'margin' option is only supported on linear sliders."
            )
        }
    }
    ...
    function testKeyboardSupport(parsed, entry) {
        ...
        if (typeof entry !== 'boolean') {
            throw new Error(
                'noUiSlider (' + VERSION + "): 'keyboardSupport' option must be a boolean."
            )
        }
    }
    ...
    function scope(target, options, originalOptions) {
        ...
        function fixEvent(e, pageOffset, eventTarget) {
            ...
            if (touch) {
                ...
                var isTouchOnTarget = function (checkTouch) {
                    return (
                        checkTouch.target === eventTarget || eventTarget.contains(checkTouch.target)
                    )
                }
        ...
        function moveHandles(upward, proposal, locations, handleNumbers) {
            ...
            handleNumbers.forEach(function (handleNumber, o) {
                state =
                    setHandle(handleNumber, locations[handleNumber] + proposal, b[o], f[o]) || state
            })
