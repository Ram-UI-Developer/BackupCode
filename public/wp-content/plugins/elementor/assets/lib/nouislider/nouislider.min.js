...
!(function (t) {
    ...
    function o(t, e, r) {
        ...
        if (('number' == typeof e && (e = [e]), !Array.isArray(e)))
            throw new Error('noUiSlider (' + ot + "): 'range' contains invalid value.")
        if (!i((n = 'min' === t ? 0 : 'max' === t ? 100 : parseFloat(t))) || !i(e[0]))
            throw new Error('noUiSlider (' + ot + "): 'range' value isn't numeric.")
        ;(r.xPct.push(n),
            r.xVal.push(e[0]),
    ...
    function d(t) {
        if ('object' == typeof (e = t) && 'function' == typeof e.to && 'function' == typeof e.from)
            return !0
        var e
        throw new Error('noUiSlider (' + ot + "): 'format' requires 'to' and 'from' methods.")
    }
    function h(t, e) {
        if (!i(e)) throw new Error('noUiSlider (' + ot + "): 'step' is not numeric.")
        t.singleStep = e
    }
    function m(t, e) {
        if ('object' != typeof e || Array.isArray(e))
            throw new Error('noUiSlider (' + ot + "): 'range' is not an object.")
        if (void 0 === e.min || void 0 === e.max)
            throw new Error('noUiSlider (' + ot + "): Missing 'min' or 'max' in 'range'.")
        if (e.min === e.max)
            throw new Error('noUiSlider (' + ot + "): 'range' 'min' and 'max' cannot be equal.")
        t.spectrum = new l(e, t.snap, t.singleStep)
    }
    function g(t, e) {
        if (((e = ut(e)), !Array.isArray(e) || !e.length))
            throw new Error('noUiSlider (' + ot + "): 'start' option is incorrect.")
        ;((t.handles = e.length), (t.start = e))
    }
    function v(t, e) {
        if ('boolean' != typeof (t.snap = e))
            throw new Error('noUiSlider (' + ot + "): 'snap' option must be a boolean.")
    }
    function b(t, e) {
        if ('boolean' != typeof (t.animate = e))
            throw new Error('noUiSlider (' + ot + "): 'animate' option must be a boolean.")
    }
    function S(t, e) {
        if ('number' != typeof (t.animationDuration = e))
            throw new Error('noUiSlider (' + ot + "): 'animationDuration' option must be a number.")
    }
    function w(t, e) {
        var r,
            n = [!1]
        if (
            ...
            if (!Array.isArray(e) || !e.length || e.length !== t.handles + 1)
                throw new Error(
                    'noUiSlider (' + ot + "): 'connect' option doesn't match handle count."
                )
            n = e
        }
        t.connect = n
    ...
    function x(t, e) {
        switch (e) {
            ...
            case 'vertical':
                ...
                break
            default:
                throw new Error('noUiSlider (' + ot + "): 'orientation' option is invalid.")
        }
    }
    function y(t, e) {
        if (!i(e)) throw new Error('noUiSlider (' + ot + "): 'margin' option must be numeric.")
        if (0 !== e && ((t.margin = t.spectrum.getMargin(e)), !t.margin))
            throw new Error(
                'noUiSlider (' + ot + "): 'margin' option is only supported on linear sliders."
            )
    }
    function E(t, e) {
        if (!i(e)) throw new Error('noUiSlider (' + ot + "): 'limit' option must be numeric.")
    ...
    function C(t, e) {
        ...
        if (0 !== e) {
            if (
                ...
                throw new Error(
                    'noUiSlider (' + ot + "): 'padding' option is only supported on linear sliders."
                )
            if (t.padding[0] < 0 || t.padding[1] < 0)
                throw new Error(
                    'noUiSlider (' + ot + "): 'padding' option must be a positive number(s)."
                )
            if (100 <= t.padding[0] + t.padding[1])
                throw new Error(
                    'noUiSlider (' + ot + "): 'padding' option must not exceed 100% of the range."
                )
        }
    }
    function N(t, e) {
        switch (e) {
            ...
            case 'rtl':
                ...
                break
            default:
                throw new Error('noUiSlider (' + ot + "): 'direction' option was not recognized.")
        }
    }
    function U(t, e) {
        if ('string' != typeof e)
            throw new Error(
                'noUiSlider (' + ot + "): 'behaviour' must be a string containing options."
            )
        ...
        if (i) {
            if (2 !== t.handles)
                throw new Error(
                    'noUiSlider (' + ot + "): 'fixed' behaviour must be used with 2 handles"
                )
    ...
    function k(t, e) {
        if (!1 !== e)
            if (!0 === e) {
                ...
                if (((t.tooltips = ut(e)), t.tooltips.length !== t.handles))
                    throw new Error(
                        'noUiSlider (' + ot + '): must pass a formatter for all handles.'
                    )
    ...
    function M(t, e) {
        if ('boolean' != typeof (t.keyboardSupport = e))
            throw new Error('noUiSlider (' + ot + "): 'keyboardSupport' option must be a boolean.")
    }
    function V(t, e) {
        t.documentElement = e
    }
    function O(t, e) {
        if ('string' != typeof e && !1 !== e)
            throw new Error('noUiSlider (' + ot + "): 'cssPrefix' must be a string or `false`.")
        t.cssPrefix = e
    }
    function L(t, e) {
        if ('object' != typeof e)
            throw new Error('noUiSlider (' + ot + "): 'cssClasses' must be an object.")
    ...
    function dt(e) {
        ...
        ;(e.format && !e.ariaFormat && (e.ariaFormat = e.format),
            Object.keys(n).forEach(function (t) {
                if (!s(e[t]) && void 0 === i[t]) {
                    if (n[t].r) throw new Error('noUiSlider (' + ot + "): '" + t + "' is required.")
                    return !0
                }
    ...
    function z(t, f, o) {
        var l,
            ...
            w = {},
            x = t.ownerDocument,
            C = f.documentElement || x.documentElement,
            N = x.body,
            U = -1,
            k = 0,
            P = 1,
            A = 2,
            M = 'rtl' === x.dir || 1 === f.ort ? 0 : 100
        function V(t, e) {
            var r = x.createElement('div')
            return (e && ct(r, e), t.appendChild(r), r)
        }
        function O(t, e) {
                ...
                f.keyboardSupport &&
                    ...
                    n.addEventListener('keydown', function (t) {
                        return (function (t, e) {
                            ...
                            return ((l *= o ? -1 : 1), (m = !1), rt(e, g[e] + l, !0), !(m = !0))
                        })(t, e)
                    })),
                n.setAttribute('role', 'slider'),
                n.setAttribute('aria-orientation', f.ort ? 'vertical' : 'horizontal'),
                0 === e
                    ? ct(n, f.cssClasses.handleLower)
                    : e === f.handles - 1 && ct(n, f.cssClasses.handleUpper),
                r
            )
        }
        function L(t, e) {
        ...
        function j(e, i, o) {
            ...
            return (
                ct(a, f.cssClasses.pips),
                ct(a, 0 === f.ort ? f.cssClasses.pipsHorizontal : f.cssClasses.pipsVertical),
        ...
        function H(t) {
            ...
            return (c = y.appendChild(j(s, o, l)))
        }
        function D() {
        ...
        function X(t, e) {
            ;(e.handle && (pt(e.handle, f.cssClasses.active), (S -= 1)),
                e.listeners.forEach(function (t) {
                    C.removeEventListener(t[0], t[1])
                }),
                0 === S &&
                    (pt(y, f.cssClasses.drag),
                    Q(),
                    t.cursor && ((N.style.cursor = ''), N.removeEventListener('selectstart', at))),
        ...
        function Y(t, e) {
            ...
            1 === e.handleNumbers.length &&
                ((r = u[e.handleNumbers[0]].children[0]), (S += 1), ct(r, f.cssClasses.active))
            t.stopPropagation()
            var n = [],
                i = R(d.move, C, B, {
                    target: t.target,
            ...
            ;(n.push.apply(n, i.concat(o, a)),
                t.cursor &&
                    ...
                    1 < u.length && ct(y, f.cssClasses.drag),
                    N.addEventListener('selectstart', at, !1)),
                e.handleNumbers.forEach(function (t) {
                    W('start', t)
                }))
        }
        function n(t) {
            ...
            var n,
                ...
                r =
                    ...
                    o)
            if (!1 === r) return !1
            ;(f.events.snap || st(y, f.cssClasses.tap, f.animationDuration),
                Z(r, e, !0, !0),
                Q(),
                W('slide', r, !0),
                W('update', r, !0),
                W('change', r, !0),
                W('set', r, !0),
                f.events.snap && Y(t, { handleNumbers: [r] }))
        }
        function _(t) {
            var e = T(t.calcPoint),
                r = E.getStep(e),
            ...
            ;((e = e.slice()),
                ...
                1 < e.length
                    ? e.forEach(function (t, e) {
                          var r = $(i, t, i[t] + n, o[e], a[e], !1)
                          !1 === r ? (n = 0) : ((n = r - i[t]), (i[t] = r))
                      })
                    : (o = a = [!0]))
            var s = !1
            ;(e.forEach(function (t, e) {
                s = Z(t, r[t] + n, o[e], a[e]) || s
            }),
                s &&
        ...
        function Z(t, e, r, n) {
            return (
                ...
                ((function (t, e) {
                    ...
                    var r = 'translate(' + G(K(e, 0) - M + '%', '0') + ')'
                    ;((u[t].style[f.transformRule] = r), tt(t), tt(t + 1))
                })(t, e),
                !0)
            )
        }
        ...
        function et(t, e) {
            var n = ut(t),
                r = void 0 === v[0]
            ;((e = void 0 === e || !!e),
                f.animate && !r && m && st(y, f.cssClasses.tap, f.animationDuration),
                b.forEach(function (t) {
                    var e, r
                    Z(
                        t,
        ...
        function rt(t, e, r) {
            ...
            if (!(0 <= (t = Number(t)) && t < b.length))
                throw new Error('noUiSlider (' + ot + '): invalid handle number, got: ' + t)
        ...
        return (
            ct((e = y), f.cssClasses.target),
            0 === f.dir ? ct(e, f.cssClasses.ltr) : ct(e, f.cssClasses.rtl),
            0 === f.ort ? ct(e, f.cssClasses.horizontal) : ct(e, f.cssClasses.vertical),
            ...
            (p = f.events).fixed ||
                u.forEach(function (t, e) {
                    R(d.start, t.children[0], Y, { handleNumbers: [e] })
                }),
            p.tap && R(d.start, l, n, {}),
            p.hover && R(d.move, l, _, { hover: !0 }),
            p.drag &&
                a.forEach(function (t, e) {
                    if (!1 !== t && 0 !== e && e !== a.length - 1) {
                        var r = u[e - 1],
                            n = u[e],
                            i = [t]
                        ;(ct(t, f.cssClasses.draggable),
                            p.fixed && (i.push(r.children[0]), i.push(n.children[0])),
                            i.forEach(function (t) {
                                R(d.start, t, Y, { handles: [r, n], handleNumbers: [e - 1, e] })
                            }))
                    }
                }),
            et(f.start),
            ...
            (s = {
                destroy: function () {
                    for (var t in f.cssClasses)
                        f.cssClasses.hasOwnProperty(t) && pt(y, f.cssClasses[t])
    ...
    return {
        ...
        create: function (t, e) {
            if (!t || !t.nodeName)
                throw new Error(
                    'noUiSlider (' + ot + '): create requires a single element, got: ' + t
                )
            if (t.noUiSlider)
                throw new Error('noUiSlider (' + ot + '): Slider was already initialized.')
            var r = z(t, dt(e), e)
