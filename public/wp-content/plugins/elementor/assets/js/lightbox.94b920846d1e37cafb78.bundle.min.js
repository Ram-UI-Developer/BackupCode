            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                showModal(e) {
                    ...
                    switch (
                        ...
                        case 'image': {
                            ...
                            ;((e.slideshow = { slides: n, swiper: { loop: !1, pagination: !1 } }),
                ...
                setVideoContent(e) {
                    ...
                    if ('hosted' === e.videoType) {
                        ...
                        n = t('<iframe>', { src: i.getAutoplayURL(e.url), allowfullscreen: 1 })
                    }
                ...
                getRatioDictionry: (e) =>
                    ({ 219: 2.33333, 169: 1.77777, 43: 1.33333, 32: 1.5, 11: 1, 916: 0.5625 })[e] ||
                    e,
                getRatioType(e) {
                    let t = ''
                ...
                getShareLinks() {
                    ...
                    if (
                        ...
                        ;(t.attr('aria-label', e.download),
                            r.append(
                                n('<a>', { href: c, download: '' }).text(e.downloadImage).prepend(t)
                            ))
                    }
                    return r
                },
                createShareLink(e, t) {
                    ...
                    return (
                        'pinterest' === e
                            ...
                            : (i.url = encodeURIComponent(location.href.replace(/#.*/, '') + n)),
                    ...
                    ;(e.zoom.in(),
                        ...
                        this.isFontIconSvgExperiment
                            ? (t.$iconZoom.addClass(n.hidden).attr('aria-checked', 'false'),
                              t.$iconZoomOut.removeClass(n.hidden).attr('aria-checked', 'true'))
                            : t.$iconZoom
                ...
                setSlideshowContent(e) {
                    ...
                    if (
                        ...
                        ;((m = n('<div>', { class: d.prevButton + ' ' + a.preventClose }).append(
                            e,
                            o
                        )),
                            (p = n('<div>', { class: d.nextButton + ' ' + a.preventClose }).append(
                                i,
                                r
                            )),
                            c.append(p, m),
                ...
                playSlideVideo() {
                    ...
                    const n = this.getSettings('classes'),
                        ...
                        s = jQuery('<div>', { class: n.videoContainer + ' ' + n.invisible }),
                        o = jQuery('<div>', {
            ...
            !(function () {
                ...
                i
                    ? (Object.defineProperties(o, {
                          ...
                          isEnabled: { enumerable: !0, get: () => Boolean(t[i.fullscreenEnabled]) }
                      }),
