...
;(() => {
    var t = {
            ...
            56027: (t, e, n) => {
                ...
                ;((t.exports = function toPrimitive(t, e) {
    ...
    function __webpack_require__(n) {
        ...
        var o = (e[n] = { exports: {} })
        return (t[n](o, o.exports, __webpack_require__), o.exports)
    }
    ;(() => {
        'use strict'
        var t,
            ...
            i,
            o,
            r = __webpack_require__(73203)(__webpack_require__(93231))
        ...
        null !== (t = elementorAdminHints) &&
            ...
            (wp.media.view.Attachment.Details = wp.media.view.Attachment.Details.extend({
                ...
                template: function template(t) {
                    var e = wp.media.template('attachment-details')(t),
                        n = document.createElement('div')
                    if (((n.innerHTML = e), !this.shouldDisplayHint(t))) return n.innerHTML
                    var i = document.createElement('div')
                    return (
                        i.classList.add('e-hint'),
                        (i.innerHTML = _.template(this._tmpl)(elementorAdminHints.mediaHint)),
                        n.querySelector('.attachment-info').appendChild(i),
                        n.innerHTML
                    )
                },
                ...
                shouldDisplayHint: function shouldDisplayHint(t) {
                    var e
                    return (
                        !(
                            !elementorAdminHints ||
                            null === (e = elementorAdminHints) ||
                            void 0 === e ||
                            !e.mediaHint
                        ) &&
                        void 0 === window.elementorHints &&
                        'image' === t.type &&
                        (!!elementorAdminHints.mediaHint.display || this.imageNotOptimized(t))
                    )
                },
                imageNotOptimized: function imageNotOptimized(t) {
                    var e = { height: 1080, width: 1920, filesizeInBytes: 1e5 }
                    return Object.keys(e).some(function (n) {
                        var i = t[n] || !1
                        return i && i > e[n]
                    })
                },
                onHintAction: function onHintAction(t) {
                    t.preventDefault()
                    var e = t.target.closest('.action-handler').dataset.settings,
                        n = atob(e),
                        i = JSON.parse(n).action_url,
                        o = void 0 === i ? null : i
                    ;(o && window.open(o, '_blank'), this.dismiss(t))
                },
                dismiss: function dismiss(t) {
                    ;(elementorCommon.ajax.addRequest('dismissed_editor_notices', {
                        data: { dismissId: t.target.closest('.e-hint__container').dataset.event }
                    }),
                        this.hideHint(t))
                },
                hideHint: function hideHint(t) {
                    ;(t.target.closest('.e-hint__container').remove(), (window.elementorHints = {}))
                }
            }))
    })()
})()
