...
/******/ ;(() => {
                    ...
                    ;(0, _createClass2.default)(LockPro, [
                        {
                            ...
                            value: function bindEvents() {
                                ...
                                templateType.addEventListener(
                                    'change',
                                    this.onTemplateTypeChange.bind(this)
                                )
  ...
  \*****************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _lockPro = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./behaviors/lock-pro */ '../assets/dev/js/admin/new-template/behaviors/lock-pro.js'
                    )
                )
                var NewTemplateView = __webpack_require__(
                    /*! elementor-admin/new-template/view */ '../assets/dev/js/admin/new-template/view.js'
                )
                module.exports = elementorModules.common.views.modal.Layout.extend({
                    ...
                    initialize: function initialize() {
                        ...
                        var dynamicControlsVisibilityListener =
                            function dynamicControlsVisibilityListener() {
                                elementorAdmin.templateControls.setDynamicControlsVisibility(
                                    lookupControlIdPrefix,
                                    elementor_new_template_form_controls
                                )
                            }
                        this.getModal().onShow = function () {
                            dynamicControlsVisibilityListener()
                            document
                                .getElementById(templateTypeSelectId)
                                .addEventListener('change', dynamicControlsVisibilityListener)
                        }
                        this.getModal().onHide = function () {
                            document
                                .getElementById(templateTypeSelectId)
                                .removeEventListener('change', dynamicControlsVisibilityListener)
                        }
                    },
                    initElements: function initElements() {
                        ...
                        this.elements = {
                            ...
                            templateType: container.querySelector(
                                ''.concat(root, '__template-type')
                            ),
                            lockBadge: container.querySelector(
                                ''.concat(root, '__template-type-badge')
                            ),
                            lockBadgeText: container.querySelector(
                                ''.concat(root, '__template-type-badge__text')
                            ),
                            lockBadgeIcon: container.querySelector(
                                ''.concat(root, '__template-type-badge__icon')
                            )
                        }
                    },
  ...
  \***********************************************************/
        ...
        var NewTemplateLayout = __webpack_require__(
            /*! elementor-admin/new-template/layout */ '../assets/dev/js/admin/new-template/layout.js'
        )
