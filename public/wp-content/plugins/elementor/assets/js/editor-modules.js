...
/******/ ;(() => {
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _argsObject = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../../modules/imports/args-object */ '../assets/dev/js/modules/imports/args-object.js'
                    )
                )
                var _panel = _interopRequireDefault(
                    __webpack_require__(/*! ./panel */ '../assets/dev/js/editor/container/panel.js')
                )
                var _childrenArray = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./model/children-array */ '../assets/dev/js/editor/container/model/children-array.js'
                    )
                )
                ...
                var Container = /*#__PURE__*/ (function (_ArgsObject) {
                    ...
                    function Container(args) {
                        ...
                        _this.panel = new _panel.default(
                            (0, _assertThisInitialized2.default)(_this)
                        )
                        _this.initialize()
                        return _this
                    ...
                    ;(0, _createClass2.default)(Container, [
                                ...
                                Object.keys(settings).forEach(function (settingKey) {
                                    Object.values(_this2.controls).forEach(function (control) {
                                        ...
                                        if (settingKey === control.name) {
                                            ...
                                            (_this2$controls$setti =
                                                _this2.controls[settingKey]) !== null &&
                                            _this2$controls$setti !== void 0 &&
                                            _this2$controls$setti.groupPrefix
                                        ) {
                                            var groupPrefix =
                                                _this2.controls[settingKey].groupPrefix
                            ...
                            value: function getAffectingControls() {
                                ...
                                Object.entries(activeControls).forEach(function (_ref3) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ((_this3$globals$get = _this3.globals.get(
                                                control.name
                                            )) !== null &&
                                                _this3$globals$get !== void 0 &&
                                                _this3$globals$get.length) ||
                                            _this3.getGlobalDefault(controlName).length
                                        ) {
                                    ...
                                    if (
                                        'object' === (0, _typeof2.default)(controlValue) &&
                                        Object.values(controlValue).join() ===
                                            Object.values(control.default).join()
                                    ) {
                                        return
                                    }
                                    result[controlName] = control
                        ...
                        },
                        {
                            ...
                            value: function handleChildrenRecursive() {
                                ...
                                if (
                                    (_this$view$children = this.view.children) !== null &&
                                    _this$view$children !== void 0 &&
                                    _this$view$children.length
                                ) {
                                    Object.values(this.view.children._views).forEach(
                                        function (view) {
                                            if (!view.container) {
                                                return
                                            }
                        ...
                        },
                        {
                            ...
                            value: function handleRepeaterChildren() {
                                ...
                                Object.values(this.controls).forEach(function (control) {
                                    ...
                                    _this5.settings
                                        .get(control.name)
                                        .forEach(function (rowModel, index) {
                                ...
                                if (['widget', 'document'].includes(this.type)) {
                                    var repeaters = Object.values(this.controls).filter(
                                        function (control) {
                                            return 'repeater' === control.type
                                        }
                                    )
                                    if (
                                        !this.model.get('supportRepeaterChildren') &&
                                        1 === repeaters.length
                                    ) {
                                        Object.defineProperty(this, 'children', {
                                            get: function get() {
                                                elementorDevTools.deprecation.deprecated(
                                                    'children',
                                                    '3.0.0',
                                                    'container.repeaters[ repeaterName ].children'
                                                )
                        ...
                        },
                        {
                            ...
                            value: function addRepeaterItem(repeaterName, rowSettingsModel, index) {
                                ...
                                this.repeaters[repeaterName].children.splice(
                                    index,
                                    0,
                                    new elementorModules.editor.Container({
                        ...
                        },
                        {
                            ...
                            value: function lookup() {
                                ...
                                if (
                                    this !== this.renderer &&
                                    (_this$renderer$view = this.renderer.view) !== null &&
                                    _this$renderer$view !== void 0 &&
                                    _this$renderer$view.isDisconnected &&
                                    this.renderer.view.isDisconnected()
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function isEditable() {
                                return (
                                    'edit' ===
                                        elementor.channels.dataEditMode.request('activeMode') &&
                        ...
                        },
                        {
                            ...
                            value: function getGlobalValue(name) {
                                var control = this.controls[name],
                                    ...
                                    data = $e.data.getCache(
                                        $e.components.get('globals'),
                                        globalArgs.command,
                                        globalArgs.args.query
                                    )
                                ...
                                if (control.groupType) {
                                    ...
                                    var responsivePrefixRegex =
                                        elementor.breakpoints.getActiveMatchRegex()
                                    var propertyName = control.name
                                        .replace(control.groupPrefix, '')
                                        .replace(responsivePrefixRegex, '')
                                    if (
                                        !data.value[
                                            elementor.config.kit_config.typography_prefix +
                                                propertyName
                                        ]
                                    ) {
                                        return
                                    ...
                                    value = 'var( --e-global-'
                                        .concat(control.groupType, '-')
                                        .concat(id, '-')
                                        .concat(propertyName, ' )')
                                    if (
                                        elementor.config.ui.defaultGenericFonts &&
                                        control.groupPrefix + 'font_family' === control.name
                                    ) {
                                        value += ', '.concat(
                                            elementor.config.ui.defaultGenericFonts
                                        )
                        ...
                        },
                        {
                            ...
                            value: function isGlobalApplied(controlName) {
                                return (
                                    this.getSetting(controlName) !== this.settings.get(controlName)
                                )
                            }
                        },
                        {
                            ...
                            value: function getGlobalDefault(controlName) {
                                ...
                                var controlGlobalArgs =
                                    (_this$controls$contro = this.controls[controlName]) === null ||
                                    _this$controls$contro === void 0
                                        ? void 0
                                        : _this$controls$contro.global
                                if (
                            ...
                            value: function someRecursive(callback) {
                                ...
                                try {
                                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                                        ...
                                        if (
                                            (_container$children = container.children) !== null &&
                                            _container$children !== void 0 &&
                                            _container$children.length
                                        ) {
                    ...
                    ;(0, _createClass2.default)(Panel, [
                        ...
                        },
                        {
                            ...
                            value: function getControlView(name) {
                                ...
                                return editor.children.findByModelCid(
                                    this.getControlModel(name).cid
                                )
                            }
                        },
                        {
                ...
                BaseSettingsModel = Backbone.Model.extend({
                    ...
                    initialize: function initialize(data, options) {
                        ...
                        _.each(self.controls, function (control) {
                            ...
                            var isUIControl =
                                control.features && -1 !== control.features.indexOf('ui')
                            if (isUIControl) {
                                return
                            }
                            ...
                            var isDynamicControl = control.dynamic && control.dynamic.active,
                                hasDynamicSettings =
                                    isDynamicControl &&
                                    attrs.__dynamic__ &&
                                    attrs.__dynamic__[controlName]
                            if (
                                isDynamicControl &&
                                !hasDynamicSettings &&
                                control.dynamic.default
                            ) {
                            ...
                            if (
                                undefined !== attrs[controlName] &&
                                isMultipleControl &&
                                !_.isObject(attrs[controlName]) &&
                                !hasDynamicSettings
                            ) {
                                elementorCommon.debug.addCustomError(
                                    new TypeError(
                                        'An invalid argument supplied as multiple control value'
                                    ),
                                    'InvalidElementData',
                                    'Element `' +
                                        (self.get('widgetType') || self.get('elType')) +
                                        '` got <' +
                                        attrs[controlName] +
                                        '> as `' +
                                        controlName +
                    ...
                    convertRepeaterValueToCollection: function convertRepeaterValueToCollection(
                        attrs,
                        repeaterControl
                    ) {
                        ...
                        _.each(this.controls, function (field) {
                            if (field.is_repeater) {
                                ...
                                if (!(attrs[field.name] instanceof Backbone.Collection)) {
                                    attrs[field.name] = self.convertRepeaterValueToCollection(
                                        attrs,
                                        field
                                    )
                                }
                    ...
                    getStyleControls: function getStyleControls(controls, attributes) {
                        ...
                        jQuery.each(controls, function () {
                            ...
                            if (control.fields) {
                                var styleFields = []
                                if (
                                    !(self.attributes[control.name] instanceof Backbone.Collection)
                                ) {
                                    self.attributes[control.name] =
                                        self.convertRepeaterValueToCollection(
                                            self.attributes,
                                            control
                                        )
                                }
                                self.attributes[control.name].each(function (item) {
                                    styleFields.push(
                                        self.getStyleControls(control.fields, item.attributes)
                                    )
                                })
                            ...
                            if (
                                control.fields ||
                                ((_control$dynamic = control.dynamic) !== null &&
                                    _control$dynamic !== void 0 &&
                                    _control$dynamic.active) ||
                                self.isGlobalControl(control, controls) ||
                                self.isStyleControl(control.name, controls)
                            ) {
                    ...
                    isGlobalControl: function isGlobalControl(control, controls) {
                        ...
                        if (
                            !(
                                (_globalControl$global = globalControl.global) !== null &&
                                _globalControl$global !== void 0 &&
                                _globalControl$global.active
                            )
                        ) {
                            return false
                        }
                        var globalValue =
                            (_this$attributes$__gl = this.attributes.__globals__) === null ||
                            _this$attributes$__gl === void 0
                                ? void 0
                                : _this$attributes$__gl[controlGlobalKey]
                        return !!globalValue
                    },
                    ...
                    clone: function clone() {
                        return new BaseSettingsModel(
                            elementorCommon.helpers.cloneObject(this.attributes),
                            elementorCommon.helpers.cloneObject(this.options)
                        )
                    },
                    ...
                    parseDynamicSettings: function parseDynamicSettings(
                        settings,
                        options,
                        controls
                    ) {
                        ...
                        jQuery.each(controls, function () {
                            ...
                            if (control.is_repeater) {
                                ...
                                valueToParse.forEach(function (value, key) {
                                    valueToParse[key] = self.parseDynamicSettings(
                                        value,
                                        options,
                                        control.fields
                                    )
                            ...
                            valueToParse =
                                settings.__dynamic__ && settings.__dynamic__[control.name]
                            if (!valueToParse) {
                                return
                            }
                            ...
                            var dynamicValue
                            try {
                                dynamicValue = elementor.dynamicTags.parseTagsText(
                                    valueToParse,
                                    dynamicSettings,
                                    elementor.dynamicTags.getTagDataContent
                                )
                            } catch (error) {
                                if (
                                    elementor.dynamicTags.CACHE_KEY_NOT_FOUND_ERROR !==
                                    error.message
                                ) {
                                    throw error
                                }
                    ...
                    parseGlobalSettings: function parseGlobalSettings(settings, controls) {
                        ...
                        jQuery.each(controls, function (index, control) {
                            ...
                            if (control.is_repeater) {
                                valueToParse = settings[control.name]
                                valueToParse.forEach(function (value, key) {
                                    valueToParse[key] = _this.parseGlobalSettings(
                                        value,
                                        control.fields
                                    )
                                })
                            ...
                            valueToParse =
                                (_settings$__globals__ = settings.__globals__) === null ||
                                _settings$__globals__ === void 0
                                    ? void 0
                                    : _settings$__globals__[control.name]
                            if (!valueToParse) {
                                return
                            }
                            ...
                            if (
                                !(
                                    (_globalSettings = globalSettings) !== null &&
                                    _globalSettings !== void 0 &&
                                    _globalSettings.active
                                )
                            ) {
                                return
                            }
                    ...
                    removeDataDefaults: function removeDataDefaults(data, controls) {
                        ...
                        jQuery.each(data, function (key) {
                            ...
                            if (
                                control.save_default ||
                                (('text' === control.type || 'textarea' === control.type) &&
                                    data[key])
                            ) {
                                return
                            }
                        ...
                        _.each(tabsWrappers, function (view) {
                            ...
                            var tabsId = view.model.get('name'),
                                tabs = parent.children.filter(function (childView) {
                                    return (
                                        'tab' === childView.model.get('type') &&
                                        childView.model.get('tabs_wrapper') === tabsId
                                    )
                                })
                            _.each(tabs, function (childView, index) {
                                view._addChildView(childView)
                                var tabId = childView.model.get('name'),
                                    controlsUnderTab = parent.children.filter(
                    ...
                    onChildviewControlTabClicked: function onChildviewControlTabClicked(childView) {
                        var closedClass = 'e-tab-close',
                            ...
                            childrenUnderTab = this.view.children.filter(function (view) {
                                return (
                                    'tab' !== view.model.get('type') &&
                                    childView.model.get('tabs_wrapper') ===
                                        view.model.get('tabs_wrapper')
                                )
                            }),
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var ControlsPopover = /*#__PURE__*/ (function () {
                    function ControlsPopover(child) {
                        ...
                        this.popoverToggleView = child._parent.children.findByIndex(
                            child._index - 1
                        )
                        ...
                        },
                        {
                            ...
                            value: function createPopoverHeader() {
                                ...
                                var $popoverToggleControl = this.$popover.prev(),
                                    ...
                                    $resetLabel = $popoverToggleControl.find(
                        ...
                        },
                        {
                            ...
                            value: function onResetButtonClick() {
                                ...
                                var groupControlName =
                                        this.child.model.get('groupPrefix') + 'typography',
                                    args = {
  ...
  \*******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _controlsPopover = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./controls-popover */ '../assets/dev/js/editor/views/controls-popover.js'
                    )
                )
                var ControlsStack
                ControlsStack = Marionette.CompositeView.extend(
                    {
                        ...
                        behaviors: {
                            HandleInnerTabs: {
                                behaviorClass: __webpack_require__(
                                    /*! elementor-behaviors/inner-tabs */ '../assets/dev/js/editor/elements/views/behaviors/inner-tabs.js'
                                )
                            }
                        },
                        ...
                        initCollection: function initCollection() {
                            this.collection = new Backbone.Collection(
                                _.values(
                                    elementor.mergeControlsSettings(this.getOption('controls'))
                                )
                            )
                        },
                        ...
                        isVisibleSectionControl: function isVisibleSectionControl(
                            sectionControlModel
                        ) {
                        ...
                        activateFirstSection: function activateFirstSection() {
                            ...
                            var sectionControls = self.collection.filter(function (controlModel) {
                                return (
                                    'section' === controlModel.get('type') &&
                                    self.isVisibleSectionControl(controlModel)
                                )
                            })
                            ...
                            var preActivatedSection = sectionControls.filter(
                        ...
                        onDeviceModeChange: function onDeviceModeChange() {
                            if (
                                'desktop' === elementor.channels.deviceMode.request('currentMode')
                            ) {
                                this.$el.removeClass('elementor-responsive-switchers-open')
                            }
                        },
                        onChildviewControlSectionClicked: function onChildviewControlSectionClicked(
                            childView
                        ) {
                        ...
                        onChildviewResponsiveSwitcherClick:
                            function onChildviewResponsiveSwitcherClick(childView, device) {
                                if ('desktop' === device) {
                    ...
                    },
                    {
                        ...
                        removePopovers: function removePopovers(view) {
                            var _view$popovers
                            ;(_view$popovers = view.popovers) === null || _view$popovers === void 0
                                ? void 0
                                : _view$popovers.forEach(function (popover) {
                ...
                var _default = /*#__PURE__*/ (function (_elementorModules$Mod) {
                    ...
                    ;(0, _createClass2.default)(_default, [
                        ...
                        },
                        {
                            key: 'setViewed',
                            value: (function () {
                                var _setViewed = (0, _asyncToGenerator2.default)(
  ...
  \******************************************/
        ...
        var _module = _interopRequireDefault(
            __webpack_require__(/*! ./utils/module */ '../assets/dev/js/editor/utils/module.js')
        )
        var _introduction = _interopRequireDefault(
            __webpack_require__(
                /*! ../utils/introduction */ '../assets/dev/js/utils/introduction.js'
            )
        )
        var _controlsStack = _interopRequireDefault(
            __webpack_require__(
                /*! ./views/controls-stack */ '../assets/dev/js/editor/views/controls-stack.js'
            )
        )
        var _baseSettings = _interopRequireDefault(
            __webpack_require__(
                /*! ./elements/models/base-settings */ '../assets/dev/js/editor/elements/models/base-settings.js'
            )
        )
        var _container = _interopRequireDefault(
            __webpack_require__(
                /*! ./container/container */ '../assets/dev/js/editor/container/container.js'
            )
        )
