        ...
        ;(function ($) {
            ...
            var ElementorGutenbergApp = {
                cacheElements: function cacheElements() {
                    ...
                    self.cache.$switchModeButton = self.cache.$switchMode.find(
                ...
                buildPanel: function buildPanel() {
                    ...
                    if (!self.cache.$gutenberg.find('#elementor-switch-mode').length) {
                        self.cache.$gutenberg
                            .find('.edit-post-header-toolbar')
                            .append(self.cache.$switchMode)
                    }
                    if (this.hasIframe()) {
                        this.handleIframe()
                    }
                    if (!$('#elementor-editor').length) {
                        ...
                        var editorButtonParent = self.cache.$gutenberg.find(
                        ...
                        self.cache.$editorPanelButton = self.cache.$editorPanel.find(
                ...
                buildPanelTopBar: function buildPanelTopBar() {
                    ...
                    if (!$('#elementor-edit-mode-button').length && this.isElementorMode) {
                        ...
                        self.cache.$gutenberg
                            .find('.edit-post-header-toolbar')
                            .append(self.cache.$editorBtnTop)
                ...
                handleEditButtonClick: function handleEditButtonClick() {
                    ...
                    var isNewPost =
                        'auto-draft' === wp.data.select('core/editor').getCurrentPost().status
                    if (isNewPost) {
                        var documentTitle = wp.data
                            .select('core/editor')
