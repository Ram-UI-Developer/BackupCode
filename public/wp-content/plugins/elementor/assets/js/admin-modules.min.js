...
;(() => {
                                ...
                                value: function highlightTopLevelMenuItem(e) {
                                    var t =
                                            arguments.length > 1 && void 0 !== arguments[1]
                                                ? arguments[1]
                                                : null,
                                        r = 'wp-has-current-submenu wp-menu-open current'
                                    ;(e.parent().addClass(r).removeClass('wp-not-current-submenu'),
                                        t && t.removeClass(r))
                                }
                            },
                            {
                                ...
                                value: function onInit() {
                                    ;(0, a.default)(
                                        (0, c.default)(MenuHandler.prototype),
                                        'onInit',
                                        this
                                    ).call(this)
                                    var e = this.getSettings()
                ...
                var d = (function (e) {
                    ...
                    function _default() {
                        ...
                        return (
                            ...
                            (0, p.default)((0, s.default)(e), 'introductionMap', null),
                            e.initDialog(),
                            e
                        )
                    }
                        ...
                        (0, u.default)(_default, [
                            {
                                ...
                                value: function setIntroductionMap(e) {
                                    this.introductionMap = e
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function initDialog() {
                                    ...
                                    this.getDialog = function () {
                                        if (!e) {
                                            var r = t.getSettings()
                                            ;((e = elementorCommon.dialogsManager.createWidget(
                                                r.dialogType,
                                                r.dialogOptions
                                            )),
                                                r.onDialogInitCallback &&
                                                    r.onDialogInitCallback.call(t, e))
                                        }
                                        return e
                                    }
                                }
                            },
                            {
                                ...
                                value: function show(e) {
                                    if (!this.introductionViewed) {
                                        ...
                                        ;(e && t.setSettings('position', { of: e }), t.show())
                                    }
                                }
                            },
                            {
                                ...
                                get: function get() {
                                    var e = this.getSettings('introductionKey')
                                    return this.getIntroductionMap()[e]
                                },
                                set: function set(e) {
                                    var t = this.getSettings('introductionKey')
                                    this.getIntroductionMap()[t] = e
                                }
                            },
                            {
                                key: 'setViewed',
                ...
                ;((e.exports = function _asyncToGenerator(e) {
                    return function () {
                        ...
                        return new Promise(function (n, o) {
                            var i = e.apply(t, r)
                            function _next(e) {
                                asyncGeneratorStep(i, n, o, _next, _throw, 'next', e)
                            }
                            function _throw(e) {
                                asyncGeneratorStep(i, n, o, _next, _throw, 'throw', e)
                            }
                            _next(void 0)
                        })
                    }
                ...
                function _regeneratorRuntime() {
                    ...
                    function wrap(e, t, r, n) {
                        var o = t && t.prototype instanceof Generator ? t : Generator,
                            ...
                            u = new Context(n || [])
                        return (a(i, '_invoke', { value: makeInvokeMethod(e, r, u) }), i)
                    }
                    ...
                    function makeInvokeMethod(e, r, n) {
                        ...
                        return function (i, a) {
                            ...
                            for (n.method = i, n.arg = a; ; ) {
                                ...
                                if ('normal' === c.type) {
                                    if (((o = n.done ? h : p), c.arg === y)) continue
                    ...
                    return (
                        ...
                        (r.async = function (e, t, n, o, i) {
                            void 0 === i && (i = Promise)
                            var a = new AsyncIterator(wrap(e, t, n, o), i)
    ...
    ;(() => {
        ...
        var e = __webpack_require__(73203),
            t = e(__webpack_require__(75389)),
            r = e(__webpack_require__(60834))
        elementorModules.admin = { MenuHandler: t.default, utils: { Introduction: r.default } }
    })()
})()
