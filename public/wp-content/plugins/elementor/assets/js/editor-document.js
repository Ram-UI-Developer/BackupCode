...
/******/ ;(() => {
  ...
  \********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _commandContainerBase = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./command-container-base */ '../assets/dev/js/editor/command-bases/command-container-base.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
  ...
  \******************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _commandContainerBase = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-editor/command-bases/command-container-base */ '../assets/dev/js/editor/command-bases/command-container-base.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function onBeforeRun(args) {
                                    ;(0, _get2.default)(
                                        (0, _getPrototypeOf2.default)(CommandHistoryBase.prototype),
                                        'onBeforeRun',
                                        this
                                    ).call(this, args)
                                    if (this.history && this.isHistoryActive()) {
                                        this.historyId = $e.internal(
  ...
  \***************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports.getDefaultDebounceDelay =
                    exports['default'] =
                    exports.DEFAULT_DEBOUNCE_DELAY =
                        void 0
                var _classCallCheck2 = _interopRequireDefault(
                    __webpack_require__(
                        /*! @babel/runtime/helpers/classCallCheck */ '../node_modules/@babel/runtime/helpers/classCallCheck.js'
                ...
                var _commandHistoryBase = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./command-history-base */ '../assets/dev/js/editor/document/command-bases/command-history-base.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                ...
                var getDefaultDebounceDelay = function getDefaultDebounceDelay() {
                    ...
                    if (
                        ...
                        undefined !== elementor.config.document.debounceDelay
                    ) {
                    ...
                    ;(0, _createClass2.default)(
                        ...
                        [
                                ...
                                value: function initialize(args) {
                                    ...
                                    ;(0, _get2.default)(
                                        (0, _getPrototypeOf2.default)(
                                            CommandHistoryDebounceBase.prototype
                                        ),
                                        'initialize',
                                        this
                                    ).call(this, args)
                            ...
                            },
                            {
                                key: 'onAfterRun',
                                value: function onAfterRun(args, result) {
                                    $e.modules.CommandBase.prototype.onAfterRun.call(
                                        this,
                                        args,
                                        result
                                    )
                                    if (this.isHistoryActive()) {
                                        if (this.isDebounceRequired) {
                                            this.constructor.debounce(function () {
                                                return $e.internal(
                                                    'document/history/end-transaction'
                                                )
                                            })
                                        } else {
                                ...
                                value: function onCatchApply(e) {
                                    ...
                                    if (e instanceof $e.modules.HookBreak && this.history) {
                                        if (this.isDebounceRequired) {
                                            ...
                                            this.constructor.debounce(function () {
                                                return $e.internal(
                                                    'document/history/clear-transaction'
                                                )
                                            })
                                        } else {
  ...
  \**************************************************/
        ...
        var _commandContainerBase = _interopRequireDefault(
            __webpack_require__(
                /*! ./command-bases/command-container-base */ '../assets/dev/js/editor/command-bases/command-container-base.js'
            )
        )
        var _commandContainerInternalBase = _interopRequireDefault(
            __webpack_require__(
                /*! ./command-bases/command-container-internal-base */ '../assets/dev/js/editor/command-bases/command-container-internal-base.js'
            )
        )
        var _commandHistoryBase = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-document/command-bases/command-history-base */ '../assets/dev/js/editor/document/command-bases/command-history-base.js'
            )
        )
        var _commandHistoryDebounceBase = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-document/command-bases/command-history-debounce-base */ '../assets/dev/js/editor/document/command-bases/command-history-debounce-base.js'
            )
        )
        $e.modules.editor = {
