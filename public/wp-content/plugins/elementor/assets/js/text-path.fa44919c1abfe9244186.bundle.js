...
;(self['webpackChunkelementor'] = self['webpackChunkelementor'] || []).push([
  ...
  \******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class TextPathHandler extends elementorModules.frontend.handlers.Base {
                        ...
                        return fetch(url)
                            ...
                            .then((svg) => {
                                this.elements.pathContainer.innerHTML =
                                    _dompurify.default.sanitize(svg)
                    ...
                    onElementChange(setting) {
                        const { start_point: startPoint, text } = this.getElementSettings()
                        switch (setting) {
                            case 'start_point':
		...
		`
                     ...
                     */
                    setText(newText) {
                        const { is_external: isExternal, nofollow } = this.getElementSettings().link
                        ...
                        const existingClone = this.elements.svg.querySelector(
                    ...
                    isFixedChromiumVersion() {
                        ...
                        const currentChromiumVersion = parseInt(
