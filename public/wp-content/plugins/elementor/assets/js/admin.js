...
/******/ ;(() => {
            ...
            /***/ (module) => {
                ...
                module.exports = elementorModules.ViewModule.extend({
                    getDefaultSettings: function getDefaultSettings() {
                        return {
                            selectors: {
                                ...
                                maintenanceModeDescriptions:
                                    '.elementor-maintenance-mode-description',
                                excludeModeSelect:
                                    '.elementor_maintenance_mode_exclude_mode select',
                    ...
                    getDefaultElements: function getDefaultElements() {
                        ...
                        elements.$maintenanceModeTable = elements.$modeSelect.parents(
                            selectors.maintenanceModeTable
                        )
                        elements.$excludeModeSelect = elements.$maintenanceModeTable.find(
                            selectors.excludeModeSelect
                        )
                        elements.$excludeRolesArea = elements.$maintenanceModeTable.find(
                            selectors.excludeRolesArea
                        )
                        elements.$templateSelect = elements.$maintenanceModeTable.find(
                            selectors.templateSelect
                        )
                        elements.$editTemplateButton = elements.$maintenanceModeTable.find(
                            selectors.editTemplateButton
                        )
                        elements.$maintenanceModeDescriptions = elements.$maintenanceModeTable.find(
                            selectors.maintenanceModeDescriptions
                        )
                        elements.$maintenanceModeError = elements.$maintenanceModeTable.find(
                            selectors.maintenanceModeError
                        )
                        return elements
                    },
                    handleModeSelectChange: function handleModeSelectChange() {
                        ...
                        elements.$maintenanceModeTable.toggleClass(
                            settings.classes.isEnabled,
                            !!elements.$modeSelect.val()
                        )
                        elements.$maintenanceModeDescriptions.hide()
                        elements.$maintenanceModeDescriptions
                            .filter('[data-value="' + elements.$modeSelect.val() + '"]')
                            .show()
                    },
                    handleExcludeModeSelectChange: function handleExcludeModeSelectChange() {
                        var elements = this.elements
                        elements.$excludeRolesArea.toggle(
                            'custom' === elements.$excludeModeSelect.val()
                        )
                    },
                    handleTemplateSelectChange: function handleTemplateSelectChange() {
                        ...
                        var editUrl =
                            elementorAdmin.config.home_url + '?p=' + templateID + '&elementor'
                    ...
                    bindEvents: function bindEvents() {
                        ...
                        elements.$excludeModeSelect.on(
                            'change',
                            this.handleExcludeModeSelectChange.bind(this)
                        )
                        elements.$templateSelect.on(
                            'change',
                            this.handleTemplateSelectChange.bind(this)
                        )
                    },
                    ...
                    ;(0, _createClass2.default)(MenuHandler, [
                        ...
                        },
                        {
                            ...
                            value: function getDefaultElements() {
                                var settings = this.getSettings()
                                return {
                                    $currentSubmenuItems: jQuery(
                                        settings.selectors.currentSubmenuItems
                                    ),
                                    $adminPageMenuLink: jQuery(
                                        'a[href="'.concat(settings.path, '"]')
                                    )
                                }
                            }
                        ...
                        },
                        {
                            ...
                            value: function onInit() {
                                ;(0, _get2.default)(
                                    (0, _getPrototypeOf2.default)(MenuHandler.prototype),
                                    'onInit',
                                    this
                                ).call(this)
                                var settings = this.getSettings()
                    ...
                    ;(0, _createClass2.default)(TemplateControls, [
                        {
                            ...
                            value: function setDynamicControlsVisibility(
                                lookupControlIdPrefix,
                                controls
                            ) {
                                ...
                                for (
                                    var _i = 0, _controlsArray = controlsArray;
                                    _i < _controlsArray.length;
                                    _i++
                                ) {
                                    var _controlsArray$_i = (0, _slicedToArray2.default)(
                                            _controlsArray[_i],
                                            2
                                        ),
                                        controlId = _controlsArray$_i[0],
                                        controlSettings = _controlsArray$_i[1]
                                    this.setVisibilityForControl(
                                        lookupControlIdPrefix,
                                        controlSettings,
                                        controlId
                                    )
                        ...
                        },
                        {
                            ...
                            value: function setVisibilityForControl(
                                lookupControlIdPrefix,
                                controlSettings,
                                controlId
                            ) {
                                var _controlSettings$cond,
                                    _this = this
                                var conditions = Object.entries(
                                    (_controlSettings$cond = controlSettings.conditions) !== null &&
                                        _controlSettings$cond !== void 0
                                        ? _controlSettings$cond
                                        : {}
                                )
                                conditions.forEach(function (condition) {
                                    _this.changeVisibilityBasedOnCondition(
                                        lookupControlIdPrefix,
                                        condition,
                                        controlId
                                    )
                        ...
                        },
                        {
                            ...
                            value: function changeVisibilityBasedOnCondition(
                                ...
                                var targetControlWrapper = document.getElementById(
                                    lookupControlIdPrefix + controlId + '__wrapper'
                                )
                                var lookupControl = document.getElementById(
                                    lookupControlIdPrefix + conditionKey
                                )
                                targetControlWrapper.classList.toggle(
                                    'elementor-hidden',
                                    !lookupControl || conditionValue !== lookupControl.value
                                )
                            }
                        }
                    ])
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function showJsonUploadWarningMessageIfNeeded(_ref) {
                    var introductionMap = _ref.introductionMap,
                        ...
                        waitForSetViewed =
                            _ref$waitForSetViewed === void 0 ? false : _ref$waitForSetViewed
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        dialog.onConfirm = /*#__PURE__*/ (0, _asyncToGenerator2.default)(
                                    ...
                                    while (1)
                                        switch ((_context.prev = _context.next)) {
                                            case 0:
                                                if (
                                                    !dialog
                                                        .getElements('checkbox-dont-show-again')
                                                        .prop('checked')
                                                ) {
                                                    _context.next = 7
                                                    break
                ...
                function createGenericWarningModal(IntroductionClass) {
                    ...
                    var introduction = new IntroductionClass({
                        ...
                        dialogOptions: {
                            ...
                            message: __(
                                'Uploading JSON files from unknown sources can be harmful and put your site at risk. For maximum safety, only install JSON files from trusted sources.',
                                'elementor'
                            ),
                            effects: {
                                show: 'fadeIn',
                    ...
                    ;(_introduction$getDial = introduction.getDialog().getElements('message')) ===
                        null || _introduction$getDial === void 0
                        ? void 0
                        : (_introduction$getDial2 = _introduction$getDial.append) === null ||
                            _introduction$getDial2 === void 0
                          ? void 0
                          : _introduction$getDial2.call(_introduction$getDial, label) // `getElements` return JQuery object.
                    ...
                    ;(0, _createClass2.default)(ExperimentsMessages, [
                        ...
                        },
                        {
                            ...
                            value: function getExperimentDependencies(experimentId) {
                                var _this2 = this
                                return this.getExperimentData(experimentId).dependencies.map(
                            ...
                            value: function getExperimentSelect(experimentId) {
                                return this.elements.selects.find(function (select) {
                                    return select.matches(
                                        '[data-experiment-id="'.concat(experimentId, '"]')
                                    )
                                })
                            }
                        },
                        ...
                        },
                        {
                            ...
                            value: function getExperimentActualState(experimentId) {
                                ...
                                var state =
                                    (_this$getExperimentSe =
                                        this.getExperimentSelect(experimentId)) === null ||
                                    _this$getExperimentSe === void 0
                                        ? void 0
                                        : _this$getExperimentSe.value
                                if (!state) {
                        ...
                        },
                        {
                            ...
                            value: function deactivateDependantExperiments(experimentId) {
                                var _this4 = this
                                Object.entries(elementorAdminConfig.experiments).forEach(
                                    function (_ref2) {
                                        var _ref3 = (0, _slicedToArray2.default)(_ref2, 2),
                                            id = _ref3[0],
                                            experimentData = _ref3[1]
                                        var isDependant =
                                                experimentData.dependencies.includes(experimentId),
                                            isActive =
                                                _this4.getExperimentActualState(id) === STATE_ACTIVE
                            ...
                            value: function shouldShowDeactivationDialog(experimentId) {
                                var getExperimentData = this.getExperimentData(experimentId),
                                    isInitialStateActive =
                                        getExperimentData.state === STATE_ACTIVE ||
                                        (getExperimentData.state === STATE_DEFAULT &&
                                            getExperimentData.default === STATE_ACTIVE),
                        ...
                        },
                        {
                            ...
                            value: function getSiteLanguageCode() {
                                var languageCode = document
                                    .querySelector('html')
                                    .getAttribute('lang')
                                return languageCode !== null && languageCode !== void 0
                                    ? languageCode
                                    : 'en' // Fallback to English if no language code found.
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function showDependenciesDialog(experimentId) {
                                ...
                                var experiment = this.getExperimentData(experimentId),
                                    ...
                                    dependenciesList = this.formatDependenciesList(
                                        this.getExperimentDependencies(experimentId)
                                    )

                                // Translators: %1$s: Experiment title, %2$s: Comma-separated dependencies list
                                var message = __(
                                    'In order to use %1$s, first you need to activate %2$s.',
                                    'elementor'
                                )
                                    .replace('%1$s', '<strong>'.concat(experimentName, '</strong>'))
                                    .replace('%2$s', dependenciesList)
                                this.showDialog({
                                    message: message,
                                    headerMessage: __(
                                        'First, activate another experiment.',
                                        'elementor'
                                    ),
                                    strings: {
                        ...
                        },
                        {
                            ...
                            value: function getMessage(experimentId, messageId) {
                                ...
                                return (_this$getExperimentDa =
                                    this.getExperimentData(experimentId)) === null ||
                                    _this$getExperimentDa === void 0
                                    ? void 0
                                    : _this$getExperimentDa.messages[messageId]
                            }
                        }
                    ])
  ...
  \*****************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _experimentsMessages = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./behaviors/experiments-messages */ '../core/experiments/assets/js/admin/behaviors/experiments-messages.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                    ...
                    ;(0, _createClass2.default)(ExperimentsModule, [
                        ...
                        },
                        {
                            ...
                            value: function addIndicatorsTooltips() {
                                var _this2 = this
                                this.elements.$experimentIndicators.each(
                                    function (index, experimentIndicator) {
                        ...
                        },
                        {
                            ...
                            value: function onInit() {
                                var _this3 = this
                                ;(0, _get2.default)(
                                    (0, _getPrototypeOf2.default)(ExperimentsModule.prototype),
                                    'onInit',
                                    this
                                ).call(this)
                                ...
                                if (this.elements.$experimentIndicators.length) {
                                    import(
                                        /* webpackIgnore: true */ ''.concat(
                                            elementorCommon.config.urls.assets,
                                            'lib/tipsy/tipsy.min.js?ver=1.0.0'
                                        )
                                    ).then(function () {
  ...
  \*****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _menuHandler = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-admin/menu-handler */ '../assets/dev/js/admin/menu-handler.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                ...
                var LandingPagesHandler = /*#__PURE__*/ (function (_AdminMenuHandler) {
                    ...
                    ;(0, _createClass2.default)(LandingPagesHandler, [
                            ...
                            value: function getDefaultSettings() {
                                var pageName = 'e-landing-page',
                                    adminMenuSelectors = {
                                        ...
                                        landingPagesTablePage:
                                            'a[href="edit.php?post_type=' + pageName + '"]',
                                        landingPagesAddNewPage:
                                ...
                                return {
                                    selectors: {
                                        ...
                                        landingPagesMenuItem: ''
                                            .concat(adminMenuSelectors.landingPagesTablePage, ', ')
                                            .concat(adminMenuSelectors.landingPagesAddNewPage),
                        ...
                        },
                        {
                            ...
                            value: function getDefaultElements() {
                                var selectors = this.getSettings('selectors'),
                                    elements = (0, _get2.default)(
                                        (0, _getPrototypeOf2.default)(
                                            LandingPagesHandler.prototype
                                        ),
                                        'getDefaultElements',
                                        this
                                    ).call(this)
                                elements.$landingPagesMenuItem = jQuery(
                                    selectors.landingPagesMenuItem
                                )
                                elements.$templatesMenuItem = jQuery(selectors.templatesMenuItem)
                                elements.$pagesMenuItemAndLink = jQuery(
                                    selectors.pagesMenuItemAndLink
                                )
                                return elements
                            }
                        },
                        {
                            ...
                            value: function onInit() {
                                ;(0, _get2.default)(
                                    (0, _getPrototypeOf2.default)(LandingPagesHandler.prototype),
                                    'onInit',
                                    this
                                ).call(this)
                                var settings = this.getSettings(),
                                    isLandingPagesTablePage = !!window.location.href.includes(
                                        settings.paths.landingPagesTablePage
                                    ),
                                    isLandingPagesTrashPage = !!window.location.href.includes(
                                        settings.paths.landingPagesTrashPage
                                    ),
                                    isLandingPagesCreateYourFirstPage =
                                        !!window.location.href.includes(
                                            settings.paths.landingPagesAddNewPage
                                        )
                                ...
                                if (
                                    isLandingPagesTablePage ||
                                    isLandingPagesTrashPage ||
                                    isLandingPagesCreateYourFirstPage ||
                                    settings.isLandingPageAdminEdit
                                ) {
                                    // Make sure the active admin top level menu item is 'Templates', and not 'Pages'.
                                    this.highlightTopLevelMenuItem(
                                        this.elements.$templatesMenuItem,
                                        this.elements.$pagesMenuItemAndLink
                                    )
                                    ...
                                    jQuery(settings.selectors.addButton).attr(
                                        'href',
                                        elementorAdminConfig.urls.addNewLandingPageUrl
                                    )
                                }
                            }
                        }
  ...
  \**********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _landingPages = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./landing-pages */ '../modules/landing-pages/assets/js/admin/landing-pages.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                            ...
                            value: function runHandler() {
                                ...
                                var pageName = 'e-landing-page',
                                    paths = {
                                        ...
                                        landingPagesAddNewPage:
                                            'edit.php?post_type=elementor_library&page=' + pageName,
                                        landingPagesTrashPage:
                                            'edit.php?post_status=trash&post_type=' + pageName
                                    },
                                    args = {
                                        path:
                                            (_elementorAdmin$confi =
                                                elementorAdmin.config.landingPages) !== null &&
                                            _elementorAdmin$confi !== void 0 &&
                                            _elementorAdmin$confi.landingPagesHasPages
                                                ? paths.landingPagesTablePage
                                                : paths.landingPagesAddNewPage,
                                        isLandingPageAdminEdit:
                                            (_elementorAdmin$confi2 =
                                                elementorAdmin.config.landingPages) === null ||
                                            _elementorAdmin$confi2 === void 0
                                                ? void 0
                                                : _elementorAdmin$confi2.isLandingPageAdminEdit,
                                        paths: paths
                                    }
  ...
  \***************************************/
        ...
        var _module = _interopRequireDefault(
            __webpack_require__(
                /*! elementor/modules/landing-pages/assets/js/admin/module */ '../modules/landing-pages/assets/js/admin/module.js'
            )
        )
        var _module2 = _interopRequireDefault(
            __webpack_require__(
                /*! elementor/core/experiments/assets/js/admin/module */ '../core/experiments/assets/js/admin/module.js'
            )
        )
        var _environment = _interopRequireDefault(
            __webpack_require__(
                /*! ../../../../core/common/assets/js/utils/environment */ '../core/common/assets/js/utils/environment.js'
            )
        )
        var _events = _interopRequireDefault(
            __webpack_require__(/*! elementor-utils/events */ '../assets/dev/js/utils/events.js')
        )
        var _filesUploadHandler = _interopRequireDefault(
            __webpack_require__(
                /*! ../editor/utils/files-upload-handler */ '../assets/dev/js/editor/utils/files-upload-handler.js'
            )
        )
        var _templateControls = _interopRequireDefault(
            __webpack_require__(
                /*! ./new-template/template-controls.js */ '../assets/dev/js/admin/new-template/template-controls.js'
            )
        )
        var _jsonUploadWarningMessage = __webpack_require__(
            /*! elementor-utils/json-upload-warning-message */ '../assets/dev/js/utils/json-upload-warning-message.js'
        )
        ;(function ($) {
            var ElementorAdmin = elementorModules.ViewModule.extend({
                ...
                getDefaultElements: function getDefaultElements() {
                    var elements = {
                        ...
                        $importFormFileInput: $(
                            '#elementor-import-template-form input[type="file"]'
                        ),
                    ...
                    elements.$settingsFormPages = elements.$settingsForm.find(
                        '.elementor-settings-form-page'
                    )
                    elements.$activeSettingsPage =
                        elements.$settingsFormPages.filter('.elementor-active')
                ...
                bindEvents: function bindEvents() {
                    ...
                    $('.e-notice--dismissible').on(
                        'click',
                        '.e-notice__dismiss, .e-notice-dismiss',
                        function (event) {
                            event.preventDefault()
                    ...
                    $('#elementor-recreate-kit-button').on('click', function (event) {
                        ...
                        $thisButton
                            ...
                            .addClass('loading')
                            .next('.e-recreate-kit-error-message')
                            .remove()
                        $.post(ajaxurl, {
                            ...
                            .fail(function (_ref) {
                                ...
                                if (
                                    (_responseJSON$data = responseJSON.data) !== null &&
                                    _responseJSON$data !== void 0 &&
                                    _responseJSON$data.message
                                ) {
                                    $thisButton.after(
                                        '<div class="e-recreate-kit-error-message">'.concat(
                    ...
                    $('#elementor_upgrade_fa_button').on('click', function (event) {
                        ...
                        elementorCommon.dialogsManager
                            .createWidget('confirm', {
                                ...
                                message:
                                    __(
                                        'I understand that by upgrading to Font Awesome 5,',
                                        'elementor'
                                    ) +
                                    '<br>' +
                                    __(
                                        'I acknowledge that some changes may affect my website and that this action cannot be undone.',
                                        'elementor'
                                    ),
                    ...
                    $('select.elementor-rollback-select')
                        .on('change', function () {
                            var $this = $(this),
                    ...
                    self.elements.$reMigrateGlobalsButton.on('click', function (event) {
                        ...
                        elementorCommon.dialogsManager
                            .createWidget('confirm', {
                                ...
                                message: __(
                                    'Please note that this process will revert all changes made to Global Colors and Fonts since upgrading to v3.x.',
                                    'elementor'
                                ),
                                strings: {
                                    confirm: __('Continue', 'elementor'),
                    ...
                    $('.elementor_css_print_method select')
                        .on('change', function () {
                ...
                initTemplatesImport: function initTemplatesImport() {
                    ...
                    var canImport =
                        elementorAdminConfig.user.is_administrator ||
                        ((_elementorAdminConfig =
                            (_elementorAdminConfig2 = elementorAdminConfig.user.restrictions) ===
                                null || _elementorAdminConfig2 === void 0
                                ? void 0
                                : _elementorAdminConfig2.includes('json-upload')) !== null &&
                        _elementorAdminConfig !== void 0
                            ? _elementorAdminConfig
                            : false)
                    if (
                        !canImport ||
                        !elementorCommon.elements.$body.hasClass('post-type-elementor_library')
                    ) {
                        return
                    }
                    var self = this,
                            ...
                            var _ref4 = (0, _asyncToGenerator2.default)(
                                /*#__PURE__*/ _regenerator.default.mark(function _callee(event) {
                                    var hasImportedFiles,
                                        areUnfilteredFilesEnabled,
                                        enableUnfilteredFilesModal
                                            ...
                                            while (1)
                                                switch ((_context.prev = _context.next)) {
                                                    case 0:
                                                        ...
                                                        _context.next = 7
                                                        return (0,
                                                        _jsonUploadWarningMessage.showJsonUploadWarningMessageIfNeeded)(
                                                            {
                                                                IntroductionClass:
                                                                    window.elementorModules.admin
                                                                        .utils.Introduction,
                                                                introductionMap:
                                                                    window.elementorAdmin.config
                                                                        .user.introduction,
                                                    ...
                                                    case 11:
                                                        ...
                                                        $importNowButton[0].value =
                                                            originalButtonValue
                                                    case 15:
                                                        return _context.abrupt('return')
                                                    case 16:
                                                        hasImportedFiles =
                                                            $importFormFileInput[0].files.length
                                                        areUnfilteredFilesEnabled =
                                                            elementorCommon.config.filesUpload
                                                                .unfilteredFiles
                                                        if (
                                                            !(
                                                                hasImportedFiles &&
                                                                !areUnfilteredFilesEnabled &&
                                                                !messages.enableUnfilteredFiles
                                                                    .shown
                                                            )
                                                        ) {
                                                            _context.next = 23
                                                        ...
                                                        event.preventDefault()
                                                        enableUnfilteredFilesModal =
                                                            _filesUploadHandler.default.getUnfilteredFilesNotEnabledImportTemplateDialog(
                                                                function () {
                ...
                initMaintenanceMode: function initMaintenanceMode() {
                    var MaintenanceMode = __webpack_require__(
                        /*! elementor-admin/maintenance-mode */ '../assets/dev/js/admin/maintenance-mode.js'
                    )
                ...
                goToSettingsTab: function goToSettingsTab(tabName) {
                    ...
                    var $activeTab = this.elements.$settingsTabs.filter(
                        '#elementor-settings-' + tabName
                    )
                ...
                roleManager: {
                    ...
                    toggle: function toggle($trigger) {
                        var self = this,
                            ...
                            $toggleHandleIcon = $row
                                .find(self.selectors.toggleHandle)
                                .find('.dashicons'),
                            $controls = $row.find(self.selectors.controlsContainer)
                        $controls.toggleClass('hidden')
                        if ($controls.hasClass('hidden')) {
                            $toggleHandleIcon
                                .removeClass(self.selectors.arrowUp)
                                .addClass(self.selectors.arrowDown)
                        } else {
                            $toggleHandleIcon
                                .removeClass(self.selectors.arrowDown)
                                .addClass(self.selectors.arrowUp)
                        }
                    ...
                    setAdvancedState: function setAdvancedState($row, state) {
                        var self = this,
                            $controls = $row
                                ...
                                .not(self.selectors.excludedField)
                    ...
                    bind: function bind() {
                        ...
                        $(document)
                            .on(
                                'click',
                                self.selectors.label + ',' + self.selectors.toggleHandle,
                                function (event) {
