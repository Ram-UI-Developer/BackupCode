...
;(() => {
    var e = {
            64376: (e, t, r) => {
                ...
                var c = (function (e) {
                    ...
                    function _default() {
                        return ((0, n.default)(this, _default), t.apply(this, arguments))
                    }
                    return (
            ...
            46458: (e, t, r) => {
                ...
                var c = (function (e) {
                    ;(0, a.default)(View, e)
                    var t = _createSuper(View)
                    function View() {
                        return ((0, o.default)(this, View), t.apply(this, arguments))
                    }
                    return (
                        (0, s.default)(View, [
                            {
                            ...
                            },
                            {
                                ...
                                value: function ui() {
                                    ...
                                    return {
                                        ...
                                        switcher: e + '-switcher',
                                        sizeInputWidth: e + '__input-width',
                                        sizeInputHeight: e + '__input-height',
                                        scaleValue: e + '-scale__value',
                                        scalePlusButton: e + '-scale__plus',
                                        scaleMinusButton: e + '-scale__minus',
                                        scaleResetButton: e + '-scale__reset',
                                        closeButton: e + '__close-button',
                                        breakpointSettingsButton: e + '__settings-button'
                                    }
                                }
                            },
                            {
                                ...
                                value: function events() {
                                    return {
                                        ...
                                        'click @ui.breakpointSettingsButton':
                            ...
                            },
                            {
                                ...
                                value: function restoreLastValidPreviewSize() {
                                    var e = elementor.channels.responsivePreview.request('size')
                                    this.ui.sizeInputWidth.val(e.width).tipsy({
                                        html: !0,
                                        trigger: 'manual',
                                        gravity: 'n',
                                        title: function title() {
                                    ...
                                    var t = this.ui.sizeInputWidth.data('tipsy')
                                    ;(t.show(),
                                        setTimeout(function () {
                                            return t.hide()
                                        }, 3e3))
                            ...
                            },
                            {
                                ...
                                value: function autoScale() {
                                    var e = (40 * this.scalePercentage) / 100,
                                        t = elementor.$previewWrapper.width() - e,
                                        r = parseInt(
                                            elementor.$preview.css('--e-editor-preview-width')
                                        )
                                    if ((r * this.scalePercentage) / 100 > t) {
                                        var i = (t / r) * 100
                                        this.setScalePercentage(i)
                            ...
                            },
                            {
                                ...
                                value: function scalePreview() {
                                    var e = this.scalePercentage / 100
                                    elementor.$previewWrapper.css('--e-preview-scale', e)
                                }
                            },
                            {
                                key: 'resetScale',
                                value: function resetScale() {
                                    ;(this.setScalePercentage(), this.scalePreview())
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function onRender() {
                                    ;(this.addTipsyToIconButtons(), this.setScalePercentage())
                                }
                            },
                            {
                                ...
                                value: function onDeviceModeChange() {
                                    var e = elementor.channels.deviceMode.request('currentMode'),
                                        t = this.ui.switcherInput.filter('[value=' + e + ']')
                                    ;(this.setWidthHeightInputsEditableState(),
                                        this.ui.switcherLabel.attr('aria-selected', !1),
                                        t.closest('label').attr('aria-selected', !0),
                            ...
                            },
                            {
                                ...
                                value: function onBreakpointSelected(e) {
                                    ...
                                    ;(elementor.changeDeviceMode(t, !1), this.autoScale())
                                }
                            },
                            {
                                key: 'onBreakpointSettingsOpen',
                                value: function onBreakpointSettingsOpen() {
                                    ;(elementorCommon.elements.$body.hasClass(
                                        'elementor-editor-preview'
                                    ) && elementor.exitPreviewMode(),
                                        'panel/global/menu' ===
                                        elementor.documents.currentDocument.config.panel
                                            .default_route
                            ...
                            },
                            {
                                ...
                                value: function onPreviewResize() {
                                    if (!this.updatingPreviewSize) {
                                        var e = elementor.channels.responsivePreview.request('size')
                                        ;(this.ui.sizeInputWidth.val(Math.round(e.width)),
                                            this.ui.sizeInputHeight.val(Math.round(e.height)))
                                    }
                                }
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function onSizeInputChange() {
                                    ...
                                    var t = {
                                        ...
                                        r = elementor.getCurrentDeviceConstrains()
                                    t.width < r.minWidth || t.width > r.maxWidth
                                        ? (this.restorePreviewSizeTimeout = setTimeout(function () {
                                              return e.restoreLastValidPreviewSize()
                                          }, 1500))
                                        : ((this.updatingPreviewSize = !0),
                                          setTimeout(function () {
                                              return (e.updatingPreviewSize = !1)
                                          }, 300),
                                          elementor.updatePreviewSize(t),
                                          this.autoScale())
                                }
                            },
                            {
                                ...
                                value: function onScalePlusButtonClick() {
                                    var e =
                                        0 == this.scalePercentage % 10
                                            ...
                                            : 10 * Math.ceil(this.scalePercentage / 10)
                                    e > 200 || (this.setScalePercentage(e), this.scalePreview())
                                }
                            },
                            {
                                ...
                                value: function onScaleMinusButtonClick() {
                                    var e =
                                        0 == this.scalePercentage % 10
                                            ? this.scalePercentage - 10
                                            : 10 * Math.floor(this.scalePercentage / 10)
                                    e < 50 || (this.setScalePercentage(e), this.scalePreview())
                                }
                            },
                            {
    ...
    ;(() => {
        'use strict'
        var e = __webpack_require__(73203)(__webpack_require__(64376))
        elementor.on('preview:loaded', function (t) {
            t &&
                (elementor.addRegions({
                    responsiveBar: { el: '#elementor-responsive-bar', regionClass: e.default }
                }),
