...
/******/ ;(() => {
                    ...
                    ;(0, _createClass2.default)(ConvertAll, [
                        ...
                        },
                        {
                            ...
                            value: function apply() {
                                ...
                                ;(0, _toConsumableArray2.default)(children).forEach(
                                    function (container) {
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _migrator = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../migrator */ '../modules/container-converter/assets/js/editor/migrator.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                        ...
                        [
                            {
                                ...
                                value: function convert(_ref) {
                                    ...
                                    var controlsMapping =
                                        _migrator.default.getLegacyControlsMapping(model)
  ...
  \*************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _convert = __webpack_require__(
                    /*! ./convert */ '../modules/container-converter/assets/js/editor/commands/convert.js'
                )
                var _convertAll = __webpack_require__(
                    /*! ./convert-all */ '../modules/container-converter/assets/js/editor/commands/convert-all.js'
                )
  ...
  \********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var commands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands/ */ '../modules/container-converter/assets/js/editor/commands/index.js'
                    )
                )
                    ...
                    ;(0, _createClass2.default)(_default, [
                        {
                            ...
                            value: function bindEvents() {
                                elementor.channels.editor.on(
                                    'elementorContainerConverter:convert',
                                    function (_ref) {
                                        var container = _ref.container,
                                            el = _ref.el
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _utils = __webpack_require__(
                    /*! ./utils */ '../modules/container-converter/assets/js/editor/maps/utils.js'
                )
                ...
                var map = function map() {
                    return _objectSpread(
                        _objectSpread(
                            _objectSpread(
                                {},
                                (0, _utils.responsive)('_inline_size', function (_ref) {
                            ...
                            (0, _utils.responsive)('content_position', function (_ref2) {
                                ...
                                var deviceKey = (0, _utils.getDeviceKey)(
                ...
                var map = function map(_ref) {
                    ...
                    return _objectSpread(
                        _objectSpread(
                            _objectSpread(
                                {},
                                'boxed' === settings.layout
                                    ? (0, _utils.responsive)('content_width', widthKey)
                                    : {
                                          content_width: null
                                      }
                            ),
                            'min-height' === settings.height &&
                                (0, _utils.responsive)('custom_height', 'min_height')
                        ),
                        {},
                        {
                            ...
                            gap: function gap(_ref4) {
                                ...
                                value =
                                    'custom' === value
                                        ? sectionSettings.gap_columns_custom
                                        : {
                                              size: sizesMap[value],
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _section = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./maps/section */ '../modules/container-converter/assets/js/editor/maps/section.js'
                    )
                )
                var _column = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./maps/column */ '../modules/container-converter/assets/js/editor/maps/column.js'
                    )
                )
                function ownKeys(object, enumerableOnly) {
                    var keys = Object.keys(object)
                    ...
                    ;(0, _createClass2.default)(Migrator, null, [
                        {
                            ...
                            value:
                                ...
                                function migrate(settings, map) {
                                    return Object.fromEntries(
                                        Object.entries(_objectSpread({}, settings))
                                            .map(function (_ref) {
  ...
  \*****************************************************************/
        ...
        var _component = _interopRequireDefault(
            __webpack_require__(
                /*! ./component */ '../modules/container-converter/assets/js/editor/component.js'
            )
        )
        function _createSuper(Derived) {
            var hasNativeReflectConstruct = _isNativeReflectConstruct()
