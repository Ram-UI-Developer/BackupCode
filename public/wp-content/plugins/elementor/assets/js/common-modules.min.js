    ...
    var C = {
            71177: (C, T, B) => {
                ...
                function t(C) {
                    ...
                    return (
                        ...
                        ((function (C) {
                            ...
                            Array.isArray(C) ||
                            !!C[K] ||
                            !!(null === (T = C.constructor) || void 0 === T ? void 0 : T[K]) ||
                            s(C) ||
                            v(C))
                    )
                }
                                                  ...
                                                  if (4 === L)
                                                      ...
                                                      if (
                                                          ...
                                                          for (var $ = B.length; $ < q.length; $++)
                                                              H[$] = !0
                                                      for (
                                                          var U = Math.min(q.length, B.length),
                                                              W = 0;
                                                          W < U;
                                                          W++
                                                      )
                                                ...
                                                q &&
                                                    (H =
                                                        2 & L[0]
                                                            ...
                                                            : L[0]
                                                              ? q.throw ||
                                                                ((H = q.return) && H.call(q), 0)
                                                              : q.next) &&
                                                    !(H = H.call(q, L[1])).done)
                                            )
                                                return H
                                            switch (
                                                ((q = 0), H && (L = [2 & L[0], H.value]), L[0])
                                            ) {
                                                case 0:
                                                case 1:
                                                    H = L
                ...
                function configureStore(C) {
                    ...
                    var Z = applyMiddleware.apply(void 0, J),
                        Y = compose
                    W && (Y = we(__spreadValues({ trace: !Me }, 'object' == typeof W && W)))
                    var ee = new Se(Z),
                        te = ee
                    return (
                        Array.isArray(G)
                ...
                function createReducer(C, T, B, q) {
                    void 0 === B && (B = [])
                    var H,
                        L = 'function' == typeof T ? executeReducerBuilderCallback(T) : [T, B, q],
                        V = L[0],
                        $ = L[1],
                        U = L[2]
                    if (
                ...
                function createEntityAdapter(C) {
                    ...
                    return __spreadValues(
                        __spreadValues(__spreadValues({ selectId: B, sortComparer: q }, H), L),
                        V
                    )
                }
                ...
                function createListenerMiddleware(C) {
                    ...
                    var findListenerEntry = function (C) {
                        ...
                        stopListening = function (C) {
                            ...
                            return (
                                L && (L.unsubscribe(), C.cancelActive && cancelActiveListeners(L)),
                                !!L
                            )
                        },
                ...
                var K = (function (C) {
                    ...
                    function ForceMethodImplementation() {
                        ...
                        return (
                            ...
                            Error.captureStackTrace((0, V.default)(C), ForceMethodImplementation),
                            C
                        )
                    }
                                    ...
                                    value: function scrollObserver(C) {
                                        ...
                                        return new IntersectionObserver(function handleIntersect(
                                            ...
                                            var q = B[0].boundingClientRect.y,
                                                ...
                                                V = Math.abs(
                                                    parseFloat(
                                                        (100 * B[0].intersectionRatio).toFixed(2)
                                                    )
                                                )
                                            ;(C.callback({
            ...
            76824: (C, T, B) => {
                ...
                ;((C.exports = function _construct(C, T, B) {
                    ...
                    var L = [null]
                    L.push.apply(L, T)
                    var V = new (C.bind.apply(C, L))()
                    return (B && q(V, B.prototype), V)
                }),
                    (C.exports.__esModule = !0),
                    (C.exports.default = C.exports))
            },
                ...
                ;((C.exports = function _iterableToArrayLimit(C, T) {
                    ...
                    if (null != B) {
                        ...
                        try {
                            ...
                            try {
                                if (!U && null != B.return && ((V = B.return()), Object(V) !== V))
                                    return
                            } finally {
                                if (W) throw H
                            }
