!(function () {
    ...
    function a(t, e) {
        const { type: s = 'all', exact: i, fetchStatus: r, predicate: n, queryKey: a, stale: o } = t
        if (a)
            if (i) {
                if (e.queryHash !== u(a, e.options)) return !1
            } else if (!h(e.queryKey, a)) return !1
        if ('all' !== s) {
            const t = e.isActive()
        ...
        return !(
            ...
            (void 0 !== r && r !== e.state.fetchStatus) ||
            (n && !n(e))
        )
    }
    function o(t, e) {
        const { exact: s, status: i, predicate: r, mutationKey: n } = t
        if (n) {
    ...
    function l(t, e) {
        ...
        const s = f(t) && f(e)
        if (s || (p(t) && p(e))) {
            const i = s ? t.length : Object.keys(t).length,
                r = s ? e : Object.keys(e),
                n = r.length,
                a = s ? [] : {}
            let o = 0
    ...
    function E(t) {
        ...
        const u = new Promise((t, e) => {
            ...
            c = () => !w.isFocused() || ('always' !== t.networkMode && !P.isOnline()),
            h = (s) => {
                o || ((o = !0), t.onSuccess?.(s), e?.(), i(s))
            },
            l = (s) => {
                o || ((o = !0), t.onError?.(s), e?.(), r(s))
            },
            d = () =>
                new Promise((s) => {
                    ;((e = (t) => {
            ...
            f = () => {
                ...
                Promise.resolve(e)
                    ...
                    .catch((e) => {
                        if (o) return
                        const i = t.retry ?? (s ? 0 : 3),
                            r = t.retryDelay ?? S,
                            u = 'function' == typeof r ? r(a, e) : r,
                            h =
                                !0 === i ||
                                ('number' == typeof i && a < i) ||
                                ('function' == typeof i && i(a, e))
                        !n && h
                            ? (a++,
                              t.onFail?.(a, e),
                              m(u)
    ...
    var M = class {
            ...
            updateGcTime(t) {
                this.gcTime = Math.max(this.gcTime || 0, t ?? (s ? 1 / 0 : 3e5))
            }
            clearGcTimeout() {
        ...
        D = class extends M {
            ...
            optionalRemove() {
                this.#u.length || 'idle' !== this.state.fetchStatus || this.#c.remove(this)
            }
            setData(t, e) {
            ...
            cancel(t) {
                const e = this.#d
                return (this.#f?.cancel(t), e ? e.then(i).catch(i) : Promise.resolve())
            }
            destroy() {
            ...
            isStaleByTime(t = 0) {
                return (
                    this.state.isInvalidated ||
                    !this.state.dataUpdatedAt ||
                    !n(this.state.dataUpdatedAt, t)
                )
            }
            onFocus() {
                const t = this.#u.find((t) => t.shouldFetchOnWindowFocus())
                ;(t?.refetch({ cancelRefetch: !1 }), this.#f?.continue())
            }
            onOnline() {
                const t = this.#u.find((t) => t.shouldFetchOnReconnect())
                ;(t?.refetch({ cancelRefetch: !1 }), this.#f?.continue())
            }
            addObserver(t) {
                this.#u.includes(t) ||
            ...
            removeObserver(t) {
                this.#u.includes(t) &&
                    ...
                    this.#u.length ||
                        (this.#f &&
                            (this.#n ? this.#f.cancel({ revert: !0 }) : this.#f.cancelRetry()),
                        this.scheduleGc()),
            ...
            fetch(t, e) {
                if ('idle' !== this.state.fetchStatus)
                    if (this.state.dataUpdatedAt && e?.cancelRefetch) this.cancel({ silent: !0 })
                    else if (this.#d) return (this.#f?.continueRetry(), this.#d)
                if ((t && this.#o(t), !this.options.queryFn)) {
                    const t = this.#u.find((t) => t.options.queryFn)
                    t && this.#o(t.options)
                }
                ...
                const a = (t) => {
                    ;((F(t) && t.silent) || this.#p({ type: 'error', error: t }),
                        F(t) ||
            ...
            #p(t) {
                ;((this.state = ((e) => {
                    switch (t.type) {
                        ...
                        case 'error':
                            const s = t.error
                            return F(s) && s.revert && this.#l
                                ? { ...this.#l, fetchStatus: 'idle' }
                                : {
                                      ...e,
                                      error: s,
        ...
        x = class extends C {
            ...
            findAll(t = {}) {
                const e = this.getAll()
                return Object.keys(t).length > 0 ? e.filter((e) => a(t, e)) : e
            }
            notify(t) {
                R.batch(() => {
                    this.listeners.forEach((e) => {
        ...
        I = class extends M {
            ...
            async execute(t) {
                ...
                try {
                    if (!s) {
                        ;(this.#p({ type: 'pending', variables: t }),
                            await this.#m.config.onMutate?.(t, this))
                        const e = await this.options.onMutate?.(t)
                        e !== this.state.context &&
                            this.#p({ type: 'pending', context: e, variables: t })
                    }
                    const i = await e()
                    return (
                        await this.#m.config.onSuccess?.(i, t, this.state.context, this),
                    ...
                    try {
                        throw (
                            await this.#m.config.onError?.(e, t, this.state.context, this),
                    ...
                    switch (t.type) {
                        ...
                        case 'pending':
                            return {
                                ...
                                failureReason: null,
                                error: null,
                                isPaused: !q(this.options.networkMode),
                                status: 'pending',
        ...
        A = class extends C {
            constructor(t = {}) {
                ;(super(), (this.config = t), (this.#v = []), (this.#b = 0))
            }
            #v
            #b
            #g
            ...
            add(t) {
                ;(this.#v.push(t), this.notify({ type: 'added', mutation: t }))
            }
            remove(t) {
            ...
            find(t) {
                const e = { exact: !0, ...t }
                return this.#v.find((t) => o(e, t))
            }
            findAll(t = {}) {
                return this.#v.filter((e) => o(t, e))
            }
            notify(t) {
                R.batch(() => {
                    this.listeners.forEach((e) => {
            ...
            resumePausedMutations() {
                return (
                    (this.#g = (this.#g ?? Promise.resolve())
                        .then(() => {
                            const t = this.#v.filter((t) => t.state.isPaused)
                            return R.batch(() =>
                                t.reduce(
                                    (t, e) => t.then(() => e.continue().catch(i)),
                                    Promise.resolve()
                                )
                            )
                        })
                    ...
                    const u =
                        ...
                        c = async (t, s, i) => {
                            ...
                            const a = await u(r),
                                ...
                                h = i ? O : g
                            return { pages: h(t.pages, a, c), pageParams: h(t.pageParams, s, c) }
                        }
                    let h
                    if (i && r.length) {
                        const t = 'backward' === i,
                            e = { pages: r, pageParams: n },
                            a = (t ? K : U)(s, e)
                        h = await c(e, a, t)
                    } else {
                        h = await c(a, n[0] ?? s.initialPageParam)
                        const e = t ?? r.length
                        for (let t = 1; t < e; t++) {
                            const t = U(s, h)
                            h = await c(h, t)
    ...
    function U(t, { pages: e, pageParams: s }) {
        const i = e.length - 1
        return t.getNextPageParam(e[i], e, s[i], s)
    }
    ...
    function L(t, e) {
        return !(!e || !t.getPreviousPageParam) && null != K(t, e)
    }
    var j = class {
            #O
            #m
            ...
            #S
            constructor(t = {}) {
                ;((this.#O = t.queryCache || new x()),
                    (this.#m = t.mutationCache || new A()),
                    (this.#a = t.defaultOptions || {}),
                    (this.#R = new Map()),
                    (this.#C = new Map()),
                    (this.#w = 0))
            ...
            mount() {
                ;(this.#w++,
                    1 === this.#w &&
                        ((this.#P = w.subscribe(() => {
                            w.isFocused() && (this.resumePausedMutations(), this.#O.onFocus())
                        })),
                        (this.#S = P.subscribe(() => {
                            P.isOnline() && (this.resumePausedMutations(), this.#O.onOnline())
                        }))))
            }
            unmount() {
                ;(this.#w--,
                    0 === this.#w &&
                        (this.#P?.(), (this.#P = void 0), this.#S?.(), (this.#S = void 0)))
            }
            isFetching(t) {
            ...
            getQueryData(t) {
                return this.#O.find({ queryKey: t })?.state.data
            }
            ensureQueryData(t) {
            ...
            setQueryData(t, e, s) {
                const i = this.#O.find({ queryKey: t }),
                    r = i?.state.data,
                    n = (function (t, e) {
                ...
                return this.#O.build(this, a).setData(n, { ...s, manual: !0 })
            }
            ...
            getQueryState(t) {
                return this.#O.find({ queryKey: t })?.state
            }
            removeQueries(t) {
                const e = this.#O
                R.batch(() => {
            ...
            cancelQueries(t = {}, e = {}) {
                const s = { revert: !0, ...e },
                    r = R.batch(() => this.#O.findAll(t).map((t) => t.cancel(s)))
            ...
            setQueryDefaults(t, e) {
                this.#R.set(c(t), { queryKey: t, defaultOptions: e })
            }
            getQueryDefaults(t) {
                ...
                return (
                    e.forEach((e) => {
                        h(t, e.queryKey) && (s = { ...s, ...e.defaultOptions })
                    }),
                    s
                )
            }
            setMutationDefaults(t, e) {
                this.#C.set(c(t), { mutationKey: t, defaultOptions: e })
            }
            getMutationDefaults(t) {
                ...
                return (
                    e.forEach((e) => {
                        h(t, e.mutationKey) && (s = { ...s, ...e.defaultOptions })
                    }),
                    s
                )
            }
            defaultQueryOptions(t) {
                ...
                return (
                    ...
                    void 0 === e.networkMode && e.persister && (e.networkMode = 'offlineFirst'),
                    e
                )
            }
        ...
        _ = ({ client: t, children: e }) => (
            ...
            G.createElement(H.Provider, { value: t }, e)
        ),
        W = class extends C {
            constructor(t, e) {
                ;(super(),
            ...
            onSubscribe() {
                1 === this.listeners.size &&
                    (this.#q.addObserver(this), B(this.#q, this.options) && this.#j(), this.#G())
            }
            onUnsubscribe() {
                this.hasListeners() || this.destroy()
            }
            shouldFetchOnReconnect() {
                return z(this.#q, this.options, this.options.refetchOnReconnect)
            }
            shouldFetchOnWindowFocus() {
                return z(this.#q, this.options, this.options.refetchOnWindowFocus)
            }
            destroy() {
                ;((this.listeners = new Set()), this.#H(), this.#N(), this.#q.removeObserver(this))
            }
            setOptions(t, e) {
                const s = this.options,
                    i = this.#q
                if (
                    ((this.options = this.#M.defaultQueryOptions(t)),
                    d(s, this.options) ||
                        this.#M.getQueryCache().notify({
                ...
                ;(this.options.queryKey || (this.options.queryKey = s.queryKey), this.#_())
                const r = this.hasListeners()
                ;(r && $(this.#q, i, this.options, s) && this.#j(),
                    this.updateResult(e),
                    !r ||
                        (this.#q === i &&
                ...
                const n = this.#B()
                !r ||
                    (this.#q === i && this.options.enabled === s.enabled && n === this.#L) ||
                    this.#z(n)
            }
            getOptimisticResult(t) {
                const e = this.#M.getQueryCache().build(this.#M, t),
                    s = this.createResult(e, t)
                return (
                    (i = s),
                    !d(this.getCurrentResult(), i) &&
                        ((this.#F = s), (this.#I = this.options), (this.#x = this.#q.state)),
                    s
                )
                var i
            }
            ...
            fetchOptimistic(t) {
                const e = this.#M.defaultQueryOptions(t),
                    s = this.#M.getQueryCache().build(this.#M, e)
                return (
            ...
            fetch(t) {
                return this.#j({ ...t, cancelRefetch: t.cancelRefetch ?? !0 }).then(
                    () => (this.updateResult(), this.#F)
                )
            }
            #j(t) {
                this.#_()
                let e = this.#q.fetch(this.options, t)
                return (t?.throwOnError || (e = e.catch(i)), e)
            }
            #W() {
                if ((this.#H(), s || this.#F.isStale || !r(this.options.staleTime))) return
                const t = n(this.#F.dataUpdatedAt, this.options.staleTime) + 1
                this.#K = setTimeout(() => {
            ...
            #z(t) {
                ;(this.#N(),
                    ...
                    !s &&
                        ...
                        0 !== this.#L &&
                        (this.#k = setInterval(() => {
                            ;(this.options.refetchIntervalInBackground || w.isFocused()) &&
                                this.#j()
                        }, this.#L)))
            }
            #G() {
            ...
            createResult(t, e) {
                const s = this.#q,
                    ...
                    n = this.#x,
                    a = this.#I,
                    o = t !== s ? t.state : this.#Q,
                    { state: u } = t
                let c,
                    { error: h, errorUpdatedAt: l, fetchStatus: d, status: f } = u,
                    p = !1
                if (e._optimisticResults) {
                    const r = this.hasListeners(),
                        ...
                        a = r && $(t, s, e, i)
                    ;((n || a) &&
                        ((d = q(t.options.networkMode) ? 'fetching' : 'paused'),
                        u.dataUpdatedAt || (f = 'pending')),
                        'isRestoring' === e._optimisticResults && (d = 'idle'))
                }
                if (e.select && void 0 !== u.data)
                    if (r && u.data === n?.data && e.select === this.#A) c = this.#T
                    else
                        try {
                            ;((this.#A = e.select),
                                (c = e.select(u.data)),
                ...
                if (void 0 !== e.placeholderData && void 0 === c && 'pending' === f) {
                    let t
                    if (r?.isPlaceholderData && e.placeholderData === a?.placeholderData) t = r.data
                    else if (
                        ((t =
                    ...
                    void 0 !== t && ((f = 'success'), (c = b(r?.data, t, e)), (p = !0))
                }
                this.#D && ((h = this.#D), (c = this.#T), (l = Date.now()), (f = 'error'))
                const y = 'fetching' === d,
                    m = 'pending' === f,
                    v = 'error' === f,
                    g = m && y
            ...
            updateResult(t) {
                const e = this.#F,
                    s = this.createResult(this.#q, this.options)
                if (((this.#x = this.#q.state), (this.#I = this.options), d(s, e))) return
                ;(void 0 !== this.#x.data && (this.#U = this.#q), (this.#F = s))
                const i = {}
                ;(!1 !== t?.listeners &&
                    (() => {
                        if (!e) return !0
                        ...
                        const i = new Set(s ?? this.#E)
                        return (
                            this.options.throwOnError && i.add('error'),
                            Object.keys(this.#F).some((t) => {
                                const s = t
                                return this.#F[s] !== e[s] && i.has(s)
                            })
                        )
                    })() &&
                    (i.listeners = !0),
            ...
            #_() {
                const t = this.#M.getQueryCache().build(this.#M, this.options)
                if (t === this.#q) return
                const e = this.#q
                ;((this.#q = t),
                    (this.#Q = t.state),
    ...
    function B(t, e) {
        return (
            ...
            (t.state.dataUpdatedAt > 0 && z(t, e, e.refetchOnMount))
        )
    }
    function z(t, e, s) {
        if (!1 !== e.enabled) {
    ...
    var J = class extends W {
        ...
        setOptions(t, e) {
            super.setOptions({ ...t, behavior: T() }, e)
        }
        getOptimisticResult(t) {
            return ((t.behavior = T()), super.getOptimisticResult(t))
        }
        fetchNextPage(t) {
        ...
        createResult(t, e) {
            const { state: s } = t,
                i = super.createResult(t, e),
                { isFetching: r, isRefetching: n } = i,
                a = r && 'forward' === s.fetchMeta?.fetchMore?.direction,
                o = r && 'backward' === s.fetchMeta?.fetchMore?.direction
            return {
                ...i,
                fetchNextPage: this.fetchNextPage,
                fetchPreviousPage: this.fetchPreviousPage,
                hasNextPage: k(e, s.data),
                hasPreviousPage: L(e, s.data),
    ...
    var st = (t, e) => {
        ...
        rt = ({ result: t, errorResetBoundary: e, throwOnError: s, query: i }) =>
            t.isError && !e.isReset() && !t.isFetching && et(s, [t.error, i]),
        nt = (t) => {
            t.suspense && 'number' != typeof t.staleTime && (t.staleTime = 1e3)
        },
        at = (t, e, s) => t?.suspense && ((t, e) => t.isLoading && t.isFetching && !e)(e, s),
        ot = (t, e, s) =>
    ...
    function ut(t, e, s) {
        ...
        ;((a._optimisticResults = r ? 'isRestoring' : 'optimistic'), nt(a), st(a, n), it(n))
        const [o] = G.useState(() => new e(i, a)),
            u = o.getOptimisticResult(a)
        if (
            (G.useSyncExternalStore(
                G.useCallback(
                    (t) => {
                        const e = r ? () => {} : o.subscribe(R.batchCalls(t))
    ...
    var ht = class extends C {
        ...
        setOptions(t) {
            ...
            ;((this.options = this.#M.defaultMutationOptions(t)),
                d(e, this.options) ||
                    this.#M.getMutationCache().notify({
                        type: 'observerOptionsUpdated',
                        mutation: this.#J,
                        observer: this
                    }),
        ...
        reset() {
            ;((this.#J = void 0), this.#V(), this.#$())
        }
        mutate(t, e) {
            return (
                (this.#X = e),
                this.#J?.removeObserver(this),
                (this.#J = this.#M.getMutationCache().build(this.#M, this.options)),
                this.#J.addObserver(this),
                this.#J.execute(t)
            )
        }
        #V() {
            const t = this.#J?.state ?? {
                context: void 0,
                data: void 0,
                error: null,
                failureCount: 0,
        ...
        #$(t) {
            R.batch(() => {
                ;(this.#X &&
                    this.hasListeners() &&
                    ('success' === t?.type
                        ? (this.#X.onSuccess?.(t.data, this.#F.variables, this.#F.context),
                          this.#X.onSettled?.(t.data, null, this.#F.variables, this.#F.context))
                        : 'error' === t?.type &&
                          (this.#X.onError?.(t.error, this.#F.variables, this.#F.context),
                          this.#X.onSettled?.(
                              void 0,
                              t.error,
                              this.#F.variables,
    ...
    function lt(t, e) {
        const s = N(e),
            [i] = G.useState(() => new ht(s, t))
        G.useEffect(() => {
            i.setOptions(t)
        }, [i, t])
        const r = G.useSyncExternalStore(
                G.useCallback((t) => i.subscribe(R.batchCalls(t)), [i]),
                () => i.getCurrentResult(),
                () => i.getCurrentResult()
            ),
            n = G.useCallback(
                (t, e) => {
                    i.mutate(t, e).catch(dt)
                },
                [i]
            )
        if (r.error && et(i.options.throwOnError, [r.error])) throw r.error
    ...
    ;(window.elementorV2 = window.elementorV2 || {}).query = e
})()
