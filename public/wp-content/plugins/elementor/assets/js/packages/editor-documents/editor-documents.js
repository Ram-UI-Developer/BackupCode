    ...
    ;(!(function () {
        ...
        var s = (0, t.__createSlice)({
            ...
            reducers: {
                ...
                updateActiveDocument(t, e) {
                    o(t) && (t.entities[t.activeId] = { ...t.entities[t.activeId], ...e.payload })
                },
                startSaving(t) {
                    o(t) && (t.entities[t.activeId].isSaving = !0)
                },
                endSaving(t, e) {
                    o(t) && (t.entities[t.activeId] = { ...e.payload, isSaving: !1 })
                },
                startSavingDraft: (t) => {
                    o(t) && (t.entities[t.activeId].isSavingDraft = !0)
                },
                endSavingDraft(t, e) {
                    o(t) && (t.entities[t.activeId] = { ...e.payload, isSavingDraft: !1 })
                },
                markAsDirty(t) {
                    o(t) && (t.entities[t.activeId].isDirty = !0)
                },
                markAsPristine(t) {
                    o(t) && (t.entities[t.activeId].isDirty = !1)
                }
            }
        })
        function r() {
        ...
        function c(t) {
            ...
            return {
                ...
                links: { platformEdit: t.config.urls.exit_to_dashboard },
        ...
        var d = (t) => t.documents.entities,
            u = (0, t.__createSelector)(
                d,
                (t) => t.documents.activeId,
                (t, e) => (e && t[e] ? t[e] : null)
            ),
            l = (0, t.__createSelector)(
                d,
                (t) => t.documents.hostId,
                (t, e) => (e && t[e] ? t[e] : null)
            )
        function v() {
            return (0, t.__useSelector)(u)
        }
        function m() {
            return {
                save: (0, a.useCallback)(
                    () => (0, e.__privateRunCommand)('document/save/default'),
                    []
                ),
                saveDraft: (0, a.useCallback)(
                    () => (0, e.__privateRunCommand)('document/save/draft'),
                    []
                ),
                saveTemplate: (0, a.useCallback)(
                    () => (0, e.__privateOpenRoute)('library/save-template'),
                    []
                )
            }
        }
        function _() {
            return (0, t.__useSelector)(l)
        }
        function p() {
        ...
        ;((0, t.__registerSlice)(s),
            (function () {
                const { init: n } = s.actions
                ;(0, e.__privateListenTo)((0, e.v1ReadyEvent)(), () => {
                    const e = r(),
                        i = Object.entries(e.documents).reduce(
                            (t, [e, n]) => ((t[e] = c(n)), t),
                            {}
                        )
                    ;(0, t.__dispatch)(
                        n({ entities: i, hostId: e.getInitialId(), activeId: e.getCurrentId() })
                    )
                })
            })(),
            (function () {
                const { activateDocument: n, setAsHost: i } = s.actions
                ;(0, e.__privateListenTo)((0, e.commandEndEvent)('editor/documents/open'), () => {
                    const e = r(),
                        a = c(e.getCurrent())
                    ;((0, t.__dispatch)(n(a)),
                        e.getInitialId() === a.id && (0, t.__dispatch)(i(a.id)))
                })
            })(),
            (function () {
                const {
                ...
                ;((0, e.__privateListenTo)((0, e.commandStartEvent)('document/save/save'), (e) => {
                    d(e) ? (0, t.__dispatch)(a()) : (0, t.__dispatch)(n())
                }),
                    (0, e.__privateListenTo)((0, e.commandEndEvent)('document/save/save'), (e) => {
                        const n = c(r().getCurrent())
                        d(e) ? (0, t.__dispatch)(o(n)) : (0, t.__dispatch)(i(n))
                    }))
            })(),
            (function () {
                const { updateActiveDocument: n } = s.actions,
                    i = (function (e, i) {
                        let a
                        return (...e) => {
                            ;(clearTimeout(a),
            ...
            (function () {
                const { markAsDirty: n, markAsPristine: i } = s.actions
                ;(0, e.__privateListenTo)(
                    (0, e.commandEndEvent)('document/save/set-is-modified'),
                    () => {
                        r().getCurrent().editor.isChanged
                            ? (0, t.__dispatch)(n())
                            : (0, t.__dispatch)(i())
                    }
                )
