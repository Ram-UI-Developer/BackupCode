            ...
            ;(0, _createClass2.default)(Admin, [
                {
                    ...
                    value: function maybeAddRevertBtnMargin() {
                        var referrerKitId = new URLSearchParams(this.revertButton.href).get(
                            'referrer_kit'
                        )
                        if (!referrerKitId) {
                            return
                    ...
                    value: function onRevertButtonClick(event) {
                        ...
                        elementorCommon.dialogsManager
                            .createWidget('confirm', {
                                ...
                                message: __(
                                    "Removing %s will permanently delete changes made to the Kit's content and site settings",
                                    'elementor'
                                ).replace('%s', this.activeKitName),
                                strings: {
                ...
                },
                {
                    ...
                    value: function onRevertConfirm() {
                        ...
                        this.saveToCache(
                            referrerKitId !== null && referrerKitId !== void 0 ? referrerKitId : ''
                        )
                    ...
                    value: function maybeShowReferrerKitDialog() {
                        ...
                        if (0 === referrerKitId.length) {
                            this.createKitDeletedWidget({
                                message: __(
                                    'Try a different Kit or build your site from scratch.',
                                    'elementor'
                                ),
                                strings: {
                ...
                },
                {
                    ...
                    value: function getDataFromCache() {
                        ...
                        try {
                            this.cachedKitData = JSON.parse(
                                sessionStorage.getItem(this.KIT_DATA_KEY)
                            )
                        } catch (e) {
                            return {}
                        }
                        return (_this$cachedKitData = this.cachedKitData) !== null &&
                            _this$cachedKitData !== void 0
                            ? _this$cachedKitData
                            : {}
                    }
                },
