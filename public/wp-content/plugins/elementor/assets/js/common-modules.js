...
/******/ ;(() => {
                                    ...
                                    function handleIntersect(entries) {
                                        var currentScrollY = entries[0].boundingClientRect.y,
                                            ...
                                            scrollPercentage = Math.abs(
                                                parseFloat(
                                                    (entries[0].intersectionRatio * 100).toFixed(2)
                                                )
                                            )
                                        obj.callback({
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _header = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./header */ '../core/common/assets/js/views/modal/header.js'
                    )
                )
                var _logo = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./logo */ '../core/common/assets/js/views/modal/logo.js'
                    )
                )
                var _loading = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./loading */ '../core/common/assets/js/views/modal/loading.js'
                    )
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                    ...
                    ;(0, _createClass2.default)(_default, [
                        ...
                        },
                        {
                            ...
                            value: function draggableModal() {
                                var $modalWidgetContent =
                                    this.getModal().getElements('widgetContent')
                        ...
                        },
                        {
                            ...
                            value: function showLogo() {
                                this.getHeaderView().logoArea.show(
                                    new _logo.default(this.getLogoOptions())
                                )
                            }
                        }
                    ])
  ...
  \*******************************************/
        ...
        var _modules = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-assets-js/modules/modules */ '../assets/dev/js/modules/modules.js'
            )
        )
        var _layout = _interopRequireDefault(
            __webpack_require__(
                /*! ./views/modal/layout */ '../core/common/assets/js/views/modal/layout.js'
            )
        )
        var _componentBase = _interopRequireDefault(
            __webpack_require__(
        ...
        var _hookBreak = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-api/modules/hook-break */ '../modules/web-cli/assets/js/modules/hook-break.js'
            )
        )
