...
/******/ ;(() => {
                    ...
                    ;(0, _createClass2.default)(Deprecation, [
                        ...
                        },
                        {
                            ...
                            value: function isSoftDeprecated(version) {
                                ...
                                return (
                                    total <= elementorDevToolsConfig.deprecation.soft_version_count
                                )
                            }
                        ...
                        },
                        {
                            ...
                            value: function isHardDeprecated(version) {
                                ...
                                return (
                                    total < 0 ||
                                    total >= elementorDevToolsConfig.deprecation.hard_version_count
                                )
                            }
                        }
                    ])
  ...
  \************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _deprecation = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./deprecation */ '../modules/dev-tools/assets/js/deprecation.js'
                    )
                )
                            ...
                            value: function notifyBackendDeprecations() {
                                ...
                                Object.entries(notices).forEach(function (_ref) {
                                    ...
                                    var _ref2 = (0, _slicedToArray2.default)(_ref, 2),
                                        key = _ref2[0],
                                        notice = _ref2[1]
                                    ;(_this$deprecation = _this.deprecation).deprecated.apply(
                                        _this$deprecation,
                                        [key].concat((0, _toConsumableArray2.default)(notice))
                                    )
                                })
                            }
                        },
  ...
  \***********************************************/
        ...
        var _module = _interopRequireDefault(
            __webpack_require__(/*! ./module */ '../modules/dev-tools/assets/js/module.js')
        )
