...
/******/ ;(() => {
  ...
  \****************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function _loadElementsDefaults() {
                    _loadElementsDefaults = (0, _asyncToGenerator2.default)(
                                    ...
                                    switch ((_context.prev = _context.next)) {
                                        case 0:
                                            ...
                                            return _context.abrupt(
                                                'return',
                                                $e.data.get(''.concat(NAMESPACE, '/index'))
                                            )
                                        case 2:
                                        case 'end':
                ...
                function _updateElementDefaults() {
                    _updateElementDefaults = (0, _asyncToGenerator2.default)(
                        /*#__PURE__*/ _regenerator.default.mark(function _callee2(type, settings) {
                ...
                function _deleteElementDefaults() {
                    _deleteElementDefaults = (0, _asyncToGenerator2.default)(
                        /*#__PURE__*/ _regenerator.default.mark(function _callee3(type) {
  ...
  \**************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _confirmCreationDialog = __webpack_require__(
                    /*! ../confirm-creation-dialog */ '../modules/kit-elements-defaults/assets/js/editor/confirm-creation-dialog.js'
                )
                                            ...
                                            while (1)
                                                switch ((_context.prev = _context.next)) {
                                                    case 0:
                                                        ...
                                                        confirmCreationDialog = (0,
                                                        _confirmCreationDialog.getConfirmCreationDialog)(
                                                            {
                                                                onConfirm: function onConfirm() {
                                                                    return $e.run(
                                                                        'kit-elements-defaults/create',
                                                                        {
                                                                            container: container
                                                                        }
                                                                    )
  ...
  \****************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _api = __webpack_require__(
                    /*! ../api */ '../modules/kit-elements-defaults/assets/js/editor/api.js'
                )
                var _extractContainerSettings = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../extract-container-settings */ '../modules/kit-elements-defaults/assets/js/editor/extract-container-settings.js'
                    )
                )
                var _utils = __webpack_require__(
                    /*! ../utils */ '../modules/kit-elements-defaults/assets/js/editor/utils.js'
                )
                function _createSuper(Derived) {
                    var hasNativeReflectConstruct = _isNativeReflectConstruct()
                    return function _createSuperInternal() {
                                                ...
                                                while (1)
                                                    switch ((_context.prev = _context.next)) {
                                                        case 0:
                                                            ...
                                                            ;((type = (0,
                                                            _utils.extractElementType)(
                                                                container.model
                                                            )),
                                                                (previousDefaults = (0,
                                                                _api.getElementDefaults)(type)),
                                                                (newDefaults = (0,
                                                                _extractContainerSettings.default)(
                                                                    container
                                                                )))
                                                            _context.prev = 3
                                                            _context.next = 6
                                                            return (0, _api.updateElementDefaults)(
                                                                type,
                                                                newDefaults
                                                            )
                                                        case 6:
                                                ...
                                                while (1)
                                                    switch ((_context.prev = _context.next)) {
                                                        case 0:
                                                            ...
                                                            _context.prev = 2
                                                            _context.next = 5
                                                            return (0, _api.deleteElementDefaults)(
                                                                type
                                                            )
                                                        case 5:
                                                            elementor.notifications.showToast({
                                                                message: __(
                                                                    'Default settings has been reset.',
                                                                    'elementor'
                                                                )
                                                            })
                                                            _context.next = 12
  ...
  \***************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _confirmCreation = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./confirm-creation */ '../modules/kit-elements-defaults/assets/js/editor/commands/confirm-creation.js'
                    )
                )
                var _create = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./create */ '../modules/kit-elements-defaults/assets/js/editor/commands/create.js'
                    )
                )
                var _delete = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./delete */ '../modules/kit-elements-defaults/assets/js/editor/commands/delete.js'
                    )
                )
                var _restore = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./restore */ '../modules/kit-elements-defaults/assets/js/editor/commands/restore.js'
                    )
                )
  ...
  \**********************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var hooks = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./hooks */ '../modules/kit-elements-defaults/assets/js/editor/hooks/index.js'
                    )
                )
                var dataCommands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./data-commands/ */ '../modules/kit-elements-defaults/assets/js/editor/data-commands/index.js'
                    )
                )
                var commands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands/ */ '../modules/kit-elements-defaults/assets/js/editor/commands/index.js'
                    )
                )
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function getConfirmCreationDialog(_ref) {
                    ...
                    if (!introductionManager) {
                        ...
                        exports.introductionManager = introductionManager =
                            createIntroductionManager()
                        introductionManager.introductionViewed = !!(
                            (_elementor$config$use = elementor.config.user.introduction) !== null &&
                            _elementor$config$use !== void 0 &&
                            _elementor$config$use[introductionKey]
                        )
                    }
                ...
                function createIntroductionManager() {
                    ...
                    var introduction = new elementorModules.editor.utils.Introduction({
                        ...
                        dialogOptions: {
                            id: dialogId,
                            headerMessage: __(
                                'Sure you want to change default settings?',
                                'elementor'
                            ),
                            // Translators: %1$s: Opening strong tag, %2$s: Closing strong tag.
                            message: __(
                                'Your changes will automatically be saved for future uses of this element. %1$sNote:%2$s This includes sensitive information like emails, API keys, etc.',
                                'elementor'
                            )
                                .replace('%1$s', '<strong>')
                                .replace('%2$s', '</strong>'),
                            ...
                            onShow: function onShow() {
                                ...
                                ;(_this$getElements = this.getElements(
                                    'checkbox-dont-show-again'
                                )) === null || _this$getElements === void 0
                                    ? void 0
                                    : _this$getElements.prop('checked', true)
                            }
                        }
                    })
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function extractSpecialSettings(settings, controls, localSettings) {
                    return SPECIAL_SETTINGS.reduce(function (acc, type) {
                        var specialSettings = extractSettings(
                        ...
                        return _objectSpread(
                            _objectSpread({}, acc),
                            {},
                            (0, _defineProperty2.default)({}, type, specialSettings)
                        )
                    }, {})
                }
                    ...
                    ;(0, _createClass2.default)(FillDefaultsOnDrop, [
                        ...
                        },
                        {
                            ...
                            value: function getConditions(args) {
                                ...
                                return (
                                    ((_args$model = args.model) === null || _args$model === void 0
                                        ? void 0
                                        : _args$model.widgetType) ||
                                    ((_args$model2 = args.model) === null || _args$model2 === void 0
                                        ? void 0
                                        : _args$model2.elType)
                                )
                            }
                        },
                        {
                            ...
                            value: function apply(args) {
                                ...
                                var elementDefaultSettings = (0, _api.getElementDefaults)(
                                    (0, _utils.extractElementType)(model)
                                )
                                if (!(0, _utils.isPopulatedObject)(elementDefaultSettings)) {
                                    return true
                                }
                                var settings = _objectSpread(
                                    _objectSpread({}, elementDefaultSettings),
                                    args.model.settings || {}
                                )
                                ;['__dynamic__', '__globals__'].forEach(function (type) {
                                    var _args$model$settings
                                    if (
                                        !(0, _utils.isPopulatedObject)(elementDefaultSettings[type])
                                    ) {
                                        return
                                    }
                                    settings[type] = _objectSpread(
                                        _objectSpread({}, elementDefaultSettings[type] || {}),
                                        ((_args$model$settings = args.model.settings) === null ||
                                        _args$model$settings === void 0
                                            ? void 0
                                            : _args$model$settings[type]) || {}
                                    )
                                })
                                args.model = _objectSpread(
                                    _objectSpread({}, args.model),
                                    {},
                                    {
                                        settings: settings
                                    }
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _fillDefaultsOnDrop = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./data/fill-defaults-on-drop */ '../modules/kit-elements-defaults/assets/js/editor/hooks/data/fill-defaults-on-drop.js'
                    )
                )
  ...
  \*******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _component = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./component */ '../modules/kit-elements-defaults/assets/js/editor/component.js'
                    )
                )
                var _api = __webpack_require__(
                    /*! ./api */ '../modules/kit-elements-defaults/assets/js/editor/api.js'
                ...
                function _addContextMenuItem2() {
                    ...
                    if (
                        !(
                            (_elementor$config = elementor.config) !== null &&
                            _elementor$config !== void 0 &&
                            (_elementor$config$use = _elementor$config.user) !== null &&
                            _elementor$config$use !== void 0 &&
                            _elementor$config$use.is_administrator
                        )
                    ) {
                        return
                    }
                    ;['widget', 'container', 'section'].forEach(function (elType) {
                        elementor.hooks.addFilter(
                            'elements/'.concat(elType, '/contextMenuGroups'),
                            function (groups, view) {
                                ...
                                if (
                                    'section' ===
                                    (0, _utils.extractElementType)(
                                        ((_view$options = view.options) === null ||
                                        _view$options === void 0
                                            ? void 0
                                            : _view$options.model) || {}
                                    )
                                ) {
                                ...
                                return groups.map(function (group) {
                                    ...
                                    group.actions = [].concat(
                                        (0, _toConsumableArray2.default)(group.actions),
                                        [
                                            {
                                                ...
                                                callback: function callback() {
                                                    $e.run(
                                                        'kit-elements-defaults/confirm-creation',
                                                        {
  ...
  \******************************************************************/
        ...
        var _module = _interopRequireDefault(
            __webpack_require__(
                /*! ./module.js */ '../modules/kit-elements-defaults/assets/js/editor/module.js'
            )
        )
        new _module.default()
    })()
