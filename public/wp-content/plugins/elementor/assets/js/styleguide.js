...
/******/ ;(() => {
  ...
  \***************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var TagPanelView = __webpack_require__(
                    /*! elementor-dynamic-tags/tag-panel-view */ '../assets/dev/js/editor/components/dynamic-tags/tag-panel-view.js'
                )
                module.exports = Marionette.Behavior.extend({
                    ...
                    initialize: function initialize() {
                        if (!this.listenerAttached) {
                            this.listenTo(
                                this.view.options.container.settings,
                                'change:external:__dynamic__',
                                this.onAfterExternalChange
                            )
                    ...
                    shouldRenderTools: function shouldRenderTools() {
                        ...
                        var isFeatureAvalibleToUser =
                                elementor.helpers.hasPro() &&
                                !elementor.helpers.hasProAndNotConnected(),
                    ...
                    renderTools: function renderTools() {
                        ...
                        this.$el
                            .find('.elementor-control-dynamic-switcher-wrapper')
                            .append($dynamicSwitcher)
                    ...
                    moveDynamicSwitcherToColorPicker: function moveDynamicSwitcherToColorPicker() {
                        ...
                        this.ui.dynamicSwitcher
                            .removeClass('elementor-control-unit-1')
                            .addClass('e-control-tool')
                        var $eyedropper = $colorPickerToolsContainer.find(
                            '.elementor-control-element-color-picker'
                        )
                    ...
                    createTagsList: function createTagsList() {
                        ...
                        if (!elementor.helpers.hasPro() && Object.keys(tags).length) {
                            var proTeaser = Marionette.Renderer.render(
                                '#tmpl-elementor-dynamic-tags-promo',
                                {
                                    promotionUrl: elementor.config.dynamicPromotionURL.replace(
                                        '%s',
                        ...
                        $tagsListInner.on(
                            ...
                            this.onTagsListItemClick.bind(this)
                        )
                    ...
                    setTagView: function setTagView(id, name, settings) {
                        ...
                        var tagView = (this.tagView = new TagPanelView({
                            ...
                            tagViewLabel =
                                elementContainer.controls[tagView.options.controlName].label
                    ...
                    tagViewToTagText: function tagViewToTagText() {
                        ...
                        return elementor.dynamicTags.tagDataToTagText(
                            tagView.getOption('id'),
                            tagView.getOption('name'),
                            tagView.model
                        )
                    },
                            ...
                            dialogOptions = {
                                ...
                                actionButton: {
                                    url: hasProAndNotConnected
                                        ...
                                        : elementor.config.dynamicPromotionURL.replace(
                                              '%s',
                                              this.view.model.get('name')
                                          ),
  ...
  \*****************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var EmptyView = __webpack_require__(
                    /*! elementor-dynamic-tags/tag-controls-stack-empty */ '../assets/dev/js/editor/components/dynamic-tags/tag-controls-stack-empty.js'
                )
  ...
  \*************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var TagControlsStack = __webpack_require__(
                    /*! elementor-dynamic-tags/tag-controls-stack */ '../assets/dev/js/editor/components/dynamic-tags/tag-controls-stack.js'
                )
                module.exports = Marionette.ItemView.extend({
                    ...
                    getTemplate: function getTemplate() {
                        var config = this.getTagConfig(),
                            templateFunction = Marionette.TemplateCache.get(
                    ...
                    initSettingsPopup: function initSettingsPopup() {
                        ...
                        var settingsPopup = elementorCommon.dialogsManager.createWidget(
                            'buttons',
                    ...
                    initModel: function initModel() {
                        this.model = new elementorModules.editor.elements.models.BaseSettings(
  ...
  \******************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var NumberValidator = __webpack_require__(
                    /*! elementor-validator/number */ '../assets/dev/js/editor/components/validator/number.js'
                )
                    ...
                    ;(0, _createClass2.default)(BreakpointValidator, [
                        ...
                        },
                        {
                            ...
                            value: function getPanelActiveBreakpoints() {
                                var panelBreakpoints =
                                        elementor.documents.currentDocument.config.settings.settings.active_breakpoints.map(
                                ...
                                panelBreakpoints.forEach(function (breakpointName) {
                                    panelActiveBreakpoints[breakpointName] =
                        ...
                        },
                        {
                            ...
                            value: function initBreakpointProperties() {
                                ...
                                this.breakpointIndex = breakpointKeys.indexOf(
                                    validationTerms.breakpointName
                                )
                                this.topBreakpoint =
                                    (_activeBreakpoints$br =
                                        activeBreakpoints[
                                            breakpointKeys[this.breakpointIndex + 1]
                                        ]) === null || _activeBreakpoints$br === void 0
                                        ? void 0
                                        : _activeBreakpoints$br.value
                                this.bottomBreakpoint =
                                    (_activeBreakpoints$br2 =
                                        activeBreakpoints[
                                            breakpointKeys[this.breakpointIndex - 1]
                                        ]) === null || _activeBreakpoints$br2 === void 0
                                        ? void 0
                                        : _activeBreakpoints$br2.value
                            }
                        },
                        {
                            ...
                            value: function validationMethod(newValue) {
                                var validationTerms = this.getSettings('validationTerms'),
                                    errors = NumberValidator.prototype.validationMethod.call(
                                        this,
                                        newValue
                                    )
                                ...
                                if (_.isFinite(newValue) || '' === newValue) {
                                    if (
                                        !this.validateMinMaxForBreakpoint(newValue, validationTerms)
                                    ) {
                                        errors.push(
                                            'Value is not between the breakpoints above or under the edited breakpoint'
                                        )
                                    }
                                }
                                return errors
                        ...
                        },
                        {
                            ...
                            value: function validateMinMaxForBreakpoint(newValue, validationTerms) {
                                ...
                                if (
                                    'mobile' === validationTerms.breakpointName &&
                                    320 === this.bottomBreakpoint
                                ) {
                                ...
                                if (this.bottomBreakpoint) {
                                    ...
                                    if (
                                        '' === newValue &&
                                        breakpointDefaultValue <= this.bottomBreakpoint
                                    ) {
                                        isValid = false
                                    }
                                }
                                ...
                                if (this.topBreakpoint) {
                                    ...
                                    if (
                                        '' === newValue &&
                                        breakpointDefaultValue >= this.topBreakpoint
                                    ) {
                                        isValid = false
                                    }
                                }
  ...
  \**************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var Validator = __webpack_require__(
                    /*! elementor-validator/base */ '../assets/dev/js/editor/components/validator/base.js'
                )
                module.exports = Validator.extend({
                    validationMethod: function validationMethod(newValue) {
                        ...
                        if (_.isFinite(newValue)) {
                            if (
                                undefined !== validationTerms.min &&
                                newValue < validationTerms.min
                            ) {
                                errors.push('Value is less than minimum')
                            }
                            if (
                                undefined !== validationTerms.max &&
                                newValue > validationTerms.max
                            ) {
  ...
  \*****************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _breakpoint = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-validator/breakpoint */ '../assets/dev/js/editor/components/validator/breakpoint.js'
                    )
                )
                ...
                var ControlBaseView = __webpack_require__(
                        /*! elementor-controls/base */ '../assets/dev/js/editor/controls/base.js'
                    ),
                    TagsBehavior = __webpack_require__(
                        /*! elementor-dynamic-tags/control-behavior */ '../assets/dev/js/editor/components/dynamic-tags/control-behavior.js'
                    ),
                    Validator = __webpack_require__(
                        /*! elementor-validator/base */ '../assets/dev/js/editor/components/validator/base.js'
                    ),
                    NumberValidator = __webpack_require__(
                        /*! elementor-validator/number */ '../assets/dev/js/editor/components/validator/number.js'
                    ),
                    ControlBaseDataView
                ControlBaseDataView = ControlBaseView.extend(
                    {
                        ...
                        ui: function ui() {
                            ...
                            _.extend(ui, {
                                ...
                                responsiveSwitchersSibling: ''.concat(
                                    ui.controlTitle,
                                    '[data-e-responsive-switcher-sibling!="false"]'
                                ),
                        ...
                        templateHelpers: function templateHelpers() {
                            var controlData = ControlBaseView.prototype.templateHelpers.apply(
                                this,
                                arguments
                            )
                        ...
                        behaviors: function behaviors() {
                            var behaviors = ControlBaseView.prototype.behaviors.apply(
                                    this,
                                    arguments
                                ),
                            ...
                            if (dynamicSettings && dynamicSettings.active) {
                                var tags = _.filter(
                                    elementor.dynamicTags.getConfig('tags'),
                                    function (tag) {
                                        return (
                                            tag.editable &&
                                            _.intersection(
                        ...
                        initialize: function initialize() {
                            ...
                            var settings = this.container
                                ? this.container.settings
                                : this.elementSettingsModel
                            this.listenTo(
                                settings,
                                'change:external:' + this.model.get('name'),
                                this.onAfterExternalChange
                            )
                        },
                        ...
                        getGlobalDefault: function getGlobalDefault() {
                            ...
                            if (
                                controlGlobalArgs !== null &&
                                controlGlobalArgs !== void 0 &&
                                controlGlobalArgs.default
                            ) {
                                ...
                                if (
                                    !elementor.config.globals.defaults_enabled[
                                        this.getGlobalMeta().controlType
                                    ]
                                ) {
                                    return ''
                                }
                                var _$e$data$commandExtra = $e.data.commandExtractArgs(
                                        controlGlobalArgs.default
                                    ),
                                    command = _$e$data$commandExtra.command,
                                    args = _$e$data$commandExtra.args,
                                    result = $e.data.getCache(
                                        $e.components.get('globals'),
                                        command,
                                        args.query
                                    )
                        ...
                        isGlobalActive: function isGlobalActive() {
                            ...
                            return (_this$options$model$g = this.options.model.get('global')) ===
                                null || _this$options$model$g === void 0
                                ? void 0
                                : _this$options$model$g.active
                        },
                        ...
                        applySavedValue: function applySavedValue() {
                            this.setInputValue(
                                '[data-setting="' + this.model.get('name') + '"]',
                        ...
                        setEditSetting: function setEditSetting(settingKey, settingValue) {
                            var settings =
                                this.getOption('elementEditSettings') ||
                                this.getOption('container').settings
                        ...
                        getControlPlaceholder: function getControlPlaceholder() {
                            ...
                            if (
                                this.model.get('responsive') &&
                                this.model.get('inherit_placeholders')
                            ) {
                                placeholder =
                                    placeholder ||
                        ...
                        preparePlaceholderForChildren: function preparePlaceholderForChildren() {
                            ...
                            var cleanValue = this.getCleanControlValue(),
                                parentValue =
                                    (_this$getResponsivePa = this.getResponsiveParentView()) ===
                                        null || _this$getResponsivePa === void 0
                                        ? void 0
                                        : _this$getResponsivePa.preparePlaceholderForChildren()
                        ...
                        onBaseInputChange: function onBaseInputChange(event) {
                            ...
                            var input = event.currentTarget,
                                ...
                                settingsValidators =
                                    this.container.settings.validators[this.model.get('name')]
                            ...
                            if (validators) {
                                ...
                                if (!isValidValue) {
                                    this.correctionTimeout = setTimeout(
                                        this.setInputValue.bind(this, input, oldValue),
                                        1200
                                    )
                                    return
                                }
                        ...
                        onResponsiveSwitchersClick: function onResponsiveSwitchersClick(event) {
                            ...
                            $switchersWrapper[0].style.setProperty(
                                '--selected-option',
                                selectedOption
                            )
                    ...
                    {
                        // Static methods
                        getStyleValue: function getStyleValue(
                            placeholder,
                            controlValue,
                            controlData
                        ) {
                ...
                ControlBaseView = Marionette.CompositeView.extend({
                    ...
                    getTemplate: function getTemplate() {
                        return Marionette.TemplateCache.get(
                            '#tmpl-elementor-control-' + this.model.get('type') + '-content'
                        )
                    },
                            ...
                            get: function get() {
                                if (!options.container) {
                                    var settingsModel = options.elementSettingsModel,
                                        view = $e.components
                                            .get('document')
                                            .utils.findViewById(settingsModel.id)
                                    ...
                                    if (view && view.getContainer) {
                                        ...
                                        if (!settingsModel.id) {
                                            settingsModel.id =
                                                'bc-' + elementorCommon.helpers.getUniqueId()
                                        }
                        ...
                        Object.defineProperty(this, 'elementSettingsModel', {
                            get: function get() {
                                ...
                                return options.container
                                    ...
                                    : options.elementSettingsModel
                            }
                        })
                        var controlType = this.model.get('type'),
                            controlSettings = jQuery.extend(
                                true,
                                {},
                                elementor.config.controls[controlType],
                                this.model.attributes
                            )
                    ...
                    toggleControlVisibility: function toggleControlVisibility() {
                        ...
                        var settings = this.container
                            ? this.container.settings
                            : this.elementSettingsModel
                        var isVisible = elementor.helpers.isActiveControl(
                            this.model,
                            settings.attributes,
                            settings.controls
                        )
                    ...
                    getControlInRouteArgs: function getControlInRouteArgs(path) {
                        return _objectSpread(
                            _objectSpread({}, $e.routes.getCurrentArgs('panel')),
                            {},
                            {
                                activeControl: path
                            }
  ...
  \****************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var ControlBaseDataView = __webpack_require__(
                    /*! elementor-controls/base-data */ '../assets/dev/js/editor/controls/base-data.js'
                )
                    ...
                    ;(0, _createClass2.default)(Enable, [
                        {
                            ...
                            value: function apply(args) {
                                $e.components
                                    .get('preview/styleguide')
                                    .enableStyleguidePreview(args)
                            }
                        }
                    ])
                    return Enable
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _enable = __webpack_require__(
                    /*! ./enable */ '../modules/styleguide/assets/js/commands/enable.js'
                )
                var _globalColors = __webpack_require__(
                    /*! ./global-colors */ '../modules/styleguide/assets/js/commands/global-colors.js'
                )
                var _globalTypography = __webpack_require__(
                    /*! ./global-typography */ '../modules/styleguide/assets/js/commands/global-typography.js'
                )
                var _hide = __webpack_require__(
                    /*! ./hide */ '../modules/styleguide/assets/js/commands/hide.js'
                )
                var _switcherChange = __webpack_require__(
                    /*! ./switcher-change */ '../modules/styleguide/assets/js/commands/switcher-change.js'
                )
  ...
  \************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _get3 = _interopRequireDefault(
                    __webpack_require__(
                ...
                var _switcher = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-assets-js/editor/controls/switcher */ '../assets/dev/js/editor/controls/switcher.js'
                    )
                )
                var _baseData = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-controls/base-data */ '../assets/dev/js/editor/controls/base-data.js'
                    )
                )
                    ...
                    ;(0, _createClass2.default)(_default, [
                        ...
                        },
                        {
                            ...
                            value: function onBeforeRender() {
                                ...
                                var actualValue = elementor.getPreferences(
  ...
  \******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var commands = _interopRequireWildcard(
                    __webpack_require__(
                        /*! ./commands */ '../modules/styleguide/assets/js/commands/index.js'
                    )
                )
                var _switcher = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./controls/switcher */ '../modules/styleguide/assets/js/controls/switcher.js'
                    )
                )
                    ...
                    ;(0, _createClass2.default)(_default, [
                        ...
                        },
                        {
                            ...
                            value: function registerStyleguideDialogType() {
                                DialogsManager.addWidgetType(
                                    'styleguide',
                                    DialogsManager.getWidgetType('lightbox').extend('alert', {
                                        buildWidget: function buildWidget() {
                                            DialogsManager.getWidgetType(
                                                'lightbox'
                                            ).prototype.buildWidget.apply(this, arguments)
                        ...
                        },
                        {
                            ...
                            value: function initModal() {
                                ...
                                this.getModal = function () {
                                    ...
                                    modal = elementorCommon.dialogsManager.createWidget(
                                        'styleguide',
                                        {
                                            id: 'e-styleguide-preview-dialog',
                                            message:
                                                '<div class="e-styleguide-preview-root"></div>',
                                            position: {
                                                my: 'center center',
                                                at: 'center center'
                                            },
                        ...
                        },
                        {
                            ...
                            value: function showStyleguidePreview() {
                                var skipPreferencesCheck =
                                    arguments.length > 0 && arguments[0] !== undefined
                                        ? arguments[0]
                                        : false
                                if (
                                    this.getModal().isVisible() ||
                                    (!skipPreferencesCheck &&
                                        !elementor.getPreferences('enable_styleguide_preview'))
                                ) {
                                    return
                                }
                        ...
                        },
                        {
                            ...
                            value: function enableStyleguidePreview(options) {
                                ...
                                $e.run('document/elements/settings', {
                                    container: elementor.settings.editorPreferences
                                        .getEditedView()
                                        .getContainer(),
                                    settings: {
  ...
  \*****************************************************/
        ...
        var _eComponent = _interopRequireDefault(
            __webpack_require__(
                /*! ./e-component */ '../modules/styleguide/assets/js/e-component.js'
            )
        )
        function _createSuper(Derived) {
            var hasNativeReflectConstruct = _isNativeReflectConstruct()
            ...
            ;(0, _createClass2.default)(Styleguide, [
                ...
                },
                {
                    ...
                    value: function addHooks() {
                        elementor.hooks.addAction(
                            'panel/global/tab/before-show',
                            this.show.bind(this)
                        )
                        elementor.hooks.addAction(
                            'panel/global/tab/before-destroy',
                            this.hide.bind(this)
                        )
                    }
                ...
                },
                {
                    ...
                    value: function hide(args) {
                        ...
                        var isGlobalsRoute = Object.values(this.getGlobalRoutes()).some(
                            function (route) {
