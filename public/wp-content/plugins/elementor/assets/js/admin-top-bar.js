...
/******/ ;(() => {
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _barButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./components/bar-button/bar-button */ '../modules/admin-top-bar/assets/js/components/bar-button/bar-button.js'
                    )
                )
                var _barHeading = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./components/bar-heading/bar-heading */ '../modules/admin-top-bar/assets/js/components/bar-heading/bar-heading.js'
                    )
                )
                var _connectionButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./components/connection-button/connection-button */ '../modules/admin-top-bar/assets/js/components/connection-button/connection-button.js'
                    )
                )
                var _usePageTitle = __webpack_require__(
                    /*! ./hooks/use-page-title/use-page-title */ '../modules/admin-top-bar/assets/js/hooks/use-page-title/use-page-title.js'
                )
                ...
                function AdminTopBar() {
                    ...
                    var finderTooltipText =
                        __('Search or do anything in Elementor', 'elementor') +
                        ' '.concat(controlSign, '+E')
                    var BarButtonNotification =
                        (_window = window) === null || _window === void 0
                            ? void 0
                            : (_window$elementorNoti = _window.elementorNotificationCenter) ===
                                    null || _window$elementorNoti === void 0
                              ? void 0
                              : _window$elementorNoti.BarButtonNotification
                    return /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                            ...
                            /*#__PURE__*/ _react.default.createElement(
                                ...
                                window.elementorAdminTopBarConfig.is_administrator
                                    ? /*#__PURE__*/ _react.default.createElement(
                                          _barButton.default,
                                          {
                                ...
                                BarButtonNotification
                                    ? /*#__PURE__*/ _react.default.createElement(
                                          ...
                                          {
                                              defaultIsRead: !(
                                                  (_elementorNotificatio =
                                                      elementorNotifications) !== null &&
                                                  _elementorNotificatio !== void 0 &&
                                                  _elementorNotificatio.is_unread
                                              )
                                          },
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                function BarButton(props) {
                    ...
                    return /*#__PURE__*/ _react.default.createElement(
                        'a',
                        {
                            className: 'e-admin-top-bar__bar-button '.concat(
                        ...
                        /*#__PURE__*/ _react.default.createElement('i', {
                            className: 'e-admin-top-bar__bar-button-icon '
                                .concat(props.icon, ' ')
                                .concat(props.iconAdditionalClasses)
                        }),
                        /*#__PURE__*/ _react.default.createElement(
                            'span',
                            {
  ...
  \********************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _barButton = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../bar-button/bar-button */ '../modules/admin-top-bar/assets/js/components/bar-button/bar-button.js'
                    )
                )
                function _getRequireWildcardCache(nodeInterop) {
                    if (typeof WeakMap !== 'function') return null
                ...
                function ConnectionButton() {
                    ...
                    var tooltipText = __(
                            "Connect your account to get access to Elementor's Template Library & more.",
                            'elementor'
                        ),
...
*/
  ...
  \***************************************************/
        ...
        var _adminTopBar = _interopRequireDefault(
            __webpack_require__(
                /*! ./admin-top-bar */ '../modules/admin-top-bar/assets/js/admin-top-bar.js'
            )
        )
        var AppWrapper = elementorCommon.config.isDebug
        ...
        _react2.default.render(
            /*#__PURE__*/ _react.default.createElement(
                AppWrapper,
                null,
                /*#__PURE__*/ _react.default.createElement(_adminTopBar.default, null)
            ),
            adminTopBarElement
        )
    })()
