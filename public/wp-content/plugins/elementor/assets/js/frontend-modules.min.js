    ...
    [354],
    {
        ...
        2618: (e, t, n) => {
            ...
            class ArgsObject extends r.default {
                ...
                requireArgument(e) {
                    let t =
                        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.args
                    if (!Object.prototype.hasOwnProperty.call(t, e))
                        throw Error(`${e} is required.`)
                }
                requireArgumentType(e, t) {
                    let n =
                        arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.args
            ...
            t.default = class Scroll {
                ...
                static getPageScrollPercentage() {
                    ...
                    const n = e.start || 0,
                        ...
                        o = r + s + (r * i) / 100
                    return (
                        ((document.documentElement.scrollTop + document.body.scrollTop + s) / o) *
                        100
                    )
                }
            }
            ...
            class NestedTabs extends r.default {
                ...
                changeActiveTab(e) {
                    ...
                    const t = this.isActiveTab(e),
                        n = this.getSettings()
                    if (
                        ((!n.toggleSelf && t) || !n.hidePrevious || this.deactivateActiveTab(e),
        ...
        2114: (e, t, n) => {
            ...
            e.exports = !i(function () {
                var e = Error('a')
                return (
                    !('stack' in e) || (Object.defineProperty(e, 'stack', r(1, 7)), 7 !== e.stack)
                )
            })
        },
        1695: (e, t, n) => {
            ...
            var i = n(1695),
                ...
                exportWebAssemblyErrorCauseWrapper = function (e, t) {
                    if (l && l[e]) {
                        var n = {}
                        ;((n[e] = o(a + '.' + e, t, c)),
                            i({ target: a, stat: !0, constructor: !0, arity: 1, forced: c }, n))
                    }
                }
