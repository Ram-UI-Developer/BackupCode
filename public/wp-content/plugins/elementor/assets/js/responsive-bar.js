...
/******/ ;(() => {
  ...
  \************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _view = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./view */ '../assets/dev/js/editor/regions/responsive-bar/view.js'
                    )
                )
                    ...
                    ;(0, _createClass2.default)(View, [
                        ...
                        },
                        {
                            ...
                            value: function initialize() {
                                ...
                                this.listenTo(
                                    elementor.channels.responsivePreview,
                                    'resize',
                        ...
                        },
                        {
                            ...
                            value: function addTipsyToIconButtons() {
                                this.ui.switcherLabel
                                    .add(this.ui.closeButton)
                                    .add(this.ui.breakpointSettingsButton)
                                    .tipsy({
                                        html: true,
                                        gravity: 'n',
                        ...
                        },
                        {
                            ...
                            value: function restoreLastValidPreviewSize() {
                                ...
                                this.ui.sizeInputWidth.val(lastSize.width).tipsy({
                                    ...
                                    title: function title() {
                                        return __(
                                            "The value inserted isn't in the breakpoint boundaries",
                                            'elementor'
                                        )
                                    }
                                })
                            ...
                            value: function autoScale() {
                                var handlesWidth = (40 * this.scalePercentage) / 100,
                                    ...
                                    iframeWidth = parseInt(
                                        elementor.$preview.css('--e-editor-preview-width')
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function onBreakpointSettingsOpen() {
                                var isWPPreviewMode = elementorCommon.elements.$body.hasClass(
                                    'elementor-editor-preview'
                                )
                                if (isWPPreviewMode) {
                                    elementor.exitPreviewMode()
                                }
                                var isInSettingsPanelActive =
                                    'panel/global/menu' ===
                                ...
                                $e.run('editor/documents/switch', {
                                    ...
                                    .then(function () {
                                        return jQuery(
                                            '.elementor-control-section_breakpoints'
                                        ).trigger('click')
                                    })
                            }
                        },
                        ...
                        },
                        {
                            ...
                            value: function onSizeInputChange() {
                                ...
                                if (
                                    size.width < currentDeviceConstrains.minWidth ||
                                    size.width > currentDeviceConstrains.maxWidth
                                ) {
                        ...
                        },
                        {
                            ...
                            value: function onScalePlusButtonClick() {
                                var scaleUp =
                                    0 === this.scalePercentage % 10
                                        ? this.scalePercentage + 10
                                        : Math.ceil(this.scalePercentage / 10) * 10
                                if (scaleUp > 200) {
                                    return
                                }
                        ...
                        },
                        {
                            ...
                            value: function onScaleMinusButtonClick() {
                                var scaleDown =
                                    0 === this.scalePercentage % 10
                                        ? this.scalePercentage - 10
                                        : Math.floor(this.scalePercentage / 10) * 10
                                if (scaleDown < 50) {
                                    return
                                }
  ...
  \***************************************************************/
        ...
        var _responsiveBar = _interopRequireDefault(
            __webpack_require__(
                /*! elementor-regions/responsive-bar/responsive-bar */ '../assets/dev/js/editor/regions/responsive-bar/responsive-bar.js'
            )
        )
