...
;(self['webpackChunkelementor'] = self['webpackChunkelementor'] || []).push([
  ...
  \*********************************************/
            /***/ (__unused_webpack_module, exports) => {
                ...
                class _default extends elementorModules.ViewModule {
                    ...
                    runElementsHandlers() {
                        this.elements.$elements.each((index, element) =>
                            setTimeout(() =>
  ...
  \*****************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _base = _interopRequireDefault(
                    __webpack_require__(/*! ../base */ '../assets/dev/js/frontend/handlers/base.js')
                )
                        ...
                        switch (event.key) {
                            ...
                            default:
                                const directionValue = this.getKeyDirectionValue(event),
                                    isEndReached =
                                        numberOfTitles < currentTitleIndex + directionValue,
  ...
  \***********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _baseSwiper = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./base-swiper */ '../assets/dev/js/frontend/handlers/base-swiper.js'
                    )
                )
                class CarouselHandlerBase extends _baseSwiper.default {
                        ...
                        const selectors = this.getSettings('selectors'),
                            elements = {
                                ...
                                $paginationBulletWrapper: this.$element.find(
                                    selectors.paginationBulletWrapper
                                )
                            }
                    ...
                    applyOffsetSettings(elementSettings, swiperOptions, slidesToShow) {
                        ...
                        switch (offsetSide) {
                            case 'right':
                                this.forceSliderToShowNextSlideWhenOnLast(
                                    swiperOptions,
                                    slidesToShow
                                )
                    ...
                    onDirectionArrowKeydown(event) {
                        const isRTL = elementorFrontend.config.is_rtl,
                            ...
                            isDirectionInlineKeydown =
                                -1 !== inlineDirectionArrows.indexOf(currentKeydown),
                    ...
                    updateSpaceBetween(propertyName) {
                        ...
                        if ('desktop' !== device) {
                            this.swiper.params.breakpoints[
                                elementorFrontend.config.responsive.activeBreakpoints[device].value
                    ...
                    getPaginationBullets() {
                        let type =
                            arguments.length > 0 && arguments[0] !== undefined
                                ? arguments[0]
                                : 'array'
                        const paginationBullets = this.$element.find(
                    ...
                    a11ySetPaginationTabindex() {
                        ...
                        const isDirectionInlineArrowKey =
                            'ArrowLeft' === event?.code || 'ArrowRight' === event?.code
                        if (
                            event?.target?.classList?.contains(bulletClass) &&
                            isDirectionInlineArrowKey
                        ) {
                    ...
                    a11ySetSlideAriaHidden() {
                        ...
                        const currentIndex =
                            'initialisation' === status ? 0 : this.swiper?.activeIndex
                        if ('number' !== typeof currentIndex) {
                            return
                        }
                        const swiperWrapperTransformXValue = this.getSwiperWrapperTranformXValue(),
                            swiperWrapperWidth = this.elements.$swiperWrapper[0].clientWidth,
                            $slides = this.elements.$swiperContainer.find(
                                this.getSettings('selectors').slideContent
                            )
                        $slides.each((index, slide) => {
                            const isSlideInsideWrapper =
                                0 <= slide.offsetLeft + swiperWrapperTransformXValue &&
                                swiperWrapperWidth > slide.offsetLeft + swiperWrapperTransformXValue
                ...
                class SwiperHandlerBase extends _base.default {
                    ...
                    handleKenBurns() {
                        ...
                        if (this.swiper) {
                            ...
                            ).children('.' + settings.classes.slideBackground)
                        } else {
                            this.$activeImageBg = jQuery(this.elements.$slides[0]).children(
                                '.' + settings.classes.slideBackground
                            )
                        }
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class StretchedElement extends _base.default {
                    ...
                    isActive(settings) {
                        return (
                            elementorFrontend.isEditMode() ||
                            settings.$element.hasClass(this.getStretchedClass())
                        )
                    }
  ...
  \********************************************/
            /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _modules = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../modules/modules */ '../assets/dev/js/modules/modules.js'
                    )
                )
                var _document = _interopRequireDefault(
                    __webpack_require__(/*! ./document */ '../assets/dev/js/frontend/document.js')
                )
                var _stretchElement = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./tools/stretch-element */ '../assets/dev/js/frontend/tools/stretch-element.js'
                    )
                )
                var _stretchedElement = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./handlers/stretched-element */ '../assets/dev/js/frontend/handlers/stretched-element.js'
                    )
                )
                var _base = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./handlers/base */ '../assets/dev/js/frontend/handlers/base.js'
                    )
                )
                var _baseSwiper = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./handlers/base-swiper */ '../assets/dev/js/frontend/handlers/base-swiper.js'
                    )
                )
                var _baseCarousel = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./handlers/base-carousel */ '../assets/dev/js/frontend/handlers/base-carousel.js'
                    )
                )
                var _nestedTabs = _interopRequireDefault(
                    __webpack_require__(
                ...
                var _nestedAccordion = _interopRequireDefault(
                    __webpack_require__(
                ...
                var _nestedTitleKeyboardHandler = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./handlers/accessibility/nested-title-keyboard-handler */ '../assets/dev/js/frontend/handlers/accessibility/nested-title-keyboard-handler.js'
                    )
                )
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class ForceMethodImplementation extends Error {
                    constructor() {
                        ...
                        super(
                            `${info.isStatic ? 'static ' : ''}${info.fullName}() should be implemented, please provide '${info.functionName || info.fullName}' functionality.`,
                            args
                        )
                ...
                class InstanceType {
                    static [Symbol.hasInstance](target) {
                        ...
                        if (target) {
                            ...
                            if (!result) {
                                if (
                                    this.getInstanceType() === target.constructor.getInstanceType()
                                ) {
                                    result = true
                                }
                            }
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports['default'] = void 0
                var _viewModule = _interopRequireDefault(
                    __webpack_require__(
                        /*! ../view-module */ '../assets/dev/js/modules/imports/view-module.js'
                    )
                )
  ...
  \*******************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _module = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./module */ '../assets/dev/js/modules/imports/module.js'
                    )
                )
  ...
  \*******************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _module = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/module */ '../assets/dev/js/modules/imports/module.js'
                    )
                )
                var _viewModule = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/view-module */ '../assets/dev/js/modules/imports/view-module.js'
                    )
                )
                var _argsObject = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/args-object */ '../assets/dev/js/modules/imports/args-object.js'
                    )
                )
                var _masonry = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/utils/masonry */ '../assets/dev/js/modules/imports/utils/masonry.js'
                    )
                )
                var _scroll = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/utils/scroll */ '../assets/dev/js/modules/imports/utils/scroll.js'
                    )
                )
                var _forceMethodImplementation = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./imports/force-method-implementation */ '../assets/dev/js/modules/imports/force-method-implementation.js'
                    )
                )
  ...
  \**********************************************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _nestedTitleKeyboardHandler = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-assets-js/frontend/handlers/accessibility/nested-title-keyboard-handler */ '../assets/dev/js/frontend/handlers/accessibility/nested-title-keyboard-handler.js'
                    )
                )
  ...
  \***********************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _base = _interopRequireDefault(
                    __webpack_require__(
                        /*! elementor-frontend/handlers/base */ '../assets/dev/js/frontend/handlers/base.js'
                    )
                )
                var _nestedAccordionTitleKeyboardHandler = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./nested-accordion-title-keyboard-handler */ '../modules/nested-accordion/assets/js/frontend/handlers/nested-accordion-title-keyboard-handler.js'
                    )
                )
  ...
  \*************************************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _flexHorizontalScroll = __webpack_require__(
                    /*! elementor-frontend-utils/flex-horizontal-scroll */ '../assets/dev/js/frontend/utils/flex-horizontal-scroll.js'
                )
                class NestedTabs extends _base.default {
                    ...
                    activateTab(tabIndex) {
                        ...
                        let $requestedTitle = this.elements.$tabTitles.filter(
                        ...
                        if (!$requestedTitle.length) {
                            ...
                            $requestedTitle = this.elements.$tabTitles.filter(
                                this.getTabTitleFilterSelector(previousTabIndex)
                            )
                            $requestedContent = this.elements.$tabContents.filter(
                                this.getTabContentFilterSelector(previousTabIndex)
                            )
                        }
                    ...
                    onTabClick(event) {
                        ...
                        this.changeActiveTab(
                            event.currentTarget?.getAttribute('data-tab-index'),
                            true
                        )
                    }
                    getTabEvents() {
                    ...
                    reInitSwipers(event, content) {
                        const swiperElements = content.querySelectorAll(
                    ...
                    forceActiveTabToBeInViewport(tabIndex) {
                        ...
                        const $activeTabTitle = this.elements.$tabTitles.filter(
                            this.getTabTitleFilterSelector(tabIndex)
                        )
                    ...
                    updateIndexValues() {
                        ...
                        $tabTitles.each((index, element) => {
                            ...
                            element
                                .querySelector(settings.selectors.tabTitleText)
                                .setAttribute('data-binding-index', newIndex)
                            element
                                .querySelector(settings.selectors.tabTitleText)
                                .setAttribute('aria-controls', updatedTabID)
                            ...
                            $tabContents[index].setAttribute(
                                'style',
                                `--n-tabs-title-order: ${newIndex}`
                            )
                        })
                    }
                }
  ...
  \****************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var ERROR_STACK_INSTALLABLE = __webpack_require__(
                    /*! ../internals/error-stack-installable */ '../node_modules/core-js/internals/error-stack-installable.js'
                )
...
*/
  ...
  \******************************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var installErrorCause = __webpack_require__(
                    /*! ../internals/install-error-cause */ '../node_modules/core-js/internals/install-error-cause.js'
                )
                var installErrorStack = __webpack_require__(
                    /*! ../internals/error-stack-install */ '../node_modules/core-js/internals/error-stack-install.js'
                )
                var DESCRIPTORS = __webpack_require__(
                    /*! ../internals/descriptors */ '../node_modules/core-js/internals/descriptors.js'
                )
  ...
  \*********************************************************/
            /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var wrapErrorConstructorWithCause = __webpack_require__(
                    /*! ../internals/wrap-error-constructor-with-cause */ '../node_modules/core-js/internals/wrap-error-constructor-with-cause.js'
                )
