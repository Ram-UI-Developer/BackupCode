...
/******/ ;(() => {
  ...
  \****************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                var _view = _interopRequireDefault(
                    __webpack_require__(/*! ./view */ '../assets/dev/js/admin/beta-tester/view.js')
                )
                    ...
                    ;(0, _createClass2.default)(BetaTesterLayout, [
                        ...
                        },
                        {
                            ...
                            value: function initialize() {
                                ...
                                this.modalHeader.currentView.ui.closeModal.after(
                                    jQuery('<div>', {
                        ...
                        },
                        {
                            ...
                            value: function onCloseModalClick() {
                                elementorCommon.ajax.addRequest('introduction_viewed', {
                                    data: {
                                        introductionKey:
                                            elementorAdmin.config.beta_tester.beta_tester_signup
                                    }
                                })
                            }
                        }
  ...
  \*********************************************************/
        ...
        var _layout = _interopRequireDefault(
            __webpack_require__(/*! ./layout */ '../assets/dev/js/admin/beta-tester/layout.js')
        )
        function _createSuper(Derived) {
            var hasNativeReflectConstruct = _isNativeReflectConstruct()
            return function _createSuperInternal() {
            ...
            ;(0, _createClass2.default)(BetaTesterModule, [
                ...
                },
                {
                    ...
                    value: function showLayout() {
                        ...
                        if (
                            !always &&
                            (!elementorAdmin.config.beta_tester.option_enabled ||
                                elementorAdmin.config.beta_tester.signup_dismissed ||
                                '#tab-fontawesome4_migration' === location.hash)
                        ) {
                            return
                        }
