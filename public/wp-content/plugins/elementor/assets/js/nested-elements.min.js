                            ...
                            (0, _.default)(Events, null, [
                                {
                                    ...
                                    value: function dispatch(e, t) {
                                        ...
                                        ;((e = e instanceof jQuery ? e[0] : e),
                                            n && e.dispatchEvent(new CustomEvent(n, { detail: r })),
    ...
    ;((__webpack_require__.m = r),
        ...
        (() => {
            ...
            var webpackJsonpCallback = (t, r) => {
                    ...
                    for (t && t(r); a < _.length; a++)
                        ((o = _[a]), __webpack_require__.o(e, o) && e[o] && e[o][0](), (e[o] = 0))
                },
                t = (self.webpackChunkelementor = self.webpackChunkelementor || [])
            ;(t.forEach(webpackJsonpCallback.bind(null, 0)),
                (t.push = webpackJsonpCallback.bind(null, t.push.bind(t))))
        })(),
        (() => {
            'use strict'
            var e = __webpack_require__(73203)(__webpack_require__(36404))
            elementorCommon.elements.$window.on('elementor:init-components', function () {
                ;((elementor.modules.nestedElements = __webpack_require__
                    .e(9648)
                    .then(__webpack_require__.bind(__webpack_require__, 9648))),
                    elementor.modules.nestedElements.then(function (t) {
                        ;((elementor.modules.nestedElements = new t.default()),
                            (elementor.modules.elements.types.NestedElementBase =
                                __webpack_require__
                                    .e(3016)
                                    .then(__webpack_require__.bind(__webpack_require__, 93016))),
                            elementor.modules.elements.types.NestedElementBase.then(function (t) {
                                ;((elementor.modules.elements.types.NestedElementBase = t.default),
                                    __webpack_require__
                                        .e(7145)
                                        .then(__webpack_require__.bind(__webpack_require__, 67145))
                                        .then(function (e) {
                                            $e.components.get('nested-elements').exports = {
                                                NestedView: e.default
                                            }
                                        })
                                        .then(function () {
                                            e.default.dispatch(
