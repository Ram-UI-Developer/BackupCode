...
;(self['webpackChunkelementor'] = self['webpackChunkelementor'] || []).push([
  ...
  \********************************************************/
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                exports.zoomOutBold =
                    ...
                    exports.pinterest =
                    exports.loading =
                    exports.frameMinimize =
                    exports.frameExpand =
                    exports.facebook =
                    exports.downloadBold =
                    exports.close =
            ...
            /***/ (__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class IconsManager {
                    ...
                    createSvgIconElement(_ref3) {
                        let { iconName, iconSelector } = _ref3
                    ...
                    createSymbolElement(_ref4) {
                        let { id, path, width, height } = _ref4
  ...
  \************************************************************/
            /***/ (module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _screenfull = _interopRequireDefault(
                    __webpack_require__(
                        /*! ./screenfull */ '../assets/dev/js/frontend/utils/lightbox/screenfull.js'
                    )
                )
                var _eIcons = __webpack_require__(
                    /*! @elementor/e-icons */ '../assets/dev/js/frontend/utils/icons/e-icons.js'
                )
                module.exports = elementorModules.ViewModule.extend({
                    ...
                    initModal() {
                        ...
                        const modal = (module.exports.modal = elementorFrontend
                            .getDialogsManager()
                    ...
                    createLightbox(element) {
                        ...
                        const initialSlideURL =
                            element.dataset.elementorLightboxVideo || element.href
                        this.openSlideshow(
                    ...
                    setVideoContent(options) {
                        ...
                        const classes = this.getSettings('classes'),
                            aspectRatio = this.getRatioDictionry(
                    ...
                    getShareLinks() {
                            ...
                            const networkLabel = data.label,
                                $link = $('<a>', {
                                    href: this.createShareLink(
                                        key,
                                        itemUrl,
                                        $activeSlide.attr('data-e-action-hash')
                                    ),
                                    target: '_blank'
                                }).text(networkLabel),
                                $socialNetworkIconElement = this.isFontIconSvgExperiment
                                    ? $(data.iconElement.element)
                                    : $('<i>', {
                                          class: 'eicon-' + key,
                                          'aria-hidden': 'true'
                                      })
                        ...
                        if (!videoUrl) {
                            const $downloadIcon = this.isFontIconSvgExperiment
                                ? $(_eIcons.downloadBold.element)
                                : $('<i>', {
                    ...
                    createShareLink(networkName, itemUrl) {
                        ...
                        if ('pinterest' === networkName) {
                            ...
                            options.url = encodeURIComponent(
                    ...
                    getSlideshowHeader() {
                        ...
                        if (showShare) {
                            const iconElement = this.isFontIconSvgExperiment
                                ? _eIcons.shareArrow.element
                                : '<i>'
                        ...
                        if (showZoom) {
                            ...
                            elements.$iconZoom = $(iconElement)
                                .attr(zoomAttrs)
                                .on('click', this.toggleZoomMode)
                            showZoomElements.push(elements.$iconZoom)
                            if (this.isFontIconSvgExperiment) {
                                elements.$iconZoomOut = $(_eIcons.zoomOutBold.element)
                                    .attr(showZoomAttrs)
                        ...
                        if (showFullscreen) {
                            ...
                            if (this.isFontIconSvgExperiment) {
                                elements.$iconMinimize = $(_eIcons.frameMinimize.element)
                    ...
                    setSlideshowContent(options) {
                        const { i18n } = elementorFrontend.config,
                            ...
                            hasTitle =
                                '' !== elementorFrontend.getKitSettings('lightbox_title_src'),
                            hasDescription =
                        ...
                        options.slides.forEach((slide) => {
                            ...
                            if (slide.video) {
                                ...
                                const playVideoLoadingElement = this.isFontIconSvgExperiment
                                        ? _eIcons.loading.element
                                        : '<i>',
                                    $playIcon = $('<div>', {
                                        class: classes.playButton
                                    }).html(
                                        $(playVideoLoadingElement)
                                            .attr('aria-label', i18n.playVideo)
                                            .addClass(classes.playButtonIcon)
                                    )
                        ...
                        if (!isSingleSlide) {
                            const $prevButtonIcon = this.isFontIconSvgExperiment
                                    ? $(_eIcons.chevronLeft.element)
                                    : $('<i>', {
                                          class: slideshowClasses.prevButtonIcon,
                                          'aria-hidden': 'true'
                                      }),
                                $nextButtonIcon = this.isFontIconSvgExperiment
                                    ? $(_eIcons.chevronRight.element)
                                    : $('<i>', {
                            ...
                            setTimeout(() => {
                                if (!this.shareMode) {
                                    this.elements.$container.addClass(
                                        slideshowClasses.hideUiVisibility
                                    )
                                }
                            }, 3500)
                        )
                    ...
                    openSlideshow(slideshowID, initialSlideURL) {
                        const $allSlideshowLinks = jQuery(
