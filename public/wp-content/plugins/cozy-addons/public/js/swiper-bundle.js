...
;(function (global, factory) {
    ...
    function A11y({ swiper, extendParams, on }) {
        ...
        function hasPagination() {
            return (
                swiper.pagination && swiper.pagination.bullets && swiper.pagination.bullets.length
            )
        }
    ...
    function effectInit(params) {
        const { effect, swiper, on, setTranslate, setTransition, overwriteParams, perspective } =
            params
        on('beforeInit', () => {
