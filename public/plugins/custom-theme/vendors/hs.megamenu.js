...
;(function ($) {
    ...
    MegaMenu.prototype.initialize = function () {
        ...
        $w.on('resize.HSMegaMenu', function (e) {
            ...
            self.resizeTimeOutId = setTimeout(function () {
                if (window.innerWidth <= self.options.breakpoint && self.state == 'desktop')
                    self.initMobileBehavior()
                else if (window.innerWidth > self.options.breakpoint && self.state == 'mobile')
    ...
    MegaMenu.prototype.bindEvents = function () {
        ...
        this.$element.on(
            'keydown.HSMegaMenu',
            this.options.classMap.hasMegaMenu + ' > a,' + this.options.classMap.hasSubMenu + ' > a',
            function (e) {
                var $this = $(this),
                    $parent = $this.parent(),
                    HSMenuItem
    ...
    MegaMenu.prototype.initMobileBehavior = function () {
        ...
        this.$element
            ...
            .children(this.options.classMap.subMenu + ',' + this.options.classMap.megaMenu)
            .hide()
    }
